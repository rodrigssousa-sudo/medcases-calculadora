...
(function(){
  ...
  Object.assign(window.PSICOFARMACOS_DRUGS_DB, {
    ...
    /* BUILD 284 — pregabalina REMOVIDA deste módulo (duplicata).
       Entrada canônica em database/analgesicos.js (Grupo 6, schema rico
       com renalAdjustment, safetyFlags, TAG/fibromialgia incluídas).
       O motor de busca (_searchIndex) indexa apenas analgesicos.js. */


    /* BUILD 284 — gabapentina REMOVIDA deste módulo (duplicata).
       Entrada canônica em database/analgesicos.js (Grupo 6, schema rico
       com renalAdjustment, safetyFlags, contraindications completos).
       O motor de busca (_searchIndex) indexa apenas analgesicos.js. */
