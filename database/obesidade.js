...
/* GOLD33_SELECTIVE:tirzepatida_obesidade:START */
;(function(){var db=window.OBESIDADE_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="tirzepatida_obesidade";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:tirzepatida_obesidade:"+matches.length);drug=matches[0];}else{drug=db&&db["tirzepatida_obesidade"];if(!drug&&db){var keys=Object.keys(db).filter(function(key){return key.toLowerCase()==="tirzepatida_obesidade";});if(keys.length>1)throw new Error("GOLD33_CANONICAL_CARDINALITY:tirzepatida_obesidade:"+keys.length);if(keys.length===1)drug=db[keys[0]];}if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:tirzepatida_obesidade");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "078",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Tirzepatida para controle de peso",
    "class": "Agonista dual dos receptores GIP e GLP-1",
    "pharmacologicClass": "Agonista dual dos receptores GIP e GLP-1",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Canetas ou frascos subcutâneos em apresentações específicas.",
    "presentations": "Canetas ou frascos subcutâneos em apresentações específicas.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância e exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo e eliminação na fonte primária.",
    "indications": "Controle crônico do peso em pacientes elegíveis, associado a dieta e atividade física.",
    "dose": "Aplicação subcutânea semanal com escalonamento próprio do produto. Não combinar com outro produto contendo tirzepatida ou agonista GLP-1.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Náusea, diarreia, vômito, constipação e dor abdominal.",
    ...
    "alerts": "Pancreatite, doença biliar, lesão renal por desidratação, ideação suicida e risco de tumor de células C.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=tirzepatida+obesidade",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=tirzepatida+obesidade"
  },
  "es": {
    "name": "Tirzepatida para controle de peso",
    ...
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Controle crônico do peso em pacientes elegíveis, associado a dieta y atividade física.",
    "dose": "Aplicação subcutânea semanal con escalonamento próprio do produto. No combinar con outro produto contendo tirzepatida ou agonista GLP-1.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Náusea, diarreia, vômito, constipação y dor abdominal.",
...
/* GOLD33_SELECTIVE:tirzepatida_obesidade:END */
