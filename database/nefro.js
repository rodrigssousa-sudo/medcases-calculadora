...
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["acetato_de_calcio"])throw new Error("GOLD33_MISSING_CANONICAL:acetato_de_calcio");db["acetato_de_calcio"].mcGoldClinicalV1={
  ...
  "pt": {
    ...
    "commercialNames": "Múltiplos produtos genéricos de calcium acetate 667 mg estão registrados no DailyMed. Este candidato não atribui uma marca única nem disponibilidade AR/BR sem fonte local.",
    "presentation": "Cápsulas 667 mg de acetato de cálcio em rótulos US; produto/força local devem ser confirmados.",
    "presentations": "EUA, fonte consultada: cápsula de acetato de cálcio 667 mg; o rótulo informa equivalência aproximada a 169 mg de cálcio por cápsula. Não inferir outras formas/concentrações sem fonte específica.",
    ...
    "pharmacokinetics": "A rotulagem regulatória atual consultada não fornece seção farmacocinética quantitativa completa para acetato de cálcio. Seu efeito terapêutico ocorre predominantemente no lúmen gastrointestinal por ligação ao fosfato da dieta. Portanto, parâmetros sistêmicos de absorção, distribuição, metabolismo e eliminação não foram inventados neste candidato; o risco sistêmico clinicamente relevante é a absorção de cálcio e hipercalcemia.",
    ...
    "adverseEffects": "Nos estudos em pacientes com doença renal terminal em hemodiálise, hipercalcemia ocorreu em 12,6%, náusea em 3,6% e vômitos em 2,4%. Hipercalcemia leve pode causar constipação, anorexia, náusea/vômitos; formas graves podem cursar com confusão, delirium, estupor ou coma. Pós-comercialização: tontura, edema e fraqueza; prurido isolado foi descrito.",
    ...
    "preparation": "Cápsula oral pronta para uso, administrada com as refeições; não requer reconstituição ou diluição.",
    "infusionProtocol": "NÃO APLICÁVEL COMPROVADO ao produto consultado: cápsula oral de acetato de cálcio; não há protocolo de infusão.",
    "pregnancy": "Não concluir nesta ficha.",
    "lactation": "Não concluir nesta ficha.",
    "specialPopulations": "Pediatria: segurança e eficácia não estão estabelecidas no rótulo consultado; não automatizar dose pediátrica a partir de adulto. Idosos: iniciar com cautela considerando maior frequência de disfunção renal e comorbidades. Em qualquer paciente, monitorizar cálcio e fósforo; risco de hipercalcemia aumenta com exposição excessiva a cálcio.",
    ...
    "clinicalPearls": "Quelante de fosfato à base de cálcio: administrar com refeições e titular pelo fósforo sérico, monitorando cálcio especialmente no início e durante titulação. Evitar suplementação de cálcio/antiácidos contendo cálcio sem indicação. A hipercalcemia pode aumentar toxicidade digitálica. Separar outros fármacos orais quando a interação por ligação/absorção for clinicamente relevante.",
    "guidelineRecommendations": "KDIGO CKD-MBD: em adultos com DRC G3a-G5D que recebem tratamento redutor de fosfato, sugere-se restringir a dose de quelantes à base de cálcio (2B). Em crianças com DRC G3a-G5D, é razoável basear a escolha do tratamento redutor de fosfato no cálcio sérico. A decisão deve integrar fósforo, cálcio, PTH e contexto de calcificação/doença óssea.",
  ...
  "es": {
    ...
    "commercialNames": "Múltiples productos genéricos de calcium acetate 667 mg están registrados en DailyMed. Este candidato no atribuye una marca única ni disponibilidad AR/BR sin fuente local.",
    "presentation": "Cápsulas 667 mg de acetato de calcio en etiquetas US; el producto/fuerza local deben confirmarse.",
    "presentations": "EE. UU., fuente consultada: cápsula de acetato de calcio 667 mg; el etiquetado informa equivalencia aproximada a 169 mg de calcio por cápsula. No inferir otras formas/concentraciones sin fuente específica.",
    ...
    "pharmacokinetics": "El etiquetado regulatorio actual consultado no aporta una sección farmacocinética cuantitativa completa para acetato de calcio. Su efecto terapéutico ocurre predominantemente en la luz gastrointestinal por unión al fosfato de la dieta. Por ello, no se inventaron parámetros sistémicos de absorción, distribución, metabolismo ni eliminación en este candidato; el riesgo sistémico clínicamente relevante es la absorción de calcio y la hipercalcemia.",
    ...
    "adverseEffects": "En estudios en pacientes con enfermedad renal terminal en hemodiálisis, hipercalcemia ocurrió en 12,6%, náuseas en 3,6% y vómitos en 2,4%. La hipercalcemia leve puede causar estreñimiento, anorexia, náuseas/vómitos; formas graves pueden cursar con confusión, delirium, estupor o coma. Poscomercialización: mareo, edema y debilidad; se describió prurito aislado.",
    ...
    "preparation": "Cápsula oral lista para usar, administrada con las comidas; no requiere reconstitución ni dilución.",
    "infusionProtocol": "NO APLICA, comprobado para el producto consultado: cápsula oral de acetato de calcio; no existe protocolo de infusión.",
    "pregnancy": "No concluir en esta ficha.",
    "lactation": "No concluir en esta ficha.",
    "specialPopulations": "Pediatría: seguridad y eficacia no están establecidas en el etiquetado consultado; no automatizar dosis pediátrica desde adulto. Mayores: iniciar con cautela considerando mayor frecuencia de disfunción renal y comorbilidades. En cualquier paciente, monitorizar calcio y fósforo; el riesgo de hipercalcemia aumenta con exposición excesiva a calcio.",
    ...
    "clinicalPearls": "Quelante de fosfato a base de calcio: administrar con comidas y titular según fósforo sérico, monitorizando calcio especialmente al inicio y durante titulación. Evitar suplementos de calcio/antiácidos con calcio sin indicación. La hipercalcemia puede aumentar la toxicidad digitálica. Separar otros fármacos orales cuando la interacción por unión/absorción sea clínicamente relevante.",
    "guidelineRecommendations": "KDIGO CKD-MBD: en adultos con ERC G3a-G5D que reciben tratamiento reductor de fosfato, se sugiere restringir la dosis de quelantes a base de calcio (2B). En niños con ERC G3a-G5D, es razonable basar la elección del tratamiento reductor de fosfato en el calcio sérico. La decisión debe integrar fósforo, calcio, PTH y contexto de calcificación/enfermedad ósea.",
...
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["alfacalcidol"])throw new Error("GOLD33_MISSING_CANONICAL:alfacalcidol");db["alfacalcidol"].mcGoldClinicalV1={
  ...
  "pt": {
    "name": "Alfacalcidol",
    "class": "Análogo ativo da vitamina D",
    "pharmacologicClass": "Pró-fármaco de calcitriol; regulador do metabolismo de cálcio e fosfato",
    "commercialNames": "Nomes regulatórios usados como evidência: os produtos citados nas referências; marcas AR/BR não presumidas.",
    "presentation": "Cápsulas moles de 0,25 micrograma e 1 micrograma; outras apresentações dependem da jurisdição.",
    "presentations": "Cápsulas moles de 0,25 micrograma e 1 micrograma; outras apresentações dependem da jurisdição.",
    "mechanism": "Pró-fármaco de calcitriol; regulador do metabolismo de cálcio e fosfato. O efeito clínico decorre do mecanismo descrito na bula primária e deve ser interpretado segundo formulação e indicação.",
    "pharmacodynamics": "Efeito farmacodinâmico coerente com pró-fármaco de calcitriol; regulador do metabolismo de cálcio e fosfato; resposta e toxicidade são dependentes de exposição, população e via.",
    "pharmacokinetics": "Convertido rapidamente no fígado em 1,25-di-hidroxivitamina D3; pico do metabólito em cerca de 8–12 h e meia-vida aproximada de 35 h.",
    "indications": "Distúrbios do metabolismo do cálcio por redução da 1α-hidroxilação: osteodistrofia urêmica, hiper/hipoparatireoidismo com doença óssea, osteoporose selecionada, raquitismo/osteomalácia e hipocalcemia neonatal, conforme SmPC.",
    "dose": "Dose inicial usual: adultos e crianças >20 kg, 1 micrograma VO/dia; idosos, 0,5 micrograma/dia pode ser suficiente. Manutenção usual 0,25–2 microgramas/dia; titular por cálcio, fosfato, PTH, fosfatase alcalina e calciúria.",
    "pediatricDose": "Neonatos/prematuros: 0,05–0,1 micrograma/kg/dia VO. Crianças <20 kg: 0,05 micrograma/kg/dia VO. Formulação/concentração deve ser confirmada antes de converter para volume. AUTOMATABLE=NO no baseline atual.",
    "renalDose": "É usado em doença óssea renal, mas não há redução fixa por eGFR. Em diálise, esquema intermitente adulto 0,5–2 microgramas 2–3 vezes/semana após a sessão, por especialista, com titulação laboratorial.",
    "hepaticDose": "Conversão hepática é necessária; o SmPC consultado não fornece ajuste numérico para insuficiência hepática.",
    "commonAdverseEffects": "Hipercalcemia, hiperfosfatemia, hipercalciúria, dor/desconforto abdominal, prurido e erupção.",
    "dangerousAdverseEffects": "Insuficiência renal, nefrolitíase/nefrocalcinose, calcificação de tecidos e arritmia em hipercalcemia, especialmente com digitálicos.",
    "adverseEffects": "Hipercalcemia, hiperfosfatemia, hipercalciúria, dor/desconforto abdominal, prurido e erupção. Eventos graves: Insuficiência renal, nefrolitíase/nefrocalcinose, calcificação de tecidos e arritmia em hipercalcemia, especialmente com digitálicos.",
    "contraindications": "Hipersensibilidade; hipercalcemia é risco clínico crítico e requer suspensão/reavaliação.",
    "interactions": "Tiazídicos e cálcio aumentam risco de hipercalcemia; evitar outros análogos de vitamina D; anticonvulsivantes indutores podem reduzir efeito; separar sequestrantes de ácidos biliares (≥1 h antes ou 4–6 h depois).",
    "monitoring": "Cálcio, fosfato, PTH, fosfatase alcalina, função renal e cálcio urinário; intensificar durante titulação e cicatrização óssea.",
    "administration": "Via oral, diariamente; em esquema intermitente de diálise, administrar ao final da sessão conforme protocolo especializado.",
    "preparation": "Cápsula não requer preparo; não assumir concentração de gotas/solução sem produto verificado.",
    "infusionProtocol": "Não aplicável à cápsula oral avaliada.",
    "pregnancy": "Não usar na gestação salvo clara necessidade; hipercalcemia materna pode causar dano fetal.",
    "lactation": "É excretado no leite humano; decidir entre suspender amamentação ou tratamento e monitorar hipercalcemia no lactente exposto.",
    ...
    "alerts": "Insuficiência renal, nefrolitíase/nefrocalcinose, calcificação de tecidos e arritmia em hipercalcemia, especialmente com digitálicos. Conversão para gotas/mL e automação pediátrica: bloqueadas sem apresentação local confirmada.",
    "references": [
      "1. Fonte regulatória oficial consultada em 2026-09-17: https://assets.hpra.ie/products/Human/13959/Licence_PA2239-017-001_28052021151451.pdf"
    ],
    "ref": "https://assets.hpra.ie/products/Human/13959/Licence_PA2239-017-001_28052021151451.pdf"
  },
  "es": {
    "name": "Alfacalcidol",
    "class": "Análogo activo de vitamina D",
    "pharmacologicClass": "Profármaco de calcitriol; regulador del metabolismo de calcio y fosfato",
    "commercialNames": "Nombres regulatorios usados como evidencia: productos citados en referencias; no se presumen marcas AR/BR.",
    "presentation": "Cápsulas blandas de 0,25 microgramos y 1 microgramo; otras presentaciones dependen de la jurisdicción.",
    "presentations": "Cápsulas blandas de 0,25 microgramos y 1 microgramo; otras presentaciones dependen de la jurisdicción.",
    "mechanism": "Profármaco de calcitriol; regulador del metabolismo de calcio y fosfato. El efecto clínico deriva del mecanismo descrito en la ficha primaria y debe interpretarse según formulación e indicación.",
    "pharmacodynamics": "Efecto farmacodinámico coherente con profármaco de calcitriol; regulador del metabolismo de calcio y fosfato; respuesta y toxicidad dependen de exposición, población y vía.",
    "pharmacokinetics": "Se convierte rápidamente en hígado a 1,25-dihidroxivitamina D3; pico del metabolito en unas 8–12 h y semivida aproximada de 35 h.",
    "indications": "Trastornos del metabolismo del calcio por reducción de la 1α-hidroxilación: osteodistrofia urémica, hiper/hipoparatiroidismo con enfermedad ósea, osteoporosis seleccionada, raquitismo/osteomalacia e hipocalcemia neonatal, según SmPC.",
    "dose": "Dosis inicial usual: adultos y niños >20 kg, 1 microgramo VO/día; ancianos, 0,5 microgramos/día puede ser suficiente. Mantenimiento usual 0,25–2 microgramos/día; titular por calcio, fosfato, PTH, fosfatasa alcalina y calciuria.",
    "pediatricDose": "Neonatos/prematuros: 0,05–0,1 microgramos/kg/día VO. Niños <20 kg: 0,05 microgramos/kg/día VO. Debe confirmarse formulación/concentración antes de convertir a volumen. AUTOMATABLE=NO en el baseline actual.",
    "renalDose": "Se usa en enfermedad ósea renal, pero no hay reducción fija por eGFR. En diálisis, esquema intermitente adulto 0,5–2 microgramos 2–3 veces/semana tras la sesión, por especialista, con titulación de laboratorio.",
    "hepaticDose": "La conversión hepática es necesaria; el SmPC consultado no aporta ajuste numérico para insuficiencia hepática.",
    "commonAdverseEffects": "Hipercalcemia, hiperfosfatemia, hipercalciuria, dolor/malestar abdominal, prurito y erupción.",
    "dangerousAdverseEffects": "Insuficiencia renal, nefrolitiasis/nefrocalcinosis, calcificación tisular y arritmia en hipercalcemia, especialmente con digitálicos.",
    "adverseEffects": "Hipercalcemia, hiperfosfatemia, hipercalciuria, dolor/malestar abdominal, prurito y erupción. Eventos graves: Insuficiencia renal, nefrolitiasis/nefrocalcinosis, calcificación tisular y arritmia en hipercalcemia, especialmente con digitálicos.",
    "contraindications": "Hipersensibilidad; la hipercalcemia es un riesgo clínico crítico y requiere suspensión/reevaluación.",
    "interactions": "Tiazidas y calcio aumentan riesgo de hipercalcemia; evitar otros análogos de vitamina D; inductores anticonvulsivantes pueden reducir efecto; separar secuestrantes de ácidos biliares (≥1 h antes o 4–6 h después).",
    "monitoring": "Calcio, fosfato, PTH, fosfatasa alcalina, función renal y calcio urinario; intensificar durante titulación y curación ósea.",
    "administration": "Vía oral, diariamente; en esquema intermitente de diálisis, administrar al final de la sesión según protocolo especializado.",
    "preparation": "La cápsula no requiere preparación; no asumir concentración de gotas/solución sin producto verificado.",
    "infusionProtocol": "No aplicable a la cápsula oral evaluada.",
    "pregnancy": "No usar en embarazo salvo necesidad clara; la hipercalcemia materna puede causar daño fetal.",
    "lactation": "Se excreta en leche humana; decidir entre suspender lactancia o tratamiento y vigilar hipercalcemia en el lactante expuesto.",
    ...
    "alerts": "Insuficiencia renal, nefrolitiasis/nefrocalcinosis, calcificación tisular y arritmia en hipercalcemia, especialmente con digitálicos. Conversão para gotas/mL e automação pediátrica: bloqueadas sem apresentação local confirmada.",
    "references": [
      "1. Fonte regulatória oficial consultada em 2026-09-17: https://assets.hpra.ie/products/Human/13959/Licence_PA2239-017-001_28052021151451.pdf"
    ],
    "ref": "https://assets.hpra.ie/products/Human/13959/Licence_PA2239-017-001_28052021151451.pdf"
...
/* GOLD33_SELECTIVE:calcitriol:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["calcitriol"])throw new Error("GOLD33_MISSING_CANONICAL:calcitriol");db["calcitriol"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "013",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Calcitriol",
    "class": "Vitamina D ativa",
    "pharmacologicClass": "Agonista do receptor de vitamina D; 1,25-di-hidroxivitamina D3",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Cápsulas 0,25/0,5 mcg; solução oral 1 mcg/mL; injeção 1 ou 2 mcg/mL conforme mercado.",
    "presentations": "Cápsulas 0,25/0,5 mcg; solução oral 1 mcg/mL; injeção 1 ou 2 mcg/mL conforme mercado.",
    "mechanism": "Agonista do receptor de vitamina D; 1,25-di-hidroxivitamina D3. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Absorção oral rápida; ligação a proteína carreadora; meia-vida sérica 3-6 h, efeito biológico mais longo; metabolismo hepático/renal.",
    "indications": "Hipocalcemia/osteodistrofia na DRC, hipoparatireoidismo e indicações específicas conforme formulação.",
    "dose": "VO: frequentemente 0,25 mcg/dia, titular por cálcio/PTH; hemodiálise IV: dose inicial comum 1-2 mcg 3 vezes/semana ao final da diálise. Indicação define o esquema.",
    "pediatricDose": "Hipoparatireoidismo: dose por idade e resposta; não automatizar sem diagnóstico, cálcio e formulação. AUTOMATABLE=NO.",
    "renalDose": "É usado na DRC, mas não se ajusta apenas por eGFR; titular por Ca/P/PTH e modalidade dialítica.",
    "hepaticDose": "Sem ajuste formal; cautela e monitorização intensiva.",
    "commonAdverseEffects": "Hipercalcemia, náusea, constipação, fraqueza, cefaleia e prurido.",
    "dangerousAdverseEffects": "Arritmia, nefrocalcinose, calcificação de tecidos moles e insuficiência renal por hipercalcemia.",
    "adverseEffects": "Hipercalcemia, náusea, constipação, fraqueza, cefaleia e prurido. Graves: Arritmia, nefrocalcinose, calcificação de tecidos moles e insuficiência renal por hipercalcemia.",
    "contraindications": "Hipercalcemia, toxicidade por vitamina D e hipersensibilidade.",
    "interactions": "Tiazídicos aumentam hipercalcemia; digoxina aumenta risco arrítmico; magnésio em diálise, sequestrantes e anticonvulsivantes alteram efeito/absorção.",
    "monitoring": "Ca, fósforo, PTH, fosfatase alcalina, creatinina, Mg e sinais de toxicidade; maior frequência durante titulação.",
    "administration": "VO consistente; IV somente em acesso dialítico conforme produto. Evitar suplementos de vitamina D/cálcio não prescritos.",
    "preparation": "Solução oral deve ser medida em mcg/mL; injeção é pronta e não deve ser confundida com outras concentrações.",
    "infusionProtocol": "Administrar IV em bolus conforme bula ao final da hemodiálise; não infundir sem confirmar produto.",
    "pregnancy": "Usar somente se benefício justificar; evitar hipercalcemia.",
    "lactation": "Dados limitados; monitorar cálcio materno e lactente.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Arritmia, nefrocalcinose, calcificação de tecidos moles e insuficiência renal por hipercalcemia. Dose bloqueada sem indicação, Ca/P/PTH, função renal/diálise, formulação, concentração e medicamentos concomitantes.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=calcitriol",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://kdigo.org/guidelines/ckd-mbd/"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=calcitriol"
  },
  "es": {
    "name": "Calcitriol",
    "class": "Vitamina D activa",
    "pharmacologicClass": "Agonista del receptor de vitamina D; 1,25-dihidroxivitamina D3",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Cápsulas 0,25/0,5 mcg; solución oral 1 mcg/mL; inyección 1 o 2 mcg/mL según mercado.",
    "presentations": "Cápsulas 0,25/0,5 mcg; solución oral 1 mcg/mL; inyección 1 o 2 mcg/mL según mercado.",
    "mechanism": "Agonista del receptor de vitamina D; 1,25-dihidroxivitamina D3. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Absorción oral rápida; unión a proteína transportadora; semivida sérica 3-6 h, efecto biológico más largo; metabolismo hepático/renal.",
    "indications": "Hipocalcemia/osteodistrofia en ERC, hipoparatiroidismo e indicaciones específicas según formulación.",
    "dose": "VO: frecuentemente 0,25 mcg/día, titular por calcio/PTH; hemodiálisis IV: inicio común 1-2 mcg 3 veces/semana al final de diálisis. La indicación define el esquema.",
    "pediatricDose": "Hipoparatiroidismo: dosis por edad y respuesta; no automatizar sin diagnóstico, calcio y formulación. AUTOMATABLE=NO.",
    "renalDose": "Se usa en ERC, pero no se ajusta solo por eGFR; titular por Ca/P/PTH y modalidad dialítica.",
    "hepaticDose": "Sin ajuste formal; precaución y vigilancia intensiva.",
    "commonAdverseEffects": "Hipercalcemia, náusea, estreñimiento, debilidad, cefalea y prurito.",
    "dangerousAdverseEffects": "Arritmia, nefrocalcinosis, calcificación de tejidos blandos e insuficiencia renal por hipercalcemia.",
    "adverseEffects": "Hipercalcemia, náusea, estreñimiento, debilidad, cefalea y prurito. Graves: Arritmia, nefrocalcinosis, calcificación de tejidos blandos e insuficiencia renal por hipercalcemia.",
    "contraindications": "Hipercalcemia, toxicidad por vitamina D e hipersensibilidad.",
    "interactions": "Tiazidas aumentan hipercalcemia; digoxina aumenta riesgo arrítmico; magnesio en diálisis, secuestrantes y anticonvulsivos alteran efecto/absorción.",
    "monitoring": "Ca, fósforo, PTH, fosfatasa alcalina, creatinina, Mg y signos de toxicidad; mayor frecuencia durante titulación.",
    "administration": "VO consistente; IV solo en acceso dialítico según producto. Evitar suplementos no indicados de vitamina D/calcio.",
    "preparation": "La solución oral se mide en mcg/mL; la inyección está lista y no debe confundirse con otras concentraciones.",
    "infusionProtocol": "Administrar IV en bolo según ficha al final de hemodiálisis; no infundir sin confirmar producto.",
    "pregnancy": "Usar solo si beneficio justifica; evitar hipercalcemia.",
    "lactation": "Datos limitados; vigilar calcio materno y del lactante.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Arritmia, nefrocalcinosis, calcificación de tejidos blandos e insuficiencia renal por hipercalcemia. Dose bloqueada sem indicação, Ca/P/PTH, função renal/diálise, formulação, concentração e medicamentos concomitantes.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=calcitriol",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://kdigo.org/guidelines/ckd-mbd/"
    ],
...
/* GOLD33_SELECTIVE:calcitriol:END */
/* GOLD33_SELECTIVE:carbonato_de_calcio:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["carbonato_de_calcio"])throw new Error("GOLD33_MISSING_CANONICAL:carbonato_de_calcio");db["carbonato_de_calcio"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "014",
    "requiredFieldCount": 33,
  ...
  "pt": {
    ...
    "class": "Suplemento de cálcio/antiácido/quelante de fósforo",
    "pharmacologicClass": "Fornece cálcio elementar e liga fosfato/neutraliza ácido",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Comprimidos mastigáveis e suspensões; 1.250 mg de carbonato contém 500 mg de cálcio elementar.",
    "presentations": "Comprimidos mastigáveis e suspensões; 1.250 mg de carbonato contém 500 mg de cálcio elementar.",
    "mechanism": "Fornece cálcio elementar e liga fosfato/neutraliza ácido. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Absorção dependente de acidez/alimento; eliminação fecal e urinária; não possui meia-vida farmacológica convencional.",
    "indications": "Suplementação, dispepsia/azia e controle de fósforo na DRC conforme produto e contexto.",
    "dose": "Dose deve ser expressa em cálcio elementar. Suplementação usual 500-1.200 mg/dia divididos; antiácido e quelante seguem rótulo e Ca/P.",
    "pediatricDose": "Necessidade varia por idade/dieta; não exceder limites dietéticos totais. AUTOMATABLE=NO sem indicação e cálcio elementar.",
    "renalDose": "Na DRC, risco de hipercalcemia/calcificação; individualizar carga total de cálcio e fósforo.",
    "hepaticDose": "Sem ajuste específico; monitorar cálcio.",
    "commonAdverseEffects": "Constipação, gases, náusea e eructação.",
    "dangerousAdverseEffects": "Hipercalcemia, síndrome leite-álcali, nefrolitíase, arritmia e calcificação vascular.",
    "adverseEffects": "Constipação, gases, náusea e eructação. Graves: Hipercalcemia, síndrome leite-álcali, nefrolitíase, arritmia e calcificação vascular.",
    "contraindications": "Hipercalcemia, hipercalciúria grave e hipersensibilidade; cautela em nefrolitíase.",
    "interactions": "Reduz absorção de levotiroxina, tetraciclinas, quinolonas, ferro e bisfosfonatos; tiazídicos/digoxina elevam risco.",
    "monitoring": "Cálcio total/ionizado, fósforo, função renal, ingestão total, constipação e cálculos.",
    "administration": "Tomar com alimento para melhor absorção/efeito quelante; dividir doses elementares >500 mg.",
    "preparation": "Mastigar completamente; agitar suspensão. Converter sal para cálcio elementar.",
    "infusionProtocol": "Não aplicável.",
    "pregnancy": "Pode ser usado dentro da necessidade diária; evitar excesso.",
    "lactation": "Compatível em doses nutricionais; considerar ingestão total.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Hipercalcemia, síndrome leite-álcali, nefrolitíase, arritmia e calcificação vascular. Dose bloqueada sem indicação, cálcio elementar, Ca/P, função renal, dieta e interações de absorção.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=calcium+carbonate",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://kdigo.org/guidelines/ckd-mbd/"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=calcium+carbonate"
  },
  "es": {
    "name": "Carbonato de calcio",
    "class": "Suplemento de calcio/antiácido/quelante de fósforo",
    "pharmacologicClass": "Aporta calcio elemental y fija fosfato/neutraliza ácido",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Comprimidos masticables y suspensiones; 1.250 mg de carbonato contienen 500 mg de calcio elemental.",
    "presentations": "Comprimidos masticables y suspensiones; 1.250 mg de carbonato contienen 500 mg de calcio elemental.",
    "mechanism": "Aporta calcio elemental y fija fosfato/neutraliza ácido. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Absorción dependiente de acidez/alimentos; eliminación fecal y urinaria; sin semivida farmacológica convencional.",
    "indications": "Suplementación, dispepsia/acidez y control de fósforo en ERC según producto y contexto.",
    "dose": "Dosis debe expresarse como calcio elemental. Suplementación habitual 500-1.200 mg/día divididos; antiácido y quelante según ficha y Ca/P.",
    "pediatricDose": "Necesidad varía por edad/dieta; no exceder límites dietéticos totales. AUTOMATABLE=NO sin indicación y calcio elemental.",
    "renalDose": "En ERC, riesgo de hipercalcemia/calcificación; individualizar carga total de calcio y fósforo.",
    "hepaticDose": "Sin ajuste específico; vigilar calcio.",
    "commonAdverseEffects": "Estreñimiento, gases, náusea y eructos.",
    "dangerousAdverseEffects": "Hipercalcemia, síndrome leche-álcali, nefrolitiasis, arritmia y calcificación vascular.",
    "adverseEffects": "Estreñimiento, gases, náusea y eructos. Graves: Hipercalcemia, síndrome leche-álcali, nefrolitiasis, arritmia y calcificación vascular.",
    "contraindications": "Hipercalcemia, hipercalciuria grave e hipersensibilidad; precaución en nefrolitiasis.",
    "interactions": "Reduce absorción de levotiroxina, tetraciclinas, quinolonas, hierro y bisfosfonatos; tiazidas/digoxina aumentan riesgo.",
    "monitoring": "Calcio total/ionizado, fósforo, función renal, ingesta total, estreñimiento y cálculos.",
    "administration": "Tomar con alimentos para mejor absorción/efecto quelante; dividir dosis elementales >500 mg.",
    "preparation": "Masticar completamente; agitar suspensión. Convertir sal a calcio elemental.",
    "infusionProtocol": "No aplicable.",
    "pregnancy": "Puede usarse dentro de necesidad diaria; evitar exceso.",
    "lactation": "Compatible en dosis nutricionales; considerar ingesta total.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Hipercalcemia, síndrome leche-álcali, nefrolitiasis, arritmia y calcificación vascular. Dose bloqueada sem indicação, cálcio elementar, Ca/P, função renal, dieta e interações de absorção.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=calcium+carbonate",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://kdigo.org/guidelines/ckd-mbd/"
    ],
...
/* GOLD33_SELECTIVE:carbonato_de_calcio:END */
/* GOLD33_SELECTIVE:carbonato_de_lantanio:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["carbonato_de_lantanio"])throw new Error("GOLD33_MISSING_CANONICAL:carbonato_de_lantanio");db["carbonato_de_lantanio"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "014",
    "requiredFieldCount": 33,
  ...
  "pt": {
    ...
    "class": "Quelante de fosfato sem cálcio",
    "pharmacologicClass": "Liga fosfato no trato gastrointestinal",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Comprimidos mastigáveis 500/750/1.000 mg e pó oral em sachês.",
    "presentations": "Comprimidos mastigáveis 500/750/1.000 mg e pó oral em sachês.",
    "mechanism": "Liga fosfato no trato gastrointestinal. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Biodisponibilidade oral <0,002%; alta ligação proteica; não metabolizado por CYP; eliminação biliar/fecal.",
    "indications": "Redução de fósforo em pacientes com DRC terminal em diálise.",
    "dose": "Iniciar 1.500 mg/dia divididos com refeições; titular a cada 2-3 semanas em incrementos de 750 mg/dia. Maioria requer 1.500-3.000 mg/dia.",
    "pediatricDose": "Segurança/eficácia não estabelecidas; não recomendado. AUTOMATABLE=NO.",
    "renalDose": "Indicado em diálise; sem ajuste adicional, titular pelo fósforo.",
    "hepaticDose": "Evitar em insuficiência grave; eliminação predominantemente biliar.",
    "commonAdverseEffects": "Náusea, vômito, dor abdominal, diarreia e constipação.",
    "dangerousAdverseEffects": "Obstrução/perfuração GI e impactação fecal.",
    "adverseEffects": "Náusea, vômito, dor abdominal, diarreia e constipação. Graves: Obstrução/perfuração GI e impactação fecal.",
    "contraindications": "Obstrução intestinal, íleo e impactação fecal; hipersensibilidade.",
    "interactions": "Separar fármacos de janela estreita/absorção dependente, como levotiroxina; quinolonas exigem intervalo conforme bula.",
    "monitoring": "Fósforo, Ca/PTH, sintomas GI, mastigação e adesão.",
    "administration": "Tomar com ou imediatamente após refeições. Mastigar completamente; pó misturado em pequena quantidade de alimento macio.",
    "preparation": "Não engolir comprimido inteiro; não dissolver pó em líquido.",
    "infusionProtocol": "Não aplicável.",
    "pregnancy": "Dados insuficientes; usar somente se benefício justificar.",
    "lactation": "Dados insuficientes; absorção sistêmica mínima.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Obstrução/perfuração GI e impactação fecal. Titulação bloqueada sem fósforo/Ca/PTH, diálise, função hepática, trânsito GI e lista de medicamentos.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=FOSRENOL",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://kdigo.org/guidelines/ckd-mbd/"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=FOSRENOL"
  },
  "es": {
    "name": "Carbonato de lantano",
    "class": "Quelante de fosfato sin calcio",
    "pharmacologicClass": "Fija fosfato en tracto gastrointestinal",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Comprimidos masticables 500/750/1.000 mg y polvo oral en sobres.",
    "presentations": "Comprimidos masticables 500/750/1.000 mg y polvo oral en sobres.",
    "mechanism": "Fija fosfato en tracto gastrointestinal. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Biodisponibilidad oral <0,002%; alta unión proteica; no metabolizado por CYP; eliminación biliar/fecal.",
    "indications": "Reducción de fósforo en pacientes con ERC terminal en diálisis.",
    "dose": "Iniciar 1.500 mg/día divididos con comidas; titular cada 2-3 semanas en incrementos de 750 mg/día. La mayoría requiere 1.500-3.000 mg/día.",
    "pediatricDose": "Seguridad/eficacia no establecidas; no recomendado. AUTOMATABLE=NO.",
    "renalDose": "Indicado en diálisis; sin ajuste adicional, titular por fósforo.",
    "hepaticDose": "Evitar en insuficiencia grave; eliminación principalmente biliar.",
    "commonAdverseEffects": "Náusea, vómito, dolor abdominal, diarrea y estreñimiento.",
    "dangerousAdverseEffects": "Obstrucción/perforación GI e impactación fecal.",
    "adverseEffects": "Náusea, vómito, dolor abdominal, diarrea y estreñimiento. Graves: Obstrucción/perforación GI e impactación fecal.",
    "contraindications": "Obstrucción intestinal, íleo e impactación fecal; hipersensibilidad.",
    "interactions": "Separar fármacos de ventana estrecha/absorción dependiente, como levotiroxina; quinolonas requieren intervalo según ficha.",
    "monitoring": "Fósforo, Ca/PTH, síntomas GI, masticación y adherencia.",
    "administration": "Tomar con o inmediatamente después de comidas. Masticar completamente; polvo mezclado con poca comida blanda.",
    "preparation": "No tragar comprimido entero; no disolver polvo en líquido.",
    "infusionProtocol": "No aplicable.",
    "pregnancy": "Datos insuficientes; usar solo si beneficio justifica.",
    "lactation": "Datos insuficientes; absorción sistémica mínima.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Obstrucción/perforación GI e impactación fecal. Titulação bloqueada sem fósforo/Ca/PTH, diálise, função hepática, trânsito GI e lista de medicamentos.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=FOSRENOL",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://kdigo.org/guidelines/ckd-mbd/"
    ],
...
/* GOLD33_SELECTIVE:carbonato_de_lantanio:END */
/* GOLD33_SELECTIVE:carboximaltose_ferrica:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["carboximaltose_ferrica"])throw new Error("GOLD33_MISSING_CANONICAL:carboximaltose_ferrica");db["carboximaltose_ferrica"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "014",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Carboximaltose férrica",
    "class": "Ferro intravenoso",
    "pharmacologicClass": "Complexo férrico que repõe ferro biodisponível",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Injeção 50 mg de ferro/mL em frascos de 100/500/750/1.000 mg conforme mercado.",
    "presentations": "Injeção 50 mg de ferro/mL em frascos de 100/500/750/1.000 mg conforme mercado.",
    "mechanism": "Complexo férrico que repõe ferro biodisponível. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Captação pelo sistema reticuloendotelial; liberação gradual para transferrina; meia-vida plasmática 7-12 h; eliminação renal mínima.",
    "indications": "Deficiência de ferro quando ferro oral é intolerado/ineficaz; e indicação específica em IC conforme produto.",
    "dose": "≥50 kg: 750 mg IV, repetir após ≥7 dias (curso 1.500 mg), ou 15 mg/kg até 1.000 mg como dose única conforme rótulo. <50 kg: 15 mg/kg em 2 doses separadas ≥7 dias.",
    "pediatricDose": "≥1 ano com intolerância/resposta inadequada ao ferro oral: 15 mg/kg, máximo conforme peso/rótulo. AUTOMATABLE=YES apenas com produto, peso e indicação.",
    "renalDose": "Sem ajuste; experiência em diálise varia e depende da indicação.",
    "hepaticDose": "Sem ajuste formal; cautela em sobrecarga/lesão hepática.",
    "commonAdverseEffects": "Náusea, hipertensão, rubor, cefaleia, reação no local e hipofosfatemia.",
    "dangerousAdverseEffects": "Anafilaxia, hipofosfatemia sintomática/osteomalácia, hipotensão e lesão por extravasamento.",
    "adverseEffects": "Náusea, hipertensão, rubor, cefaleia, reação no local e hipofosfatemia. Graves: Anafilaxia, hipofosfatemia sintomática/osteomalácia, hipotensão e lesão por extravasamento.",
    "contraindications": "Hipersensibilidade grave ao produto/excipientes; sobrecarga de ferro.",
    "interactions": "Poucas interações sistêmicas; ferro oral concomitante é desnecessário e absorção pode ficar reduzida.",
    "monitoring": "Hb, ferritina, TSAT, fósforo sérico em repetição/risco, PA e hipersensibilidade.",
    "administration": "IV lenta ou infusão conforme dose e produto; observar durante e ≥30 min após.",
    "preparation": "Diluir apenas em SF 0,9% na concentração permitida; não misturar com outros fármacos.",
    "infusionProtocol": "Tempos mínimos variam por dose; confirmar bula. Evitar extravasamento.",
    "pregnancy": "Dados disponíveis não mostram sinal claro; usar quando benefício justificar.",
    "lactation": "Dados limitados; considerar benefício.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Anafilaxia, hipofosfatemia sintomática/osteomalácia, hipotensão e lesão por extravasamento. Dose/infusão bloqueadas sem peso, Hb/ferritina/TSAT, fósforo, produto, dose prévia e plano de observação.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=INJECTAFER",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2023/203565s020lbl.pdf"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=INJECTAFER"
  },
  "es": {
    "name": "Carboximaltosa férrica",
    "class": "Hierro intravenoso",
    "pharmacologicClass": "Complejo férrico que repone hierro biodisponible",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Inyección 50 mg de hierro/mL en viales de 100/500/750/1.000 mg según mercado.",
    "presentations": "Inyección 50 mg de hierro/mL en viales de 100/500/750/1.000 mg según mercado.",
    "mechanism": "Complejo férrico que repone hierro biodisponible. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Captación por sistema reticuloendotelial; liberación gradual a transferrina; semivida plasmática 7-12 h; eliminación renal mínima.",
    "indications": "Deficiencia de hierro cuando hierro oral es intolerado/ineficaz; e indicación específica en IC según producto.",
    "dose": "≥50 kg: 750 mg IV, repetir tras ≥7 días (curso 1.500 mg), o 15 mg/kg hasta 1.000 mg como dosis única según ficha. <50 kg: 15 mg/kg en 2 dosis separadas ≥7 días.",
    "pediatricDose": "≥1 año con intolerancia/respuesta inadecuada a hierro oral: 15 mg/kg, máximo según peso/ficha. AUTOMATABLE=YES solo con producto, peso e indicación.",
    "renalDose": "Sin ajuste; experiencia en diálisis variable según indicación.",
    "hepaticDose": "Sin ajuste formal; precaución en sobrecarga/lesión hepática.",
    "commonAdverseEffects": "Náusea, hipertensión, rubor, cefalea, reacción local e hipofosfatemia.",
    "dangerousAdverseEffects": "Anafilaxia, hipofosfatemia sintomática/osteomalacia, hipotensión y lesión por extravasación.",
    "adverseEffects": "Náusea, hipertensión, rubor, cefalea, reacción local e hipofosfatemia. Graves: Anafilaxia, hipofosfatemia sintomática/osteomalacia, hipotensión y lesión por extravasación.",
    "contraindications": "Hipersensibilidad grave al producto/excipientes; sobrecarga de hierro.",
    "interactions": "Pocas interacciones sistémicas; hierro oral concomitante innecesario y absorción puede reducirse.",
    "monitoring": "Hb, ferritina, TSAT, fósforo sérico en repetición/riesgo, PA e hipersensibilidad.",
    "administration": "IV lenta o infusión según dosis y producto; observar durante y ≥30 min después.",
    "preparation": "Diluir solo en SS 0,9% a concentración permitida; no mezclar con otros fármacos.",
    "infusionProtocol": "Tiempos mínimos varían por dosis; confirmar ficha. Evitar extravasación.",
    "pregnancy": "Datos disponibles sin señal clara; usar cuando beneficio justifique.",
    "lactation": "Datos limitados; considerar beneficio.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Anafilaxia, hipofosfatemia sintomática/osteomalacia, hipotensión y lesión por extravasación. Dose/infusão bloqueadas sem peso, Hb/ferritina/TSAT, fósforo, produto, dose prévia e plano de observação.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=INJECTAFER",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2023/203565s020lbl.pdf"
    ],
...
/* GOLD33_SELECTIVE:carboximaltose_ferrica:END */
/* GOLD33_SELECTIVE:ciclossilicato_de_zirconio_sodico:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["ciclossilicato_de_zirconio_sodico"])throw new Error("GOLD33_MISSING_CANONICAL:ciclossilicato_de_zirconio_sodico");db["ciclossilicato_de_zirconio_sodico"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "018",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Ciclossilicato de zircônio sódico",
    "class": "Quelante intestinal de potássio",
    "pharmacologicClass": "Troca seletiva de cátions no trato gastrointestinal",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Sachês de pó oral 5 e 10 g.",
    "presentations": "Sachês de pó oral 5 e 10 g.",
    "mechanism": "Troca seletiva de cátions no trato gastrointestinal. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Ação local GI; excretado nas fezes sem absorção.",
    "indications": "Tratamento da hipercalemia; não indicado como terapia de emergência isolada.",
    "dose": "Correção: 10 g VO 3x/dia por até 48 h. Manutenção: 10 g/dia, ajustar em passos de 5 g; faixa 5 g em dias alternados a 15 g/dia.",
    "pediatricDose": "Segurança/eficácia pediátrica não estabelecidas. AUTOMATABLE=NO.",
    "renalDose": "Sem ajuste; em hemodiálise usar apenas em dias sem diálise conforme rótulo e K pré-diálise.",
    "hepaticDose": "Sem ajuste estabelecido.",
    "commonAdverseEffects": "Edema e hipocalemia.",
    "dangerousAdverseEffects": "Hipocalemia importante e sobrecarga de sódio/edema.",
    "adverseEffects": "Edema e hipocalemia. Graves: Hipocalemia importante e sobrecarga de sódio/edema.",
    "contraindications": "Hipersensibilidade; cautela em edema e distúrbios graves de motilidade.",
    "interactions": "Pode alterar absorção por mudança transitória do pH gástrico; separar medicamentos dependentes de pH.",
    "monitoring": "Potássio, ECG se grave, edema/peso, sódio e resposta dialítica.",
    "administration": "VO; separar outros fármacos orais geralmente por 2 h.",
    "preparation": "Suspender o conteúdo em água, agitar e ingerir imediatamente; repetir água no copo.",
    "infusionProtocol": "Não aplicável.",
    "pregnancy": "Não absorvido sistemicamente; risco fetal improvável.",
    "lactation": "Não absorvido sistemicamente; exposição pelo leite improvável.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Hipocalemia importante e sobrecarga de sódio/edema. Uso bloqueado como única medida em hipercalemia com instabilidade/ECG; dose exige K, diálise, edema e medicamentos concomitantes.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=LOKELMA",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.fda.gov/media/113526/download"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=LOKELMA"
  },
  "es": {
    "name": "Ciclosilicato de zirconio sódico",
    "class": "Quelante intestinal de potasio",
    "pharmacologicClass": "Intercambio selectivo de cationes en tracto gastrointestinal",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Sobres de polvo oral 5 y 10 g.",
    "presentations": "Sobres de polvo oral 5 y 10 g.",
    "mechanism": "Intercambio selectivo de cationes en tracto gastrointestinal. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Acción local GI; excretado en heces sin absorción.",
    "indications": "Tratamiento de hiperpotasemia; no indicado como terapia de emergencia aislada.",
    "dose": "Corrección: 10 g VO 3 veces/día hasta 48 h. Mantenimiento: 10 g/día, ajustar en pasos de 5 g; rango 5 g en días alternos a 15 g/día.",
    "pediatricDose": "Seguridad/eficacia pediátrica no establecidas. AUTOMATABLE=NO.",
    "renalDose": "Sin ajuste; en hemodiálisis usar solo días sin diálisis según ficha y K prediálisis.",
    "hepaticDose": "Sin ajuste establecido.",
    "commonAdverseEffects": "Edema e hipopotasemia.",
    "dangerousAdverseEffects": "Hipopotasemia importante y sobrecarga de sodio/edema.",
    "adverseEffects": "Edema e hipopotasemia. Graves: Hipopotasemia importante y sobrecarga de sodio/edema.",
    "contraindications": "Hipersensibilidad; precaución en edema y trastornos graves de motilidad.",
    "interactions": "Puede alterar absorción por cambio transitorio del pH gástrico; separar fármacos dependientes del pH.",
    "monitoring": "Potasio, ECG si grave, edema/peso, sodio y respuesta dialítica.",
    "administration": "VO; separar otros fármacos orales generalmente 2 h.",
    "preparation": "Suspender contenido en agua, agitar e ingerir inmediatamente; repetir agua en el vaso.",
    "infusionProtocol": "No aplicable.",
    "pregnancy": "No se absorbe sistémicamente; riesgo fetal improbable.",
    "lactation": "No se absorbe sistémicamente; exposición por leche improbable.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Hipopotasemia importante y sobrecarga de sodio/edema. Uso bloqueado como única medida em hipercalemia com instabilidade/ECG; dose exige K, diálise, edema e medicamentos concomitantes.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=LOKELMA",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.fda.gov/media/113526/download"
    ],
...
/* GOLD33_SELECTIVE:ciclossilicato_de_zirconio_sodico:END */
/* GOLD33_SELECTIVE:cinacalcete:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["cinacalcete"])throw new Error("GOLD33_MISSING_CANONICAL:cinacalcete");db["cinacalcete"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "018",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Cinacalcete",
    "class": "Calcimimético",
    "pharmacologicClass": "Modulador alostérico positivo do receptor sensível ao cálcio",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Comprimidos 30, 60 e 90 mg.",
    "presentations": "Comprimidos 30, 60 e 90 mg.",
    "mechanism": "Modulador alostérico positivo do receptor sensível ao cálcio. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Metabolismo CYP3A4/1A2/2D6; meia-vida terminal 30–40 h.",
    "indications": "Hiperparatireoidismo secundário em adultos em diálise; hipercalcemia por carcinoma de paratireoide ou HPT primário selecionado.",
    "dose": "HPT secundário: 30 mg/dia, titular a cada 2–4 semanas até 180 mg/dia. Carcinoma/HPT primário: 30 mg 2x/dia, titular conforme cálcio.",
    "pediatricDose": "Não indicado para HPT secundário pediátrico no rótulo dos EUA; risco de hipocalcemia fatal. AUTOMATABLE=NO.",
    "renalDose": "Sem ajuste farmacocinético, mas indicação dialítica e cálcio determinam uso.",
    "hepaticDose": "Moderada/grave aumenta exposição; monitorar e titular com cautela.",
    "commonAdverseEffects": "Náusea, vômito, diarreia e parestesias.",
    "dangerousAdverseEffects": "Hipocalcemia, QT/arritmia, convulsão e sangramento GI.",
    "adverseEffects": "Náusea, vômito, diarreia e parestesias. Graves: Hipocalcemia, QT/arritmia, convulsão e sangramento GI.",
    "contraindications": "Cálcio sérico abaixo do limite inferior; hipersensibilidade.",
    "interactions": "Forte inibidor CYP2D6; níveis aumentam com inibidores CYP3A4; cautela com fármacos que prolongam QT.",
    "monitoring": "Cálcio/fósforo 1 semana após início/ajuste, PTH, QT se risco, convulsões e sintomas.",
    "administration": "VO com alimento ou logo após; engolir inteiro.",
    "preparation": "Comprimido pronto; não partir/triturar.",
    "infusionProtocol": "Não aplicável.",
    "pregnancy": "Dados insuficientes; benefício-risco.",
    "lactation": "Desconhecido no leite humano; decisão individual.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Hipocalcemia, QT/arritmia, convulsão e sangramento GI. Início/titulação bloqueados sem indicação, cálcio corrigido, fósforo, PTH, diálise, fígado e risco QT/convulsão.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=SENSIPAR",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2011/021688s017lbl.pdf"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=SENSIPAR"
  },
  "es": {
    "name": "Cinacalcet",
    "class": "Calcimimético",
    "pharmacologicClass": "Modulador alostérico positivo del receptor sensible al calcio",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Comprimidos 30, 60 y 90 mg.",
    "presentations": "Comprimidos 30, 60 y 90 mg.",
    "mechanism": "Modulador alostérico positivo del receptor sensible al calcio. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Metabolismo CYP3A4/1A2/2D6; semivida terminal 30–40 h.",
    "indications": "Hiperparatiroidismo secundario en adultos en diálisis; hipercalcemia por carcinoma paratiroideo o HPT primario seleccionado.",
    "dose": "HPT secundario: 30 mg/día, titular cada 2–4 semanas hasta 180 mg/día. Carcinoma/HPT primario: 30 mg 2 veces/día, titular según calcio.",
    "pediatricDose": "No indicado para HPT secundario pediátrico en ficha de EE. UU.; riesgo de hipocalcemia fatal. AUTOMATABLE=NO.",
    "renalDose": "Sin ajuste farmacocinético, pero indicación dialítica y calcio determinan uso.",
    "hepaticDose": "Moderada/grave aumenta exposición; monitorizar y titular con cautela.",
    "commonAdverseEffects": "Náusea, vómito, diarrea y parestesias.",
    "dangerousAdverseEffects": "Hipocalcemia, QT/arritmia, convulsión y sangrado GI.",
    "adverseEffects": "Náusea, vómito, diarrea y parestesias. Graves: Hipocalcemia, QT/arritmia, convulsión y sangrado GI.",
    "contraindications": "Calcio sérico por debajo del límite inferior; hipersensibilidad.",
    "interactions": "Inhibidor fuerte CYP2D6; niveles aumentan con inhibidores CYP3A4; precaución con fármacos que prolongan QT.",
    "monitoring": "Calcio/fósforo 1 semana tras inicio/ajuste, PTH, QT si riesgo, convulsiones y síntomas.",
    "administration": "VO con alimentos o justo después; tragar entero.",
    "preparation": "Comprimido listo; no partir/triturar.",
    "infusionProtocol": "No aplicable.",
    "pregnancy": "Datos insuficientes; beneficio-riesgo.",
    "lactation": "Desconocido en leche humana; decisión individual.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Hipocalcemia, QT/arritmia, convulsión y sangrado GI. Início/titulação bloqueados sem indicação, cálcio corrigido, fósforo, PTH, diálise, fígado e risco QT/convulsão.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=SENSIPAR",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2011/021688s017lbl.pdf"
    ],
...
/* GOLD33_SELECTIVE:cinacalcete:END */
/* GOLD33_SELECTIVE:cisteamina:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["cisteamina"])throw new Error("GOLD33_MISSING_CANONICAL:cisteamina");db["cisteamina"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "018",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Cisteamina",
    "class": "Agente depletor de cistina lisossomal",
    "pharmacologicClass": "Converte cistina em produtos que deixam o lisossomo",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Cápsulas IR ou DR, grânulos orais e solução oftálmica conforme produto.",
    "presentations": "Cápsulas IR ou DR, grânulos orais e solução oftálmica conforme produto.",
    "mechanism": "Converte cistina em produtos que deixam o lisossomo. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Metabolismo e eliminação não totalmente definidos; resposta guiada por cistina leucocitária.",
    "indications": "Cistinose nefropática; formulações oral e oftálmica têm usos distintos.",
    "dose": "Oral baseada em superfície corporal: iniciar gradualmente; manutenção rotulada frequentemente 1,3 g/m²/dia, máximo 1,95 g/m²/dia, dividida conforme formulação.",
    "pediatricDose": "Mesma base por m², com titulação lenta e leucócitos de cistina; <1 ano exige centro especializado. AUTOMATABLE=NO.",
    "renalDose": "Sem ajuste fixo; monitorar doença renal e perdas eletrolíticas da cistinose.",
    "hepaticDose": "Cautela e monitorização; dados limitados.",
    "commonAdverseEffects": "Náusea, vômito, anorexia, dor abdominal, hálito/odor e sonolência.",
    "dangerousAdverseEffects": "Úlcera/sangramento GI, leucopenia, hepatotoxicidade, lesões cutâneas/ósseas, convulsão e hipertensão intracraniana.",
    "adverseEffects": "Náusea, vômito, anorexia, dor abdominal, hálito/odor e sonolência. Graves: Úlcera/sangramento GI, leucopenia, hepatotoxicidade, lesões cutâneas/ósseas, convulsão e hipertensão intracraniana.",
    "contraindications": "Hipersensibilidade à cisteamina/penicilamina.",
    "interactions": "Álcool pode alterar liberação da forma DR; revisar interações e alimentação.",
    "monitoring": "Cistina leucocitária, crescimento, hemograma, fígado, pele/osso, sintomas GI, neurologia e pressão intracraniana.",
    "administration": "Regras de jejum variam entre IR e DR; não intercambiar.",
    "preparation": "Cápsulas podem ter instruções específicas para abrir/misturar; seguir exatamente o produto.",
    "infusionProtocol": "Não aplicável à forma oral.",
    "pregnancy": "Dados limitados; decisão especializada e controle da doença.",
    "lactation": "Amamentação geralmente não recomendada durante tratamento sistêmico.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Úlcera/sangramento GI, leucopenia, hepatotoxicidade, lesões cutâneas/ósseas, convulsão e hipertensão intracraniana. Dose bloqueada sem formulação IR/DR, superfície corporal, idade, cistina leucocitária, tolerância GI e monitorização especializada.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=cysteamine",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.fda.gov/drugsatfda-documents-regulatory-information"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=cysteamine"
  },
  "es": {
    "name": "Cisteamina",
    "class": "Agente reductor de cistina lisosomal",
    "pharmacologicClass": "Convierte cistina en productos que salen del lisosoma",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Cápsulas IR o DR, gránulos orales y solución oftálmica según producto.",
    "presentations": "Cápsulas IR o DR, gránulos orales y solución oftálmica según producto.",
    "mechanism": "Convierte cistina en productos que salen del lisosoma. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Metabolismo y eliminación no totalmente definidos; respuesta guiada por cistina leucocitaria.",
    "indications": "Cistinosis nefropática; formulaciones oral y oftálmica tienen usos distintos.",
    "dose": "Oral basada en superficie corporal: iniciar gradualmente; mantenimiento autorizado frecuentemente 1,3 g/m²/día, máximo 1,95 g/m²/día, dividida según formulación.",
    "pediatricDose": "Misma base por m², con titulación lenta y cistina leucocitaria; <1 año requiere centro especializado. AUTOMATABLE=NO.",
    "renalDose": "Sin ajuste fijo; monitorizar enfermedad renal y pérdidas electrolíticas por cistinosis.",
    "hepaticDose": "Precaución y monitorización; datos limitados.",
    "commonAdverseEffects": "Náusea, vómito, anorexia, dolor abdominal, aliento/olor y somnolencia.",
    "dangerousAdverseEffects": "Úlcera/sangrado GI, leucopenia, hepatotoxicidad, lesiones cutáneas/óseas, convulsión e hipertensión intracraneal.",
    "adverseEffects": "Náusea, vómito, anorexia, dolor abdominal, aliento/olor y somnolencia. Graves: Úlcera/sangrado GI, leucopenia, hepatotoxicidad, lesiones cutáneas/óseas, convulsión e hipertensión intracraneal.",
    "contraindications": "Hipersensibilidad a cisteamina/penicilamina.",
    "interactions": "Alcohol puede alterar liberación de forma DR; revisar interacciones y alimentación.",
    "monitoring": "Cistina leucocitaria, crecimiento, hemograma, hígado, piel/hueso, síntomas GI, neurología y presión intracraneal.",
    "administration": "Reglas de ayuno varían entre IR y DR; no intercambiar.",
    "preparation": "Cápsulas pueden tener instrucciones específicas para abrir/mezclar; seguir exactamente el producto.",
    "infusionProtocol": "No aplicable a forma oral.",
    "pregnancy": "Datos limitados; decisión especializada y control de la enfermedad.",
    "lactation": "Lactancia generalmente no recomendada durante tratamiento sistémico.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Úlcera/sangrado GI, leucopenia, hepatotoxicidad, lesiones cutáneas/óseas, convulsión e hipertensión intracraneal. Dose bloqueada sem formulação IR/DR, superfície corporal, idade, cistina leucocitária, tolerância GI e monitorização especializada.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=cysteamine",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.fda.gov/drugsatfda-documents-regulatory-information"
    ],
...
/* GOLD33_SELECTIVE:cisteamina:END */
/* GOLD33_SELECTIVE:citrato_de_potassio:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["citrato_de_potassio"])throw new Error("GOLD33_MISSING_CANONICAL:citrato_de_potassio");db["citrato_de_potassio"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "019",
    "requiredFieldCount": 33,
  ...
  "pt": {
    ...
    "class": "Alcalinizante urinário",
    "pharmacologicClass": "Fornece citrato e aumenta pH/citrato urinários",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Comprimidos de liberação prolongada 5, 10 e 15 mEq.",
    "presentations": "Comprimidos de liberação prolongada 5, 10 e 15 mEq.",
    "mechanism": "Fornece citrato e aumenta pH/citrato urinários. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Citrato metabolizado a bicarbonato; potássio eliminado pelos rins.",
    "indications": "Cálculos renais por hipocitratúria e acidose tubular renal; prevenção selecionada de cálculos de ácido úrico.",
    "dose": "Hipocitratúria grave: iniciar 60 mEq/dia; leve/moderada: 30 mEq/dia, divididos com refeições. Titular por citrato e pH urinários; evitar >100 mEq/dia sem protocolo especializado.",
    "pediatricDose": "Segurança/eficácia não estabelecidas. AUTOMATABLE=NO.",
    "renalDose": "Contraindicado em insuficiência renal importante por risco de hipercalemia.",
    "hepaticDose": "Sem ajuste específico; monitorar.",
    "commonAdverseEffects": "Náusea, vômito, dor abdominal e diarreia.",
    "dangerousAdverseEffects": "Hipercalemia/arritmia e ulceração, obstrução ou perfuração GI.",
    "adverseEffects": "Náusea, vômito, dor abdominal e diarreia. Graves: Hipercalemia/arritmia e ulceração, obstrução ou perfuração GI.",
    "contraindications": "Hipercalemia, insuficiência renal, infecção urinária ativa, obstrução/retardo GI, úlcera péptica ativa e insuficiência adrenal.",
    "interactions": "IECA/BRA, poupadores de K, AINE e outros produtos com potássio.",
    "monitoring": "K, bicarbonato, creatinina, ECG se risco, urina 24 h, pH e citrato urinários.",
    "administration": "VO com refeições/lanche e água; engolir inteiro.",
    "preparation": "Não esmagar, mastigar ou dissolver comprimido ER.",
    "infusionProtocol": "Não aplicável.",
    "pregnancy": "Usar somente se indicado e monitorado.",
    ...
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Hipercalemia/arritmia e ulceração, obstrução ou perfuração GI. Dose bloqueada sem diagnóstico metabólico, K, eGFR, pH/citrato urinários e revisão de fármacos que elevam K.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=potassium+citrate",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2009/019071s015lbl.pdf"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=potassium+citrate"
  },
  "es": {
    "name": "Citrato de potasio",
    "class": "Alcalinizante urinario",
    "pharmacologicClass": "Aporta citrato y aumenta pH/citrato urinarios",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Comprimidos de liberación prolongada 5, 10 y 15 mEq.",
    "presentations": "Comprimidos de liberación prolongada 5, 10 y 15 mEq.",
    "mechanism": "Aporta citrato y aumenta pH/citrato urinarios. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Citrato metabolizado a bicarbonato; potasio eliminado por riñones.",
    "indications": "Cálculos renales por hipocitraturia y acidosis tubular renal; prevención seleccionada de cálculos de ácido úrico.",
    "dose": "Hipocitraturia grave: iniciar 60 mEq/día; leve/moderada: 30 mEq/día, divididos con comidas. Titular por citrato y pH urinarios; evitar >100 mEq/día sin protocolo especializado.",
    "pediatricDose": "Seguridad/eficacia no establecidas. AUTOMATABLE=NO.",
    "renalDose": "Contraindicado en insuficiencia renal importante por riesgo de hiperpotasemia.",
    "hepaticDose": "Sin ajuste específico; monitorizar.",
    "commonAdverseEffects": "Náusea, vómito, dolor abdominal y diarrea.",
    "dangerousAdverseEffects": "Hiperpotasemia/arritmia y ulceración, obstrucción o perforación GI.",
    "adverseEffects": "Náusea, vómito, dolor abdominal y diarrea. Graves: Hiperpotasemia/arritmia y ulceración, obstrucción o perforación GI.",
    "contraindications": "Hiperpotasemia, insuficiencia renal, infección urinaria activa, obstrucción/retardo GI, úlcera péptica activa e insuficiencia suprarrenal.",
    "interactions": "IECA/ARA-II, ahorradores de K, AINE y otros productos con potasio.",
    "monitoring": "K, bicarbonato, creatinina, ECG si riesgo, orina 24 h, pH y citrato urinarios.",
    "administration": "VO con comidas/colación y agua; tragar entero.",
    "preparation": "No triturar, masticar ni disolver comprimido ER.",
    "infusionProtocol": "No aplicable.",
    "pregnancy": "Usar solo si está indicado y monitorizado.",
    "lactation": "Datos limitados; vigilar lactante si es necesario.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Hiperpotasemia/arritmia y ulceración, obstrucción o perforación GI. Dose bloqueada sem diagnóstico metabólico, K, eGFR, pH/citrato urinários e revisão de fármacos que elevam K.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=potassium+citrate",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2009/019071s015lbl.pdf"
    ],
...
/* GOLD33_SELECTIVE:citrato_de_potassio:END */
/* GOLD33_SELECTIVE:citrato_ferrico:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["citrato_ferrico"])throw new Error("GOLD33_MISSING_CANONICAL:citrato_ferrico");db["citrato_ferrico"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "019",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Citrato férrico",
    "class": "Quelante de fosfato com ferro",
    "pharmacologicClass": "Liga fosfato intestinal e fornece ferro absorvível",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Comprimido equivalente a 210 mg de ferro férrico.",
    "presentations": "Comprimido equivalente a 210 mg de ferro férrico.",
    "mechanism": "Liga fosfato intestinal e fornece ferro absorvível. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Ação intestinal; parte do ferro é absorvida e incorporada aos estoques.",
    "indications": "Controle de fósforo em DRC dialítica e anemia ferropriva em DRC não dialítica conforme rótulo.",
    "dose": "Hiperfosfatemia: 2 comprimidos VO 3x/dia com refeições, titular 1–2 comprimidos/dia em intervalos ≥1 semana; máximo 12/dia. Anemia DRC: 1 comprimido 3x/dia com refeições; máximo 12/dia.",
    "pediatricDose": "Não estabelecido. AUTOMATABLE=NO.",
    "renalDose": "Indicado em populações específicas com DRC; titular por fósforo/ferro.",
    "hepaticDose": "Sem ajuste específico.",
    "commonAdverseEffects": "Diarreia, fezes escuras, constipação, náusea e dor abdominal.",
    "dangerousAdverseEffects": "Sobrecarga de ferro e alterações GI graves.",
    "adverseEffects": "Diarreia, fezes escuras, constipação, náusea e dor abdominal. Graves: Sobrecarga de ferro e alterações GI graves.",
    "contraindications": "Síndrome de sobrecarga de ferro e hipersensibilidade.",
    "interactions": "Pode reduzir absorção de doxiciclina e ciprofloxacino; separar conforme rótulo.",
    "monitoring": "Fósforo, ferritina, TSAT, Hb e sintomas GI.",
    "administration": "VO com refeições; não usar como substituto automático de ferro IV.",
    "preparation": "Comprimido pronto.",
    "infusionProtocol": "Não aplicável.",
    "pregnancy": "Dados insuficientes; excesso de ferro pode causar dano fetal.",
    "lactation": "Ferro é componente do leite; decisão individual.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Sobrecarga de ferro e alterações GI graves. Uso bloqueado sem indicação DRC, fósforo, ferritina/TSAT, Hb, sobrecarga de ferro e interações de absorção.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=AURYXIA",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2017/205874s013lbl.pdf"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=AURYXIA"
  },
  "es": {
    "name": "Citrato férrico",
    "class": "Quelante de fosfato con hierro",
    "pharmacologicClass": "Une fosfato intestinal y aporta hierro absorbible",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Comprimido equivalente a 210 mg de hierro férrico.",
    "presentations": "Comprimido equivalente a 210 mg de hierro férrico.",
    "mechanism": "Une fosfato intestinal y aporta hierro absorbible. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Acción intestinal; parte del hierro se absorbe e incorpora a depósitos.",
    "indications": "Control de fósforo en ERC dialítica y anemia ferropénica en ERC no dialítica según ficha.",
    "dose": "Hiperfosfatemia: 2 comprimidos VO 3 veces/día con comidas, titular 1–2 comprimidos/día en intervalos ≥1 semana; máximo 12/día. Anemia ERC: 1 comprimido 3 veces/día con comidas; máximo 12/día.",
    "pediatricDose": "No establecido. AUTOMATABLE=NO.",
    "renalDose": "Indicado en poblaciones específicas con ERC; titular por fósforo/hierro.",
    "hepaticDose": "Sin ajuste específico.",
    "commonAdverseEffects": "Diarrea, heces oscuras, estreñimiento, náusea y dolor abdominal.",
    "dangerousAdverseEffects": "Sobrecarga de hierro y alteraciones GI graves.",
    "adverseEffects": "Diarrea, heces oscuras, estreñimiento, náusea y dolor abdominal. Graves: Sobrecarga de hierro y alteraciones GI graves.",
    "contraindications": "Síndrome de sobrecarga de hierro e hipersensibilidad.",
    "interactions": "Puede reducir absorción de doxiciclina y ciprofloxacino; separar según ficha.",
    "monitoring": "Fósforo, ferritina, TSAT, Hb y síntomas GI.",
    "administration": "VO con comidas; no usar como sustituto automático de hierro IV.",
    "preparation": "Comprimido listo.",
    "infusionProtocol": "No aplicable.",
    "pregnancy": "Datos insuficientes; exceso de hierro puede causar daño fetal.",
    "lactation": "Hierro es componente de la leche; decisión individual.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Sobrecarga de hierro y alteraciones GI graves. Uso bloqueado sem indicação DRC, fósforo, ferritina/TSAT, Hb, sobrecarga de ferro e interações de absorção.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=AURYXIA",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2017/205874s013lbl.pdf"
    ],
...
/* GOLD33_SELECTIVE:citrato_ferrico:END */
/* GOLD33_SELECTIVE:citrato_sodio_acido_citrico:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["citrato_sodio_acido_citrico"])throw new Error("GOLD33_MISSING_CANONICAL:citrato_sodio_acido_citrico");db["citrato_sodio_acido_citrico"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "019",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Citrato de sódio + ácido cítrico",
    "class": "Alcalinizante sistêmico/urinário",
    "pharmacologicClass": "Citrato metabolizado a bicarbonato",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Solução oral; cada produto possui concentração e mEq próprios.",
    "presentations": "Solução oral; cada produto possui concentração e mEq próprios.",
    "mechanism": "Citrato metabolizado a bicarbonato. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Citrato convertido a bicarbonato; excreção renal dependente do estado ácido-base.",
    "indications": "Correção de acidose metabólica crônica e alcalinização urinária em situações selecionadas.",
    "dose": "Regimes usuais do rótulo variam de 10–30 mL diluídos após refeições e ao deitar; a dose deve ser titulada por bicarbonato/pH e concentração exata.",
    "pediatricDose": "Dose por mL/kg existe conforme indicação, mas depende da concentração e eletrólitos. AUTOMATABLE=NO.",
    "renalDose": "Cautela/evitar em insuficiência renal grave e retenção de sódio.",
    "hepaticDose": "Sem ajuste formal; monitorar equilíbrio ácido-base.",
    "commonAdverseEffects": "Náusea, vômito, diarreia e distensão.",
    "dangerousAdverseEffects": "Alcalose metabólica, hipernatremia, sobrecarga volêmica e tetania.",
    "adverseEffects": "Náusea, vômito, diarreia e distensão. Graves: Alcalose metabólica, hipernatremia, sobrecarga volêmica e tetania.",
    "contraindications": "Alcalose, hipernatremia e situações com restrição rigorosa de sódio conforme produto.",
    "interactions": "Pode alterar absorção/excreção de fármacos dependentes do pH; alumínio pode ter absorção aumentada.",
    "monitoring": "Na, K, bicarbonato, pH, volume/edema, PA e função renal.",
    "administration": "Diluir em água; administrar após refeições para tolerância.",
    "preparation": "Confirmar mEq de sódio e bicarbonato equivalente por mL do produto.",
    "infusionProtocol": "Não aplicável.",
    "pregnancy": "Usar somente se necessário e monitorado.",
    "lactation": "Compatibilidade provável, mas considerar carga de sódio materna.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Alcalose metabólica, hipernatremia, sobrecarga volêmica e tetania. Cálculo bloqueado sem produto/concentração, indicação, peso pediátrico, eletrólitos, função renal e estado volêmico.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=sodium+citrate+citric+acid",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/scripts/cder/daf/"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=sodium+citrate+citric+acid"
  },
  "es": {
    "name": "Citrato de sodio + ácido cítrico",
    "class": "Alcalinizante sistémico/urinario",
    "pharmacologicClass": "Citrato metabolizado a bicarbonato",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Solución oral; cada producto tiene concentración y mEq propios.",
    "presentations": "Solución oral; cada producto tiene concentración y mEq propios.",
    "mechanism": "Citrato metabolizado a bicarbonato. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Citrato convertido a bicarbonato; excreción renal según estado ácido-base.",
    "indications": "Corrección de acidosis metabólica crónica y alcalinización urinaria en situaciones seleccionadas.",
    "dose": "Regímenes usuales de ficha varían de 10–30 mL diluidos tras comidas y al acostarse; titular por bicarbonato/pH y concentración exacta.",
    "pediatricDose": "Dosis por mL/kg existe según indicación, pero depende de concentración y electrolitos. AUTOMATABLE=NO.",
    "renalDose": "Precaución/evitar en insuficiencia renal grave y retención de sodio.",
    "hepaticDose": "Sin ajuste formal; monitorizar equilibrio ácido-base.",
    "commonAdverseEffects": "Náusea, vómito, diarrea y distensión.",
    "dangerousAdverseEffects": "Alcalosis metabólica, hipernatremia, sobrecarga de volumen y tetania.",
    "adverseEffects": "Náusea, vómito, diarrea y distensión. Graves: Alcalosis metabólica, hipernatremia, sobrecarga de volumen y tetania.",
    "contraindications": "Alcalosis, hipernatremia y situaciones con restricción estricta de sodio según producto.",
    "interactions": "Puede alterar absorción/excreción de fármacos dependientes del pH; aluminio puede aumentar absorción.",
    "monitoring": "Na, K, bicarbonato, pH, volumen/edema, PA y función renal.",
    "administration": "Diluir en agua; administrar tras comidas para tolerancia.",
    "preparation": "Confirmar mEq de sodio y bicarbonato equivalente por mL del producto.",
    "infusionProtocol": "No aplicable.",
    "pregnancy": "Usar solo si es necesario y monitorizado.",
    "lactation": "Compatibilidad probable, pero considerar carga de sodio materna.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Alcalosis metabólica, hipernatremia, sobrecarga de volumen y tetania. Cálculo bloqueado sem produto/concentração, indicação, peso pediátrico, eletrólitos, função renal e estado volêmico.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=sodium+citrate+citric+acid",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/scripts/cder/daf/"
    ],
...
/* GOLD33_SELECTIVE:darbepoetina_alfa:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["darbepoetina_alfa"])throw new Error("GOLD33_MISSING_CANONICAL:darbepoetina_alfa");db["darbepoetina_alfa"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "023",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Darbepoetina alfa",
    "class": "Agente estimulador da eritropoiese",
    "pharmacologicClass": "Ativa receptor de eritropoietina e aumenta eritropoiese",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Seringas/frascos SC/IV em múltiplas concentrações de mcg.",
    "presentations": "Seringas/frascos SC/IV em múltiplas concentrações de mcg.",
    "mechanism": "Ativa receptor de eritropoietina e aumenta eritropoiese. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Meia-vida prolongada, maior por SC; depuração receptor-mediada.",
    "indications": "Anemia da DRC e anemia por quimioterapia mielossupressora em cenários rotulados.",
    "dose": "DRC: iniciar geralmente 0,45 mcg/kg IV/SC semanal ou 0,75 mcg/kg a cada 2 semanas conforme diálise/contexto; quimioterapia: 2,25 mcg/kg semanal ou 500 mcg a cada 3 semanas. Usar menor dose para reduzir transfusões.",
    "pediatricDose": "DRC pediátrica ≥1 mês: esquema por peso e tratamento prévio; titulação pelo Hb. AUTOMATABLE=NO.",
    "renalDose": "Indicação principal; ajustar pela resposta de Hb, ferro e diálise, não por depuração isolada.",
    "hepaticDose": "Sem ajuste específico; investigar outras causas.",
    "commonAdverseEffects": "Hipertensão, edema, dor e reação local.",
    "dangerousAdverseEffects": "Morte/IM/AVC/TEV, progressão tumoral, convulsão, PRCA e anafilaxia.",
    "adverseEffects": "Hipertensão, edema, dor e reação local. Graves: Morte/IM/AVC/TEV, progressão tumoral, convulsão, PRCA e anafilaxia.",
    "contraindications": "Hipertensão não controlada; aplasia pura de série vermelha após ESA.",
    "interactions": "Outros pró-trombóticos; resposta reduzida por inflamação/deficiência de ferro.",
    "monitoring": "Hb semanal no início, PA, ferro/TSAT/ferritina, trombose e resposta tumoral.",
    "administration": "SC ou IV; não agitar, proteger da luz e descartar seringa usada.",
    "preparation": "Não diluir nem misturar; confirmar concentração em mcg/mL.",
    "infusionProtocol": "IV em bolus conforme rótulo.",
    "pregnancy": "Dados limitados; usar apenas se necessário.",
    "lactation": "Dados limitados.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Morte/IM/AVC/TEV, progressão tumoral, convulsão, PRCA e anafilaxia. Dose/titulação bloqueadas sem indicação, Hb e tendência, PA, ferro, peso, diálise, risco trombótico e objetivo transfusional.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=darbepoetin+alfa",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.fda.gov/drugs/postmarket-drug-safety-information-patients-and-providers/information-erythropoiesis-stimulating-agents-esa"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=darbepoetin+alfa"
  },
  "es": {
    "name": "Darbepoetina alfa",
    "class": "Agente estimulante de eritropoyesis",
    "pharmacologicClass": "Activa receptor de eritropoyetina y aumenta eritropoyesis",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Jeringas/viales SC/IV en múltiples concentraciones de mcg.",
    "presentations": "Jeringas/viales SC/IV en múltiples concentraciones de mcg.",
    "mechanism": "Activa receptor de eritropoyetina y aumenta eritropoyesis. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Semivida prolongada, mayor por SC; depuración mediada por receptor.",
    "indications": "Anemia de ERC y anemia por quimioterapia mielosupresora en escenarios autorizados.",
    "dose": "ERC: iniciar generalmente 0,45 mcg/kg IV/SC semanal o 0,75 mcg/kg cada 2 semanas según diálisis/contexto; quimioterapia: 2,25 mcg/kg semanal o 500 mcg cada 3 semanas. Usar menor dosis para reducir transfusiones.",
    "pediatricDose": "ERC pediátrica ≥1 mes: esquema por peso y tratamiento previo; titulación por Hb. AUTOMATABLE=NO.",
    "renalDose": "Indicación principal; ajustar por respuesta de Hb, hierro y diálisis, no por depuración aislada.",
    "hepaticDose": "Sin ajuste específico; investigar otras causas.",
    "commonAdverseEffects": "Hipertensión, edema, dolor y reacción local.",
    "dangerousAdverseEffects": "Muerte/IM/ACV/TEV, progresión tumoral, convulsión, PRCA y anafilaxia.",
    "adverseEffects": "Hipertensión, edema, dolor y reacción local. Graves: Muerte/IM/ACV/TEV, progresión tumoral, convulsión, PRCA y anafilaxia.",
    "contraindications": "Hipertensión no controlada; aplasia pura de serie roja tras ESA.",
    "interactions": "Otros protrombóticos; respuesta reducida por inflamación/déficit de hierro.",
    "monitoring": "Hb semanal al inicio, PA, hierro/TSAT/ferritina, trombosis y respuesta tumoral.",
    "administration": "SC o IV; no agitar, proteger de luz y desechar jeringa usada.",
    "preparation": "No diluir ni mezclar; confirmar concentración en mcg/mL.",
    "infusionProtocol": "IV en bolo según ficha.",
    ...
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Muerte/IM/ACV/TEV, progresión tumoral, convulsión, PRCA y anafilaxia. Dose/titulação bloqueadas sem indicação, Hb e tendência, PA, ferro, peso, diálise, risco trombótico e objetivo transfusional.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=darbepoetin+alfa",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.fda.gov/drugs/postmarket-drug-safety-information-patients-and-providers/information-erythropoiesis-stimulating-agents-esa"
    ],
...
/* GOLD33_SELECTIVE:darbepoetina_alfa:END */
/* GOLD33_SELECTIVE:derisomaltose_ferrica:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["derisomaltose_ferrica"])throw new Error("GOLD33_MISSING_CANONICAL:derisomaltose_ferrica");db["derisomaltose_ferrica"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "023",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Derisomaltose férrica",
    "class": "Reposição de ferro intravenoso",
    "pharmacologicClass": "Complexo de ferro libera ferro utilizável para hemoglobina e estoques",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Solução IV 100 mg/mL em frascos.",
    "presentations": "Solução IV 100 mg/mL em frascos.",
    "mechanism": "Complexo de ferro libera ferro utilizável para hemoglobina e estoques. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Captação pelo sistema reticuloendotelial; ferro incorporado à Hb/estoques.",
    "indications": "Anemia ferropriva adulta com intolerância/resposta inadequada ao ferro oral ou DRC não dialítica.",
    "dose": "≥50 kg: 1000 mg IV dose única; <50 kg: 20 mg/kg IV dose única. Repetir somente após reavaliação.",
    "pediatricDose": "Não estabelecida. AUTOMATABLE=NO.",
    "renalDose": "Indicada em DRC não dialítica; sem ajuste específico, mas confirmar causa da anemia.",
    "hepaticDose": "Sem ajuste específico; cautela em sobrecarga de ferro.",
    "commonAdverseEffects": "Náusea, rash, reação no local.",
    "dangerousAdverseEffects": "Anafilaxia/hipotensão, sobrecarga de ferro e hipofosfatemia.",
    "adverseEffects": "Náusea, rash, reação no local. Graves: Anafilaxia/hipotensão, sobrecarga de ferro e hipofosfatemia.",
    "contraindications": "Hipersensibilidade a ferro parenteral; sobrecarga de ferro.",
    "interactions": "Poucas interações diretas; ferro oral pode ser desnecessário/conflitante.",
    "monitoring": "Hb, ferritina, TSAT, resposta, PA e hipersensibilidade; fósforo se risco/sintomas.",
    "administration": "IV diluída em ≥20 min ou injeção lenta conforme dose/rótulo; observar após.",
    "preparation": "Diluir somente em SF 0,9% até concentração permitida; não misturar.",
    "infusionProtocol": "Infusão de 1000 mg em pelo menos 20 min; equipe para anafilaxia disponível.",
    "pregnancy": "Dados crescentes, mas decisão individual.",
    ...
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Anafilaxia/hipotensão, sobrecarga de ferro e hipofosfatemia. Dose/infusão bloqueadas sem peso, Hb/ferritina/TSAT, causa da anemia, história de reação, concentração/diluente e capacidade de tratar anafilaxia.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=ferric+derisomaltose",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.fda.gov/drugsatfda"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=ferric+derisomaltose"
  },
  "es": {
    "name": "Derisomaltosa férrica",
    "class": "Reposición de hierro intravenoso",
    "pharmacologicClass": "Complejo de hierro libera hierro utilizable para hemoglobina y depósitos",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Solución IV 100 mg/mL en viales.",
    "presentations": "Solución IV 100 mg/mL en viales.",
    "mechanism": "Complejo de hierro libera hierro utilizable para hemoglobina y depósitos. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Captación por sistema reticuloendotelial; hierro incorporado a Hb/depósitos.",
    "indications": "Anemia ferropénica adulta con intolerancia/respuesta inadecuada a hierro oral o ERC no dialítica.",
    "dose": "≥50 kg: 1000 mg IV dosis única; <50 kg: 20 mg/kg IV dosis única. Repetir solo tras reevaluación.",
    "pediatricDose": "No establecida. AUTOMATABLE=NO.",
    "renalDose": "Indicada en ERC no dialítica; sin ajuste específico, pero confirmar causa de anemia.",
    "hepaticDose": "Sin ajuste específico; precaución en sobrecarga de hierro.",
    "commonAdverseEffects": "Náusea, erupción, reacción local.",
    "dangerousAdverseEffects": "Anafilaxia/hipotensión, sobrecarga de hierro e hipofosfatemia.",
    "adverseEffects": "Náusea, erupción, reacción local. Graves: Anafilaxia/hipotensión, sobrecarga de hierro e hipofosfatemia.",
    "contraindications": "Hipersensibilidad a hierro parenteral; sobrecarga de hierro.",
    "interactions": "Pocas interacciones directas; hierro oral puede ser innecesario/conflictivo.",
    "monitoring": "Hb, ferritina, TSAT, respuesta, PA e hipersensibilidad; fósforo si riesgo/síntomas.",
    "administration": "IV diluida en ≥20 min o inyección lenta según dosis/ficha; observar después.",
    "preparation": "Diluir solo en SF 0,9% hasta concentración permitida; no mezclar.",
    "infusionProtocol": "Infusión de 1000 mg en al menos 20 min; equipo para anafilaxia disponible.",
    "pregnancy": "Datos crecientes, pero decisión individual.",
    ...
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Anafilaxia/hipotensión, sobrecarga de hierro e hipofosfatemia. Dose/infusão bloqueadas sem peso, Hb/ferritina/TSAT, causa da anemia, história de reação, concentração/diluente e capacidade de tratar anafilaxia.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=ferric+derisomaltose",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.fda.gov/drugsatfda"
    ],
...
/* GOLD33_SELECTIVE:derisomaltose_ferrica:END */
/* GOLD33_SELECTIVE:dextrana_ferrica:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["dextrana_ferrica"])throw new Error("GOLD33_MISSING_CANONICAL:dextrana_ferrica");db["dextrana_ferrica"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "024",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Dextrana férrica",
    "class": "Reposição de ferro parenteral",
    "pharmacologicClass": "Complexo ferro-dextrana repõe ferro corporal",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Injeção 50 mg de ferro elemental/mL para IV ou IM conforme produto.",
    "presentations": "Injeção 50 mg de ferro elemental/mL para IV ou IM conforme produto.",
    "mechanism": "Complexo ferro-dextrana repõe ferro corporal. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Complexo captado pelo sistema reticuloendotelial e incorporado à Hb/estoques.",
    "indications": "Deficiência de ferro documentada em adultos e crianças ≥4 meses quando ferro oral é insatisfatório ou inviável.",
    "dose": "Calcular déficit total pela tabela/fórmula do rótulo com peso e Hb; administrar dose-teste antes da primeira dose terapêutica. Regime fracionado conforme produto.",
    "pediatricDose": "≥4 meses: cálculo por peso/Hb e dose-teste; não automatizar sem parâmetros e produto. AUTOMATABLE=NO.",
    "renalDose": "Sem ajuste isolado; evitar sobrecarga e interpretar ferro na DRC/inflamação.",
    "hepaticDose": "Sem ajuste fixo; cautela em hepatopatia/sobrecarga.",
    "commonAdverseEffects": "Dor local, náusea, rubor, mialgia e hipotensão.",
    "dangerousAdverseEffects": "Anafilaxia fatal, choque, sobrecarga de ferro e reação tardia.",
    "adverseEffects": "Dor local, náusea, rubor, mialgia e hipotensão. Graves: Anafilaxia fatal, choque, sobrecarga de ferro e reação tardia.",
    "contraindications": "Hipersensibilidade a ferro-dextrana; anemia não ferropriva ou sobrecarga de ferro.",
    "interactions": "Poucas interações diretas; evitar reposição oral simultânea desnecessária.",
    "monitoring": "Hb, ferritina, TSAT, resposta, PA e hipersensibilidade durante/depois.",
    "administration": "IV lenta ou IM profunda conforme rótulo; manter ressuscitação disponível e observar após.",
    "preparation": "Confirmar concentração e diluição; não misturar sem compatibilidade.",
    "infusionProtocol": "Dose-teste e velocidade conforme rótulo; interromper imediatamente se reação.",
    "pregnancy": "Usar apenas se claramente necessário; risco de reação materna/fetal.",
    "lactation": "Dados limitados; monitorar lactente.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Anafilaxia fatal, choque, sobrecarga de ferro e reação tardia. Cálculo/administração bloqueados sem peso, Hb, alvo, ferritina/TSAT, causa, produto, via, dose-teste e capacidade de tratar anafilaxia.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=iron+dextran",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://infed.com/"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=iron+dextran"
  },
  "es": {
    "name": "Dextrano férrico",
    "class": "Reposición de hierro parenteral",
    "pharmacologicClass": "Complejo hierro-dextrano repone hierro corporal",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Inyección 50 mg de hierro elemental/mL para IV o IM según producto.",
    "presentations": "Inyección 50 mg de hierro elemental/mL para IV o IM según producto.",
    "mechanism": "Complejo hierro-dextrano repone hierro corporal. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Complejo captado por sistema reticuloendotelial e incorporado a Hb/depósitos.",
    "indications": "Deficiencia de hierro documentada en adultos y niños ≥4 meses cuando hierro oral es insatisfactorio o inviable.",
    "dose": "Calcular déficit total por tabla/fórmula de ficha con peso y Hb; administrar dosis de prueba antes de primera dosis terapéutica. Régimen fraccionado según producto.",
    "pediatricDose": "≥4 meses: cálculo por peso/Hb y dosis de prueba; no automatizar sin parámetros y producto. AUTOMATABLE=NO.",
    "renalDose": "Sin ajuste aislado; evitar sobrecarga e interpretar hierro en ERC/inflamación.",
    "hepaticDose": "Sin ajuste fijo; precaución en hepatopatía/sobrecarga.",
    "commonAdverseEffects": "Dolor local, náusea, rubor, mialgia e hipotensión.",
    "dangerousAdverseEffects": "Anafilaxia fatal, choque, sobrecarga de hierro y reacción tardía.",
    "adverseEffects": "Dolor local, náusea, rubor, mialgia e hipotensión. Graves: Anafilaxia fatal, choque, sobrecarga de hierro y reacción tardía.",
    "contraindications": "Hipersensibilidad a hierro-dextrano; anemia no ferropénica o sobrecarga de hierro.",
    "interactions": "Pocas interacciones directas; evitar reposición oral simultánea innecesaria.",
    "monitoring": "Hb, ferritina, TSAT, respuesta, PA e hipersensibilidad durante/después.",
    "administration": "IV lenta o IM profunda según ficha; disponer reanimación y observar después.",
    "preparation": "Confirmar concentración y dilución; no mezclar sin compatibilidad.",
    "infusionProtocol": "Dosis de prueba y velocidad según ficha; suspender inmediatamente si reacción.",
    "pregnancy": "Usar solo si claramente necesario; riesgo de reacción materna/fetal.",
    "lactation": "Datos limitados; controlar lactante.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Anafilaxia fatal, choque, sobrecarga de hierro y reacción tardía. Cálculo/administração bloqueados sem peso, Hb, alvo, ferritina/TSAT, causa, produto, via, dose-teste e capacidade de tratar anafilaxia.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=iron+dextran",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://infed.com/"
    ],
...
/* GOLD33_SELECTIVE:dextrana_ferrica:END */
/* GOLD33_SELECTIVE:epoetina_alfa:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["epoetina_alfa"])throw new Error("GOLD33_MISSING_CANONICAL:epoetina_alfa");db["epoetina_alfa"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "030",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Epoetina alfa",
    "class": "Agente estimulador da eritropoiese",
    "pharmacologicClass": "Ativa receptor de eritropoietina e eritropoiese",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Frascos/seringas IV ou SC em múltiplas concentrações.",
    "presentations": "Frascos/seringas IV ou SC em múltiplas concentrações.",
    "mechanism": "Ativa receptor de eritropoietina e eritropoiese. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Glicoproteína; depuração por receptores/catabolismo.",
    "indications": "Anemia por DRC, quimioterapia, zidovudina e redução de transfusão perioperatória em critérios específicos.",
    "dose": "Dose depende da indicação. DRC adulta comum: 50–100 UI/kg IV/SC 3x/semana, individualizada; usar menor dose que evite transfusão.",
    "pediatricDose": "Esquemas por indicação e peso; DRC frequentemente 50 UI/kg 3x/semana. AUTOMATABLE=NO.",
    "renalDose": "Sem ajuste fixo além da titulação por Hb/resposta.",
    "hepaticDose": "Sem ajuste definido.",
    "commonAdverseEffects": "Hipertensão, artralgia, reação local e febre.",
    "dangerousAdverseEffects": "Morte/eventos CV/AVC/trombose, progressão tumoral e aplasia pura.",
    "adverseEffects": "Hipertensão, artralgia, reação local e febre. Graves: Morte/eventos CV/AVC/trombose, progressão tumoral e aplasia pura.",
    "contraindications": "Hipertensão não controlada; aplasia pura de série vermelha por ESA; hipersensibilidade.",
    "interactions": "Outros pró-trombóticos; resposta reduzida com deficiência de ferro/inflamação.",
    "monitoring": "Hb semanal até estável, ferro, PA, trombose e taxa de elevação da Hb.",
    "administration": "IV preferida em hemodiálise; SC em outros cenários. Não agitar.",
    ...
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Morte/eventos CV/AVC/trombose, progressão tumoral e aplasia pura. Cálculo/titulação bloqueados sem indicação, peso, Hb seriada, ferro, PA, risco trombótico/oncológico e alvo de menor dose.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=epoetin+alfa",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2017/103234s5369lbl.pdf"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=epoetin+alfa"
  },
  "es": {
    "name": "Epoetina alfa",
    "class": "Agente estimulante de eritropoyesis",
    "pharmacologicClass": "Activa receptor de eritropoyetina y eritropoyesis",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Viales/jeringas IV o SC en múltiples concentraciones.",
    "presentations": "Viales/jeringas IV o SC en múltiples concentraciones.",
    "mechanism": "Activa receptor de eritropoyetina y eritropoyesis. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Glucoproteína; depuración por receptores/catabolismo.",
    "indications": "Anemia por ERC, quimioterapia, zidovudina y reducción de transfusión perioperatoria en criterios específicos.",
    "dose": "Dosis depende de indicación. ERC adulta común: 50–100 UI/kg IV/SC 3 veces/semana, individualizada; usar menor dosis que evite transfusión.",
    "pediatricDose": "Pautas por indicación y peso; ERC frecuentemente 50 UI/kg 3 veces/semana. AUTOMATABLE=NO.",
    "renalDose": "Sin ajuste fijo además de titulación por Hb/respuesta.",
    "hepaticDose": "Sin ajuste definido.",
    "commonAdverseEffects": "Hipertensión, artralgia, reacción local y fiebre.",
    "dangerousAdverseEffects": "Muerte/eventos CV/ictus/trombosis, progresión tumoral y aplasia pura.",
    "adverseEffects": "Hipertensión, artralgia, reacción local y fiebre. Graves: Muerte/eventos CV/ictus/trombosis, progresión tumoral y aplasia pura.",
    "contraindications": "Hipertensión no controlada; aplasia pura de serie roja por ESA; hipersensibilidad.",
    "interactions": "Otros protrombóticos; respuesta reducida con deficiencia de hierro/inflamación.",
    "monitoring": "Hb semanal hasta estable, hierro, PA, trombosis y velocidad de aumento de Hb.",
    "administration": "IV preferida en hemodiálisis; SC en otros escenarios. No agitar.",
    ...
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Muerte/eventos CV/ictus/trombosis, progresión tumoral y aplasia pura. Cálculo/titulação bloqueados sem indicação, peso, Hb seriada, ferro, PA, risco trombótico/oncológico e alvo de menor dose.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=epoetin+alfa",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2017/103234s5369lbl.pdf"
    ],
...
/* GOLD33_SELECTIVE:epoetina_alfa:END */
/* GOLD33_SELECTIVE:epoetina_beta:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["epoetina_beta"])throw new Error("GOLD33_MISSING_CANONICAL:epoetina_beta");db["epoetina_beta"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "030",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Epoetina beta",
    "class": "Agente estimulador da eritropoiese",
    "pharmacologicClass": "Ativa receptor de eritropoietina",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Seringas/frascos IV ou SC em unidades variadas; produtos regionais.",
    "presentations": "Seringas/frascos IV ou SC em unidades variadas; produtos regionais.",
    "mechanism": "Ativa receptor de eritropoietina. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Glicoproteína de ação eritropoiética; meia-vida varia por via/produto.",
    "indications": "Anemia associada à DRC e indicações autorizadas regionalmente.",
    "dose": "Esquemas dependem do produto e indicação; em DRC, doses iniciais por peso 1–3x/semana com titulação por Hb. Não existe dose universal entre produtos. AUTOMATABLE=NO.",
    "pediatricDose": "Doses por peso e indicação; especialista. AUTOMATABLE=NO.",
    "renalDose": "Titular por Hb/resposta.",
    "hepaticDose": "Sem ajuste definido.",
    "commonAdverseEffects": "Hipertensão, cefaleia, reação local e sintomas gripais.",
    "dangerousAdverseEffects": "Eventos CV/trombose, aplasia pura e progressão tumoral em uso inadequado.",
    "adverseEffects": "Hipertensão, cefaleia, reação local e sintomas gripais. Graves: Eventos CV/trombose, aplasia pura e progressão tumoral em uso inadequado.",
    "contraindications": "Hipertensão não controlada, aplasia pura por ESA e hipersensibilidade.",
    "interactions": "Risco trombótico com agentes pró-coagulantes; corrigir ferro/inflamação.",
    "monitoring": "Hb, ferro, PA, trombose e resposta.",
    "administration": "IV/SC conforme produto; não agitar nem intercambiar biossimilares sem rastreabilidade.",
    "preparation": "Confirmar produto, concentração e apresentação; seguir rótulo oficial.",
    "infusionProtocol": "Não aplicável salvo apresentação parenteral; seguir protocolo do produto.",
    "pregnancy": "Usar somente após avaliação individual de benefício-risco e rotulagem específica.",
    "lactation": "Avaliar benefício materno, exposição do lactente e alternativas.",
    ...
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Eventos CV/trombose, aplasia pura e progressão tumoral em uso inadequado. Toda dose bloqueada sem país/produto, indicação, peso, Hb, ferro, PA e risco trombótico/oncológico.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://www.ema.europa.eu/en/medicines/human/EPAR/neorecormon",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://consultas.anvisa.gov.br/#/bulario/"
    ],
    "ref": "https://www.ema.europa.eu/en/medicines/human/EPAR/neorecormon"
  },
  "es": {
    "name": "Epoetina beta",
    "class": "Agente estimulante de eritropoyesis",
    "pharmacologicClass": "Activa receptor de eritropoyetina",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Jeringas/viales IV o SC en unidades variadas; productos regionales.",
    "presentations": "Jeringas/viales IV o SC en unidades variadas; productos regionales.",
    "mechanism": "Activa receptor de eritropoyetina. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Glucoproteína eritropoyética; semivida varía por vía/producto.",
    "indications": "Anemia asociada a ERC e indicaciones autorizadas regionalmente.",
    "dose": "Pautas dependen de producto e indicación; en ERC, dosis iniciales por peso 1–3 veces/semana con titulación por Hb. No existe dosis universal entre productos. AUTOMATABLE=NO.",
    "pediatricDose": "Dosis por peso e indicación; especialista. AUTOMATABLE=NO.",
    "renalDose": "Titular por Hb/respuesta.",
    "hepaticDose": "Sin ajuste definido.",
    "commonAdverseEffects": "Hipertensión, cefalea, reacción local y síntomas gripales.",
    "dangerousAdverseEffects": "Eventos CV/trombosis, aplasia pura y progresión tumoral en uso inadecuado.",
    "adverseEffects": "Hipertensión, cefalea, reacción local y síntomas gripales. Graves: Eventos CV/trombosis, aplasia pura y progresión tumoral en uso inadecuado.",
    "contraindications": "Hipertensión no controlada, aplasia pura por ESA e hipersensibilidad.",
    "interactions": "Riesgo trombótico con agentes procoagulantes; corregir hierro/inflamación.",
    "monitoring": "Hb, hierro, PA, trombosis y respuesta.",
    "administration": "IV/SC según producto; no agitar ni intercambiar biosimilares sin trazabilidad.",
    "preparation": "Confirmar producto, concentración y presentación; seguir ficha oficial.",
    "infusionProtocol": "No aplicable salvo presentación parenteral; seguir protocolo del producto.",
    "pregnancy": "Usar solo tras evaluación individual de beneficio-riesgo y ficha específica.",
    "lactation": "Evaluar beneficio materno, exposición del lactante y alternativas.",
    ...
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Eventos CV/trombosis, aplasia pura y progresión tumoral en uso inadecuado. Toda dose bloqueada sem país/produto, indicação, peso, Hb, ferro, PA e risco trombótico/oncológico.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://www.ema.europa.eu/en/medicines/human/EPAR/neorecormon",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://consultas.anvisa.gov.br/#/bulario/"
    ],
...
/* GOLD33_SELECTIVE:ferro_polimaltosado:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["ferro_polimaltosado"])throw new Error("GOLD33_MISSING_CANONICAL:ferro_polimaltosado");db["ferro_polimaltosado"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "034",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Complexo de hidróxido de ferro(III)-polimaltose",
    "class": "Repositor oral/parenteral de ferro conforme produto",
    "pharmacologicClass": "Complexo férrico de liberação controlada",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Gotas, xarope, comprimidos mastigáveis e algumas formas parenterais; concentrações regionais distintas.",
    "presentations": "Gotas, xarope, comprimidos mastigáveis e algumas formas parenterais; concentrações regionais distintas.",
    "mechanism": "Complexo férrico de liberação controlada. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Absorção regulada pelo estado de ferro; complexo é processado antes da incorporação.",
    "indications": "Deficiência de ferro; indicação, via e autorização variam amplamente por país/produto.",
    "dose": "Dose expressa em ferro elementar e depende do déficit/produto; não converter automaticamente entre apresentações.",
    "pediatricDose": "Dose em mg/kg de ferro elementar conforme idade, diagnóstico e produto local. AUTOMATABLE=NO.",
    "renalDose": "Sem ajuste fixo; confirmar causa da anemia e risco de sobrecarga.",
    "hepaticDose": "Sem ajuste fixo; cautela em hepatopatia/sobrecarga.",
    "commonAdverseEffects": "Náusea, dor abdominal, constipação/diarreia e fezes escuras.",
    "dangerousAdverseEffects": "Sobrecarga, reação de hipersensibilidade e intoxicação por ingestão acidental.",
    "adverseEffects": "Náusea, dor abdominal, constipação/diarreia e fezes escuras. Graves: Sobrecarga, reação de hipersensibilidade e intoxicação por ingestão acidental.",
    "contraindications": "Sobrecarga de ferro, anemias não ferropênicas e hipersensibilidade.",
    "interactions": "Pode reduzir absorção de tetraciclinas, quinolonas, levotiroxina e outros; separar conforme produto.",
    "monitoring": "Hemograma, ferritina, saturação de transferrina, reticulócitos e resposta.",
    "administration": "Via conforme produto; oral pode ser administrado com alimento se necessário.",
    "preparation": "Não fracionar/converter sem concentração de ferro elementar confirmada.",
    "infusionProtocol": "Somente se apresentação parenteral autorizada; seguir bula específica.",
    "pregnancy": "Tratar deficiência documentada; necessidade aumenta na gestação.",
    "lactation": "Compatível em geral; ajustar à necessidade materna.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Sobrecarga, reação de hipersensibilidade e intoxicação por ingestão acidental. Dose bloqueada sem país/produto, via, concentração de ferro elementar, peso, Hb, ferritina/TSAT e diagnóstico etiológico.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://www.anmat.gob.ar/Medicamentos/basedat.asp",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://consultas.anvisa.gov.br/#/bulario/"
    ],
    "ref": "https://www.anmat.gob.ar/Medicamentos/basedat.asp"
  },
  "es": {
    "name": "Complejo de hidróxido de hierro(III)-polimaltosa",
    "class": "Repositor oral/parenteral de hierro según producto",
    "pharmacologicClass": "Complejo férrico de liberación controlada",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Gotas, jarabe, masticables y algunas formas parenterales; concentraciones regionales distintas.",
    "presentations": "Gotas, jarabe, masticables y algunas formas parenterales; concentraciones regionales distintas.",
    "mechanism": "Complejo férrico de liberación controlada. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Absorción regulada por estado de hierro; complejo procesado antes de incorporación.",
    "indications": "Deficiencia de hierro; indicación, vía y autorización varían ampliamente por país/producto.",
    "dose": "Dosis expresada en hierro elemental y depende del déficit/producto; no convertir automáticamente entre presentaciones.",
    "pediatricDose": "Dosis en mg/kg de hierro elemental según edad, diagnóstico y producto local. AUTOMATABLE=NO.",
    "renalDose": "Sin ajuste fijo; confirmar causa de anemia y riesgo de sobrecarga.",
    "hepaticDose": "Sin ajuste fijo; precaución en hepatopatía/sobrecarga.",
    "commonAdverseEffects": "Náusea, dolor abdominal, estreñimiento/diarrea y heces oscuras.",
    "dangerousAdverseEffects": "Sobrecarga, reacción de hipersensibilidad e intoxicación por ingestión accidental.",
    "adverseEffects": "Náusea, dolor abdominal, estreñimiento/diarrea y heces oscuras. Graves: Sobrecarga, reacción de hipersensibilidad e intoxicación por ingestión accidental.",
    "contraindications": "Sobrecarga de hierro, anemias no ferropénicas e hipersensibilidad.",
    "interactions": "Puede reducir absorción de tetraciclinas, quinolonas, levotiroxina y otros; separar según producto.",
    "monitoring": "Hemograma, ferritina, saturación de transferrina, reticulocitos y respuesta.",
    "administration": "Vía según producto; oral puede administrarse con comida si es necesario.",
    "preparation": "No fraccionar/convertir sin concentración de hierro elemental confirmada.",
    "infusionProtocol": "Solo si presentación parenteral autorizada; seguir ficha específica.",
    "pregnancy": "Tratar deficiencia documentada; necesidad aumenta en embarazo.",
    "lactation": "Compatible en general; ajustar a necesidad materna.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Sobrecarga, reacción de hipersensibilidad e intoxicación por ingestión accidental. Dose bloqueada sem país/produto, via, concentração de ferro elementar, peso, Hb, ferritina/TSAT e diagnóstico etiológico.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://www.anmat.gob.ar/Medicamentos/basedat.asp",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://consultas.anvisa.gov.br/#/bulario/"
    ],
...
/* GOLD33_SELECTIVE:ferro_polimaltosado:END */
/* GOLD33_SELECTIVE:ferro_sacarato:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["ferro_sacarato"])throw new Error("GOLD33_MISSING_CANONICAL:ferro_sacarato");db["ferro_sacarato"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "034",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Ferro sacarato",
    "class": "Repositor intravenoso de ferro",
    "pharmacologicClass": "Complexo férrico IV",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Injeção 20 mg/mL em frascos/ampolas.",
    "presentations": "Injeção 20 mg/mL em frascos/ampolas.",
    "mechanism": "Complexo férrico IV. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Captado pelo sistema reticuloendotelial e incorporado a transferrina/hemoglobina.",
    "indications": "Anemia ferropriva em doença renal crônica conforme população e rótulo.",
    "dose": "DRC em hemodiálise: 100 mg IV por sessão até curso cumulativo usual de 1000 mg; outros cenários têm esquemas específicos.",
    "pediatricDose": "≥2 anos com DRC: regimes em mg/kg conforme reposição/manutenção e modalidade. AUTOMATABLE=NO.",
    "renalDose": "Indicado em DRC; dose depende da modalidade e estado de ferro.",
    "hepaticDose": "Sem ajuste definido; evitar sobrecarga.",
    "commonAdverseEffects": "Hipotensão, náusea, cefaleia, cãibra e reação no local.",
    "dangerousAdverseEffects": "Anafilaxia/hipersensibilidade grave, hipotensão, colapso e sobrecarga de ferro.",
    "adverseEffects": "Hipotensão, náusea, cefaleia, cãibra e reação no local. Graves: Anafilaxia/hipersensibilidade grave, hipotensão, colapso e sobrecarga de ferro.",
    "contraindications": "Hipersensibilidade conhecida ao produto.",
    "interactions": "Interações relevantes com ferro oral; evitar duplicação e sobrecarga.",
    "monitoring": "Hb, ferritina, TSAT, PA durante administração e hipersensibilidade.",
    "administration": "IV lenta ou infusão; observar durante e por pelo menos 30 min após.",
    "preparation": "Pode diluir somente em NaCl 0,9% conforme dose/produto.",
    "infusionProtocol": "Taxa e volume específicos por dose; não misturar com outros fármacos.",
    "pregnancy": "Dados disponíveis não sugerem grande risco após primeiro trimestre; individualizar.",
    "lactation": "Ferro no leite é fisiológico; decisão individual.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Anafilaxia/hipersensibilidade grave, hipotensão, colapso e sobrecarga de ferro. Cálculo e infusão bloqueados sem peso, modalidade de DRC, Hb/ferritina/TSAT, dose cumulativa, concentração e capacidade de tratar anafilaxia.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=iron+sucrose",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2020/021135s037lbl.pdf"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=iron+sucrose"
  },
  "es": {
    "name": "Hierro sacarosa",
    "class": "Repositor intravenoso de hierro",
    "pharmacologicClass": "Complejo férrico IV",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Inyección 20 mg/mL en viales/ampollas.",
    "presentations": "Inyección 20 mg/mL en viales/ampollas.",
    "mechanism": "Complejo férrico IV. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Captado por sistema reticuloendotelial e incorporado a transferrina/hemoglobina.",
    "indications": "Anemia ferropénica en enfermedad renal crónica según población y ficha.",
    "dose": "ERC en hemodiálisis: 100 mg IV por sesión hasta curso acumulado habitual de 1000 mg; otros escenarios tienen pautas específicas.",
    "pediatricDose": "≥2 años con ERC: pautas en mg/kg según reposición/mantenimiento y modalidad. AUTOMATABLE=NO.",
    "renalDose": "Indicado en ERC; dosis depende de modalidad y estado de hierro.",
    "hepaticDose": "Sin ajuste definido; evitar sobrecarga.",
    "commonAdverseEffects": "Hipotensión, náusea, cefalea, calambres y reacción local.",
    "dangerousAdverseEffects": "Anafilaxia/hipersensibilidad grave, hipotensión, colapso y sobrecarga de hierro.",
    "adverseEffects": "Hipotensión, náusea, cefalea, calambres y reacción local. Graves: Anafilaxia/hipersensibilidad grave, hipotensión, colapso y sobrecarga de hierro.",
    "contraindications": "Hipersensibilidad conocida al producto.",
    "interactions": "Interacciones relevantes con hierro oral; evitar duplicación y sobrecarga.",
    "monitoring": "Hb, ferritina, TSAT, PA durante administración e hipersensibilidad.",
    "administration": "IV lenta o infusión; observar durante y al menos 30 min después.",
    "preparation": "Puede diluirse solo en NaCl 0,9% según dosis/producto.",
    "infusionProtocol": "Velocidad y volumen específicos por dosis; no mezclar con otros fármacos.",
    "pregnancy": "Datos disponibles no sugieren gran riesgo tras primer trimestre; individualizar.",
    "lactation": "Hierro en leche es fisiológico; decisión individual.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Anafilaxia/hipersensibilidad grave, hipotensión, colapso y sobrecarga de hierro. Cálculo e infusão bloqueados sem peso, modalidade de DRC, Hb/ferritina/TSAT, dose cumulativa, concentração e capacidade de tratar anafilaxia.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=iron+sucrose",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2020/021135s037lbl.pdf"
    ],
...
/* GOLD33_SELECTIVE:fosfato_de_potassio:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["fosfato_de_potassio"])throw new Error("GOLD33_MISSING_CANONICAL:fosfato_de_potassio");db["fosfato_de_potassio"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "037",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Fosfatos de potássio",
    "class": "Repositor de fósforo e potássio",
    "pharmacologicClass": "Fonte intravenosa de fosfato e potássio",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Concentrado IV; produto comum contém 3 mmol de fósforo e 4,4 mEq de K por mL. Confirmar rótulo.",
    "presentations": "Concentrado IV; produto comum contém 3 mmol de fósforo e 4,4 mEq de K por mL. Confirmar rótulo.",
    "mechanism": "Fonte intravenosa de fosfato e potássio. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Íons distribuídos nos compartimentos corporais; eliminação renal.",
    "indications": "Prevenção/correção de hipofosfatemia quando a via IV é necessária; também aditivo de nutrição parenteral.",
    "dose": "Dose em mmol de fósforo conforme fósforo sérico, peso, K, rim e protocolo; não há dose universal segura.",
    "pediatricDose": "Dose por peso e idade sob protocolo institucional; neonatos exigem limites próprios. AUTOMATABLE=NO.",
    "renalDose": "Reduzir/evitar na insuficiência renal; contraindicado em insuficiência renal grave/hipercalemia conforme produto.",
    "hepaticDose": "Sem ajuste hepático isolado; considerar equilíbrio eletrolítico global.",
    "commonAdverseEffects": "Dor/flebite, náusea e alterações eletrolíticas.",
    "dangerousAdverseEffects": "Arritmia/parada por hipercalemia, hipocalcemia, calcificação, lesão renal e extravasamento.",
    "adverseEffects": "Dor/flebite, náusea e alterações eletrolíticas. Graves: Arritmia/parada por hipercalemia, hipocalcemia, calcificação, lesão renal e extravasamento.",
    "contraindications": "Hipercalemia, hiperfosfatemia, hipocalcemia e insuficiência renal grave, conforme rótulo.",
    "interactions": "Cálcio IV, soluções incompatíveis, fármacos que elevam K e bloqueadores do SRAA.",
    "monitoring": "Fósforo, K, Ca, Mg, creatinina, ECG, balanço e local de infusão.",
    "administration": "Nunca administrar sem diluição; usar bomba e acesso apropriado.",
    "preparation": "Diluir em solução compatível e respeitar concentração máxima institucional; não misturar com cálcio sem validação.",
    "infusionProtocol": "Taxa depende da dose, acesso, K e risco; monitorização contínua em reposições rápidas/altas.",
    "pregnancy": "Usar apenas com indicação e monitorização.",
    "lactation": "Compatível com necessidade materna; decisão individual.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Arritmia/parada por hipercalemia, hipocalcemia, calcificação, lesão renal e extravasamento. Cálculo e infusão bloqueados sem fósforo/K/Ca/Mg, peso, CrCl, acesso, concentração do frasco, solução/diluente e protocolo institucional.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=potassium+phosphates+injection",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2019/018821s028lbl.pdf"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=potassium+phosphates+injection"
  },
  "es": {
    "name": "Fosfatos de potasio",
    "class": "Repositor de fósforo y potasio",
    "pharmacologicClass": "Fuente intravenosa de fosfato y potasio",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Concentrado IV; producto común contiene 3 mmol de fósforo y 4,4 mEq de K por mL. Confirmar ficha.",
    "presentations": "Concentrado IV; producto común contiene 3 mmol de fósforo y 4,4 mEq de K por mL. Confirmar ficha.",
    "mechanism": "Fuente intravenosa de fosfato y potasio. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Iones distribuidos en compartimentos corporales; eliminación renal.",
    "indications": "Prevención/corrección de hipofosfatemia cuando se requiere vía IV; también aditivo de nutrición parenteral.",
    "dose": "Dosis en mmol de fósforo según fósforo sérico, peso, K, riñón y protocolo; no hay dosis universal segura.",
    "pediatricDose": "Dosis por peso y edad bajo protocolo institucional; neonatos requieren límites propios. AUTOMATABLE=NO.",
    "renalDose": "Reducir/evitar en insuficiencia renal; contraindicado en insuficiencia renal grave/hiperpotasemia según producto.",
    "hepaticDose": "Sin ajuste hepático aislado; considerar equilibrio electrolítico global.",
    "commonAdverseEffects": "Dolor/flebitis, náusea y alteraciones electrolíticas.",
    "dangerousAdverseEffects": "Arritmia/paro por hiperpotasemia, hipocalcemia, calcificación, lesión renal y extravasación.",
    "adverseEffects": "Dolor/flebitis, náusea y alteraciones electrolíticas. Graves: Arritmia/paro por hiperpotasemia, hipocalcemia, calcificación, lesión renal y extravasación.",
    "contraindications": "Hiperpotasemia, hiperfosfatemia, hipocalcemia e insuficiencia renal grave, según ficha.",
    "interactions": "Calcio IV, soluciones incompatibles, fármacos que elevan K y bloqueadores del SRAA.",
    "monitoring": "Fósforo, K, Ca, Mg, creatinina, ECG, balance y sitio de infusión.",
    "administration": "Nunca administrar sin diluir; usar bomba y acceso apropiado.",
    "preparation": "Diluir en solución compatible y respetar concentración máxima institucional; no mezclar con calcio sin validación.",
    "infusionProtocol": "Velocidad depende de dosis, acceso, K y riesgo; monitorización continua en reposiciones rápidas/altas.",
    "pregnancy": "Usar solo con indicación y vigilancia.",
    "lactation": "Compatible con necesidad materna; decisión individual.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Arritmia/paro por hiperpotasemia, hipocalcemia, calcificación, lesión renal y extravasación. Cálculo e infusão bloqueados sem fósforo/K/Ca/Mg, peso, CrCl, acesso, concentração do frasco, solução/diluente e protocolo institucional.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=potassium+phosphates+injection",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2019/018821s028lbl.pdf"
    ],
...
/* GOLD33_SELECTIVE:fosfato_de_potassio:END */
/* GOLD33_SELECTIVE:fosfato_de_sodio:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["fosfato_de_sodio"])throw new Error("GOLD33_MISSING_CANONICAL:fosfato_de_sodio");db["fosfato_de_sodio"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "037",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Fosfatos de sódio",
    "class": "Repositor de fósforo e sódio",
    "pharmacologicClass": "Fonte intravenosa de fosfato e sódio",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Concentrado IV comum: 3 mmol de fósforo e 4 mEq de sódio por mL; confirmar produto.",
    "presentations": "Concentrado IV comum: 3 mmol de fósforo e 4 mEq de sódio por mL; confirmar produto.",
    "mechanism": "Fonte intravenosa de fosfato e sódio. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Distribuição iônica; eliminação renal predominante.",
    "indications": "Reposição IV de fósforo e aditivo de nutrição parenteral; formas orais/retais têm indicações e riscos distintos.",
    "dose": "Dose IV individualizada em mmol de fósforo por nível sérico, peso, rim e sódio; não extrapolar para laxantes/enemas.",
    "pediatricDose": "Dose por peso/protocolo; neonatos e nutrição parenteral exigem especialista. AUTOMATABLE=NO.",
    "renalDose": "Reduzir/evitar em insuficiência renal; risco de hiperfosfatemia e nefropatia.",
    "hepaticDose": "Sem ajuste específico; considerar retenção de sódio/ascite.",
    "commonAdverseEffects": "Flebite, náusea, edema e alterações eletrolíticas.",
    "dangerousAdverseEffects": "Hipocalcemia sintomática, calcificação, nefropatia por fosfato, hipernatremia e sobrecarga.",
    "adverseEffects": "Flebite, náusea, edema e alterações eletrolíticas. Graves: Hipocalcemia sintomática, calcificação, nefropatia por fosfato, hipernatremia e sobrecarga.",
    "contraindications": "Hiperfosfatemia, hipernatremia, hipocalcemia e insuficiência renal grave, conforme produto.",
    "interactions": "Cálcio IV/compatibilidade, soluções com sódio e fármacos que alteram rim/eletrólitos.",
    "monitoring": "Fósforo, Na, Ca, K, Mg, creatinina, balanço e local de infusão.",
    "administration": "IV somente após diluição; bomba e acesso apropriado.",
    "preparation": "Diluir em solução compatível; validar cálcio e concentração final.",
    "infusionProtocol": "Infundir conforme protocolo e monitorização; evitar correção rápida não supervisionada.",
    "pregnancy": "Usar se indicação superar risco.",
    "lactation": "Decisão individual.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Hipocalcemia sintomática, calcificação, nefropatia por fosfato, hipernatremia e sobrecarga. Cálculo e infusão bloqueados sem forma farmacêutica, fósforo/Na/Ca/K/Mg, peso, CrCl, balanço, acesso e protocolo institucional.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=sodium+phosphates+injection",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2019/018820s027lbl.pdf"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=sodium+phosphates+injection"
  },
  "es": {
    "name": "Fosfatos de sodio",
    "class": "Repositor de fósforo y sodio",
    "pharmacologicClass": "Fuente intravenosa de fosfato y sodio",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Concentrado IV común: 3 mmol de fósforo y 4 mEq de sodio por mL; confirmar producto.",
    "presentations": "Concentrado IV común: 3 mmol de fósforo y 4 mEq de sodio por mL; confirmar producto.",
    "mechanism": "Fuente intravenosa de fosfato y sodio. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Distribución iónica; eliminación renal predominante.",
    "indications": "Reposición IV de fósforo y aditivo de nutrición parenteral; formas orales/rectales tienen indicaciones y riesgos distintos.",
    "dose": "Dosis IV individualizada en mmol de fósforo por nivel sérico, peso, riñón y sodio; no extrapolar a laxantes/enemas.",
    "pediatricDose": "Dosis por peso/protocolo; neonatos y nutrición parenteral requieren especialista. AUTOMATABLE=NO.",
    "renalDose": "Reducir/evitar en insuficiencia renal; riesgo de hiperfosfatemia y nefropatía.",
    "hepaticDose": "Sin ajuste específico; considerar retención de sodio/ascitis.",
    "commonAdverseEffects": "Flebitis, náusea, edema y alteraciones electrolíticas.",
    "dangerousAdverseEffects": "Hipocalcemia sintomática, calcificación, nefropatía por fosfato, hipernatremia y sobrecarga.",
    "adverseEffects": "Flebitis, náusea, edema y alteraciones electrolíticas. Graves: Hipocalcemia sintomática, calcificación, nefropatía por fosfato, hipernatremia y sobrecarga.",
    "contraindications": "Hiperfosfatemia, hipernatremia, hipocalcemia e insuficiencia renal grave, según producto.",
    "interactions": "Calcio IV/compatibilidad, soluciones con sodio y fármacos que alteran riñón/electrolitos.",
    "monitoring": "Fósforo, Na, Ca, K, Mg, creatinina, balance y sitio de infusión.",
    "administration": "Solo IV tras dilución; bomba y acceso apropiado.",
    "preparation": "Diluir en solución compatible; validar calcio y concentración final.",
    "infusionProtocol": "Infundir según protocolo y vigilancia; evitar corrección rápida no supervisada.",
    "pregnancy": "Usar si indicación supera riesgo.",
    "lactation": "Decisión individual.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Hipocalcemia sintomática, calcificación, nefropatía por fosfato, hipernatremia y sobrecarga. Cálculo e infusão bloqueados sem forma farmacêutica, fósforo/Na/Ca/K/Mg, peso, CrCl, balanço, acesso e protocolo institucional.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=sodium+phosphates+injection",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2019/018820s027lbl.pdf"
    ],
...
/* GOLD33_SELECTIVE:fosfato_de_sodio:END */
/* GOLD33_SELECTIVE:fumarato_ferroso:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["fumarato_ferroso"])throw new Error("GOLD33_MISSING_CANONICAL:fumarato_ferroso");db["fumarato_ferroso"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "037",
    "requiredFieldCount": 33,
  ...
  "pt": {
    ...
    "class": "Sal oral de ferro",
    "pharmacologicClass": "Reposição de ferro ferroso",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Comprimidos/cápsulas/xarope com quantidades variáveis; 325 mg de fumarato ferroso fornecem aproximadamente 106 mg de ferro elementar.",
    "presentations": "Comprimidos/cápsulas/xarope com quantidades variáveis; 325 mg de fumarato ferroso fornecem aproximadamente 106 mg de ferro elementar.",
    "mechanism": "Reposição de ferro ferroso. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Absorção duodenal regulada por hepcidina; armazenamento como ferritina.",
    "indications": "Prevenção e tratamento da deficiência de ferro quando confirmada ou altamente provável.",
    "dose": "Prescrever em mg de ferro elementar. Regimes adultos frequentemente usam cerca de 40-100 mg elementar uma vez/dia ou em dias alternados; individualizar por diagnóstico e tolerância.",
    "pediatricDose": "Dose elementar por idade/peso e finalidade; risco de intoxicação fatal por superdose. AUTOMATABLE=NO.",
    "renalDose": "Sem ajuste fixo; investigar causa e considerar resposta reduzida em DRC/inflamação.",
    "hepaticDose": "Sem ajuste fixo; cautela em sobrecarga de ferro/hepatopatia.",
    "commonAdverseEffects": "Náusea, dor abdominal, constipação, diarreia e fezes escuras.",
    "dangerousAdverseEffects": "Intoxicação aguda, corrosão GI, sobrecarga de ferro e aspiração de comprimido.",
    "adverseEffects": "Náusea, dor abdominal, constipação, diarreia e fezes escuras. Graves: Intoxicação aguda, corrosão GI, sobrecarga de ferro e aspiração de comprimido.",
    "contraindications": "Hemocromatose/hemossiderose, anemia sem deficiência de ferro e hipersensibilidade.",
    "interactions": "Levotiroxina, tetraciclinas, quinolonas, bisfosfonatos, antiácidos/cálcio e levodopa; separar horários.",
    "monitoring": "Hemograma, ferritina, saturação de transferrina, reticulócitos, resposta e causa de perdas.",
    "administration": "Preferir em jejum se tolerado; pode tomar com alimento. Separar de interações.",
    "preparation": "Medir líquido com dispositivo; confirmar ferro elementar por unidade.",
    "infusionProtocol": "Não aplicável.",
    "pregnancy": "Usado quando indicado; confirmar necessidade e dose elementar.",
    "lactation": "Compatível em doses terapêuticas.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Intoxicação aguda, corrosão GI, sobrecarga de ferro e aspiração de comprimido. Dose bloqueada sem diagnóstico, Hb/ferritina/TSAT, idade/peso, gestação, causa da deficiência e quantidade exata de ferro elementar do produto.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=ferrous+fumarate",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.who.int/publications/i/item/9789240035740"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=ferrous+fumarate"
  },
  "es": {
    "name": "Fumarato ferroso",
    "class": "Sal oral de hierro",
    "pharmacologicClass": "Reposición de hierro ferroso",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Comprimidos/cápsulas/jarabe variables; 325 mg de fumarato ferroso aportan aproximadamente 106 mg de hierro elemental.",
    "presentations": "Comprimidos/cápsulas/jarabe variables; 325 mg de fumarato ferroso aportan aproximadamente 106 mg de hierro elemental.",
    "mechanism": "Reposición de hierro ferroso. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Absorción duodenal regulada por hepcidina; almacenamiento como ferritina.",
    "indications": "Prevención y tratamiento de deficiencia de hierro cuando confirmada o muy probable.",
    "dose": "Prescribir en mg de hierro elemental. Pautas adultas frecuentemente usan ~40-100 mg elemental una vez/día o días alternos; individualizar por diagnóstico y tolerancia.",
    "pediatricDose": "Dosis elemental por edad/peso y finalidad; riesgo de intoxicación fatal por sobredosis. AUTOMATABLE=NO.",
    "renalDose": "Sin ajuste fijo; investigar causa y considerar menor respuesta en ERC/inflamación.",
    "hepaticDose": "Sin ajuste fijo; precaución en sobrecarga de hierro/hepatopatía.",
    "commonAdverseEffects": "Náusea, dolor abdominal, estreñimiento, diarrea y heces oscuras.",
    "dangerousAdverseEffects": "Intoxicación aguda, corrosión GI, sobrecarga de hierro y aspiración de comprimido.",
    "adverseEffects": "Náusea, dolor abdominal, estreñimiento, diarrea y heces oscuras. Graves: Intoxicación aguda, corrosión GI, sobrecarga de hierro y aspiración de comprimido.",
    "contraindications": "Hemocromatosis/hemosiderosis, anemia sin deficiencia de hierro e hipersensibilidad.",
    "interactions": "Levotiroxina, tetraciclinas, quinolonas, bisfosfonatos, antiácidos/calcio y levodopa; separar horarios.",
    "monitoring": "Hemograma, ferritina, saturación de transferrina, reticulocitos, respuesta y causa de pérdidas.",
    "administration": "Preferir en ayunas si tolerado; puede tomarse con alimentos. Separar interacciones.",
    "preparation": "Medir líquido con dispositivo; confirmar hierro elemental por unidad.",
    "infusionProtocol": "No aplicable.",
    "pregnancy": "Usado cuando indicado; confirmar necesidad y dosis elemental.",
    "lactation": "Compatible en dosis terapéuticas.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Intoxicación aguda, corrosión GI, sobrecarga de hierro y aspiración de comprimido. Dose bloqueada sem diagnóstico, Hb/ferritina/TSAT, idade/peso, gestação, causa da deficiência e quantidade exata de ferro elementar do produto.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=ferrous+fumarate",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.who.int/publications/i/item/9789240035740"
    ],
...
/* GOLD33_SELECTIVE:fumarato_ferroso:END */
/* GOLD33_SELECTIVE:gluconato_ferrico:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["gluconato_ferrico"])throw new Error("GOLD33_MISSING_CANONICAL:gluconato_ferrico");db["gluconato_ferrico"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "039",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Gluconato férrico de sódio",
    "class": "Ferro intravenoso",
    "pharmacologicClass": "Repõe ferro para síntese de hemoglobina",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Injeção 12,5 mg de ferro elementar/mL; frasco 62,5 mg/5 mL.",
    "presentations": "Injeção 12,5 mg de ferro elementar/mL; frasco 62,5 mg/5 mL.",
    "mechanism": "Repõe ferro para síntese de hemoglobina. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Ferro liberado ao sistema reticuloendotelial e incorporado à transferrina.",
    "indications": "Deficiência de ferro em pacientes com DRC em hemodiálise recebendo epoetina, conforme rótulo.",
    "dose": "Adultos: 125 mg IV por sessão de diálise; dose cumulativa usual 1000 mg em 8 sessões, conforme rótulo.",
    "pediatricDose": "Pediatria ≥6 anos em hemodiálise: 1,5 mg/kg (máx. 125 mg) por sessão em situações rotuladas. AUTOMATABLE=NO.",
    "renalDose": "Usado na DRC em diálise; evitar sobrecarga de ferro.",
    "hepaticDose": "Sem ajuste específico.",
    "commonAdverseEffects": "Náusea, hipotensão, câimbras e reação no local.",
    "dangerousAdverseEffects": "Anafilaxia/hipersensibilidade grave, hipotensão e sobrecarga de ferro.",
    "adverseEffects": "Náusea, hipotensão, câimbras e reação no local. Graves: Anafilaxia/hipersensibilidade grave, hipotensão e sobrecarga de ferro.",
    "contraindications": "Hipersensibilidade ao produto.",
    "interactions": "Interações formais limitadas; ferro pode reduzir absorção de fármacos quando oral, não aplicável diretamente ao IV.",
    "monitoring": "Hb, ferritina, TSAT, PA, reação infusional e dose cumulativa.",
    "administration": "IV durante diálise com capacidade de tratar anafilaxia.",
    "preparation": "Pode diluir em NaCl 0,9% conforme rótulo.",
    "infusionProtocol": "Infundir 125 mg em 1 h ou injeção lenta conforme rótulo/protocolo.",
    ...
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Anafilaxia/hipersensibilidade grave, hipotensão e sobrecarga de ferro. Dose/infusão bloqueadas sem peso/idade, diálise, Hb, ferritina/TSAT, ferro prévio, alergia e dose cumulativa.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=sodium+ferric+gluconate"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=sodium+ferric+gluconate"
  },
  "es": {
    "name": "Gluconato férrico sódico",
    "class": "Hierro intravenoso",
    "pharmacologicClass": "Repone hierro para síntesis de hemoglobina",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Inyección 12,5 mg de hierro elemental/mL; vial 62,5 mg/5 mL.",
    "presentations": "Inyección 12,5 mg de hierro elemental/mL; vial 62,5 mg/5 mL.",
    "mechanism": "Repone hierro para síntesis de hemoglobina. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Hierro liberado al sistema reticuloendotelial e incorporado a transferrina.",
    "indications": "Deficiencia de hierro en pacientes con ERC en hemodiálisis que reciben epoetina, según ficha.",
    "dose": "Adultos: 125 mg IV por sesión de diálisis; dosis acumulada habitual 1000 mg en 8 sesiones, según ficha.",
    "pediatricDose": "Pediatría ≥6 años en hemodiálisis: 1,5 mg/kg (máx. 125 mg) por sesión en situaciones autorizadas. AUTOMATABLE=NO.",
    "renalDose": "Usado en ERC con diálisis; evitar sobrecarga de hierro.",
    "hepaticDose": "Sin ajuste específico.",
    "commonAdverseEffects": "Náusea, hipotensión, calambres y reacción local.",
    "dangerousAdverseEffects": "Anafilaxia/hipersensibilidad grave, hipotensión y sobrecarga de hierro.",
    "adverseEffects": "Náusea, hipotensión, calambres y reacción local. Graves: Anafilaxia/hipersensibilidad grave, hipotensión y sobrecarga de hierro.",
    "contraindications": "Hipersensibilidad al producto.",
    "interactions": "Interacciones formales limitadas; hierro oral reduce absorción de fármacos, no aplica directamente al IV.",
    "monitoring": "Hb, ferritina, TSAT, PA, reacción infusional y dosis acumulada.",
    "administration": "IV durante diálisis con capacidad de tratar anafilaxia.",
    "preparation": "Puede diluirse en NaCl 0,9% según ficha.",
    "infusionProtocol": "Infundir 125 mg en 1 h o inyección lenta según ficha/protocolo.",
    ...
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Anafilaxia/hipersensibilidad grave, hipotensión y sobrecarga de hierro. Dose/infusão bloqueadas sem peso/idade, diálise, Hb, ferritina/TSAT, ferro prévio, alergia e dose cumulativa.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=sodium+ferric+gluconate"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=sodium+ferric+gluconate"
...
/* GOLD33_SELECTIVE:gluconato_ferrico:END */
/* GOLD33_SELECTIVE:gluconato_ferroso:START */
;(function(){var db=window.NEFRO_DRUGS_DB;if(!db||!db["gluconato_ferroso"])throw new Error("GOLD33_MISSING_CANONICAL:gluconato_ferroso");db["gluconato_ferroso"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "039",
    "requiredFieldCount": 33,
  ...
  "pt": {
    ...
    "class": "Ferro oral",
    "pharmacologicClass": "Repõe ferro elementar",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Comprimidos de 324/325 mg de sal, cerca de 38 mg de ferro elementar; líquidos variam.",
    "presentations": "Comprimidos de 324/325 mg de sal, cerca de 38 mg de ferro elementar; líquidos variam.",
    "mechanism": "Repõe ferro elementar. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Absorção duodenal regulada; perdas sem via ativa de excreção.",
    "indications": "Prevenção ou tratamento da deficiência de ferro confirmada.",
    "dose": "Individualizar por ferro elementar; frequentemente 38-76 mg de ferro elementar 1x/dia ou em dias alternados.",
    "pediatricDose": "Dose por ferro elementar, idade/peso e gravidade; confirmar formulação. AUTOMATABLE=NO.",
    "renalDose": "Sem ajuste fixo; investigar anemia e evitar sobrecarga na DRC.",
    "hepaticDose": "Sem ajuste fixo; cautela em doença hepática com sobrecarga.",
    "commonAdverseEffects": "Náusea, dor abdominal, constipação, diarreia e fezes escuras.",
    "dangerousAdverseEffects": "Superdose com toxicidade grave, especialmente em crianças.",
    "adverseEffects": "Náusea, dor abdominal, constipação, diarreia e fezes escuras. Graves: Superdose com toxicidade grave, especialmente em crianças.",
    "contraindications": "Hemocromatose/hemossiderose e anemias sem deficiência de ferro.",
    "interactions": "Levotiroxina, tetraciclinas, quinolonas, bisfosfonatos, antiácidos e cálcio.",
    "monitoring": "Hb, reticulócitos, ferritina/TSAT, tolerância GI e adesão.",
    "administration": "VO; melhor absorção em jejum, mas pode tomar com alimento se intolerância.",
    "preparation": "Medir líquido; separar de interações.",
    "infusionProtocol": "Não aplicável.",
    "pregnancy": "Usado quando indicado.",
    "lactation": "Compatível; monitorar lactente se necessário.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Superdose com toxicidade grave, especialmente em crianças. Dose bloqueada sem ferro elementar por unidade, diagnóstico/laboratório, idade/peso, causa da deficiência e interações.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=ferrous+gluconate"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=ferrous+gluconate"
  },
  "es": {
    "name": "Gluconato ferroso",
    "class": "Hierro oral",
    "pharmacologicClass": "Repone hierro elemental",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Comprimidos de 324/325 mg de sal, ~38 mg de hierro elemental; líquidos variables.",
    "presentations": "Comprimidos de 324/325 mg de sal, ~38 mg de hierro elemental; líquidos variables.",
    "mechanism": "Repone hierro elemental. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Absorción duodenal regulada; pérdidas sin vía activa de excreción.",
    "indications": "Prevención o tratamiento de deficiencia de hierro confirmada.",
    "dose": "Individualizar por hierro elemental; con frecuencia 38-76 mg de hierro elemental una vez/día o días alternos.",
    "pediatricDose": "Dosis por hierro elemental, edad/peso y gravedad; confirmar formulación. AUTOMATABLE=NO.",
    "renalDose": "Sin ajuste fijo; investigar anemia y evitar sobrecarga en ERC.",
    "hepaticDose": "Sin ajuste fijo; precaución en hepatopatía con sobrecarga.",
    "commonAdverseEffects": "Náusea, dolor abdominal, estreñimiento, diarrea y heces oscuras.",
    "dangerousAdverseEffects": "Sobredosis con toxicidad grave, especialmente en niños.",
    "adverseEffects": "Náusea, dolor abdominal, estreñimiento, diarrea y heces oscuras. Graves: Sobredosis con toxicidad grave, especialmente en niños.",
    "contraindications": "Hemocromatosis/hemosiderosis y anemias sin deficiencia de hierro.",
    "interactions": "Levotiroxina, tetraciclinas, quinolonas, bisfosfonatos, antiácidos y calcio.",
    "monitoring": "Hb, reticulocitos, ferritina/TSAT, tolerancia GI y adherencia.",
    "administration": "VO; mejor absorción en ayunas, puede tomarse con alimento si intolerancia.",
    "preparation": "Medir líquido; separar de interacciones.",
    "infusionProtocol": "No aplicable.",
    "pregnancy": "Usado cuando está indicado.",
    "lactation": "Compatible; vigilar lactante si es necesario.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Sobredosis con toxicidad grave, especialmente en niños. Dose bloqueada sem ferro elementar por unidade, diagnóstico/laboratório, idade/peso, causa da deficiência e interações.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=ferrous+gluconate"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=ferrous+gluconate"
...
/* GOLD33_SELECTIVE:oxido_de_magnesio:START */
;(function(){var db=window.NEFRO_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="oxido_de_magnesio";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:oxido_de_magnesio:"+matches.length);drug=matches[0];}else{drug=db&&db["oxido_de_magnesio"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:oxido_de_magnesio");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "059",
    "requiredFieldCount": 33,
  ...
  "pt": {
    ...
    "class": "Sal de magnésio; laxante/antiácido ou suplemento",
    "pharmacologicClass": "Sal de magnésio; laxante/antiácido ou suplemento",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Comprimidos/cápsulas e pós com diferentes quantidades de magnésio elementar.",
    "presentations": "Comprimidos/cápsulas e pós com diferentes quantidades de magnésio elementar.",
    ...
    "indications": "Constipação ocasional, dispepsia ou reposição conforme produto e jurisdição.",
    "dose": "Dose depende da indicação e do conteúdo elementar de magnésio, que não equivale ao peso do sal. Não automatizar conversão sem rótulo específico.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Diarreia, cólicas e náusea.",
    "dangerousAdverseEffects": "Hipermagnesemia, hipotensão, bradicardia e depressão neuromuscular, sobretudo em insuficiência renal.",
    "adverseEffects": "Diarreia, cólicas e náusea.; Hipermagnesemia, hipotensão, bradicardia e depressão neuromuscular, sobretudo em insuficiência renal.",
    ...
    "safetyFlags": "Hipermagnesemia, hipotensão, bradicardia e depressão neuromuscular, sobretudo em insuficiência renal.",
    "alerts": "Hipermagnesemia, hipotensão, bradicardia e depressão neuromuscular, sobretudo em insuficiência renal.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=oxido+de+magnesio",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=oxido+de+magnesio"
  },
  "es": {
    "name": "Óxido de magnésio",
    "class": "Sal de magnésio; laxante/antiácido ou suplemento",
    "pharmacologicClass": "Sal de magnésio; laxante/antiácido ou suplemento",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Comprimidos/cápsulas y pós con diferentes quantidades de magnésio elementar.",
    "presentations": "Comprimidos/cápsulas y pós con diferentes quantidades de magnésio elementar.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Constipação ocasional, dispepsia ou reposição conforme produto y jurisdição.",
    "dose": "Dose depende da indicação y do conteúdo elementar de magnésio, que no equivale ao peso do sal. No automatizar conversão sem rótulo específico.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Diarreia, cólicas y náusea.",
    "dangerousAdverseEffects": "Hipermagnesemia, hipotensão, bradicardia y depressão neuromuscular, sobretudo em insuficiência renal.",
    "adverseEffects": "Diarreia, cólicas y náusea.; Hipermagnesemia, hipotensão, bradicardia y depressão neuromuscular, sobretudo em insuficiência renal.",
    ...
    "safetyFlags": "Hipermagnesemia, hipotensão, bradicardia y depressão neuromuscular, sobretudo em insuficiência renal.",
    "alerts": "Hipermagnesemia, hipotensão, bradicardia y depressão neuromuscular, sobretudo em insuficiência renal.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=oxido+de+magnesio",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
...
/* GOLD33_SELECTIVE:oxido_de_magnesio:END */
/* GOLD33_SELECTIVE:oxihidroxido_sucroferrico:START */
;(function(){var db=window.NEFRO_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="oxihidroxido_sucroferrico";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:oxihidroxido_sucroferrico:"+matches.length);drug=matches[0];}else{drug=db&&db["oxihidroxido_sucroferrico"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:oxihidroxido_sucroferrico");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "059",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Oxihidróxido sucroférrico",
    "class": "Quelante de fosfato à base de ferro",
    "pharmacologicClass": "Quelante de fosfato à base de ferro",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Comprimido mastigável equivalente a 500 mg de ferro.",
    "presentations": "Comprimido mastigável equivalente a 500 mg de ferro.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância e exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo e eliminação na fonte primária.",
    "indications": "Controle do fósforo em adultos com doença renal crônica em diálise.",
    "dose": "Iniciar geralmente 500 mg de ferro VO três vezes/dia com refeições; mastigar e titular pelo fósforo. A força é expressa como ferro.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Fezes escuras, diarreia e descoloração dentária.",
    "dangerousAdverseEffects": "Hipofosfatemia, sobrecarga de ferro em suscetíveis e eventos gastrointestinais importantes.",
    "adverseEffects": "Fezes escuras, diarreia e descoloração dentária.; Hipofosfatemia, sobrecarga de ferro em suscetíveis e eventos gastrointestinais importantes.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade e riscos graves aplicáveis.",
    "administration": "Usar somente via e formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações e vias não são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação e jurisdição.",
    "safetyFlags": "Hipofosfatemia, sobrecarga de ferro em suscetíveis e eventos gastrointestinais importantes.",
    "alerts": "Hipofosfatemia, sobrecarga de ferro em suscetíveis e eventos gastrointestinais importantes.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=oxihidroxido+sucroferrico",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=oxihidroxido+sucroferrico"
  },
  "es": {
    "name": "Oxihidróxido sucroférrico",
    "class": "Quelante de fosfato à base de ferro",
    ...
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Controle do fósforo em adultos con doença renal crônica em diálise.",
    "dose": "Iniciar geralmente 500 mg de ferro VO três vezes/dia con refeições; mastigar y titular pelo fósforo. A força é expressa como ferro.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Fezes escuras, diarreia y descoloração dentária.",
    "dangerousAdverseEffects": "Hipofosfatemia, sobrecarga de ferro em suscetíveis y eventos gastrointestinais importantes.",
    "adverseEffects": "Fezes escuras, diarreia y descoloração dentária.; Hipofosfatemia, sobrecarga de ferro em suscetíveis y eventos gastrointestinais importantes.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade y riscos graves aplicáveis.",
    "administration": "Usar somente via y formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações y vias no são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação y jurisdição.",
    "safetyFlags": "Hipofosfatemia, sobrecarga de ferro em suscetíveis y eventos gastrointestinais importantes.",
    "alerts": "Hipofosfatemia, sobrecarga de ferro em suscetíveis y eventos gastrointestinais importantes.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=oxihidroxido+sucroferrico",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
...
/* GOLD33_SELECTIVE:oxihidroxido_sucroferrico:END */
/* GOLD33_SELECTIVE:paricalcitol:START */
;(function(){var db=window.NEFRO_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="paricalcitol";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:paricalcitol:"+matches.length);drug=matches[0];}else{drug=db&&db["paricalcitol"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:paricalcitol");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "060",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Paricalcitol",
    "class": "Ativador seletivo do receptor de vitamina D",
    "pharmacologicClass": "Ativador seletivo do receptor de vitamina D",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Cápsulas e solução injetável em microgramas.",
    "presentations": "Cápsulas e solução injetável em microgramas.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância e exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo e eliminação na fonte primária.",
    "indications": "Prevenção e tratamento do hiperparatireoidismo secundário na doença renal crônica conforme estágio e formulação.",
    "dose": "Dose oral ou IV deve ser titulada por PTH, cálcio, fósforo e estágio renal. Unidades e esquemas diferem entre cápsula e injetável.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Náusea, edema, cefaleia e alterações de cálcio/fósforo.",
    "dangerousAdverseEffects": "Hipercalcemia, hiperfosfatemia, calcificação vascular e toxicidade por vitamina D.",
    "adverseEffects": "Náusea, edema, cefaleia e alterações de cálcio/fósforo.; Hipercalcemia, hiperfosfatemia, calcificação vascular e toxicidade por vitamina D.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade e riscos graves aplicáveis.",
    "administration": "Usar somente via e formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações e vias não são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação e jurisdição.",
    "safetyFlags": "Hipercalcemia, hiperfosfatemia, calcificação vascular e toxicidade por vitamina D.",
    "alerts": "Hipercalcemia, hiperfosfatemia, calcificação vascular e toxicidade por vitamina D.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=paricalcitol",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=paricalcitol"
  },
  "es": {
    "name": "Paricalcitol",
    "class": "Ativador seletivo do receptor de vitamina D",
    "pharmacologicClass": "Ativador seletivo do receptor de vitamina D",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Cápsulas y solución injetável em microgramas.",
    "presentations": "Cápsulas y solución injetável em microgramas.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Prevenção y tratamento do hiperparatireoidismo secundário na doença renal crônica conforme estágio y formulação.",
    "dose": "Dose oral ou IV deve ser titulada por PTH, cálcio, fósforo y estágio renal. Unidades y esquemas diferem entre cápsula y injetável.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Náusea, edema, cefaleia y alterações de cálcio/fósforo.",
    "dangerousAdverseEffects": "Hipercalcemia, hiperfosfatemia, calcificação vascular y toxicidade por vitamina D.",
    "adverseEffects": "Náusea, edema, cefaleia y alterações de cálcio/fósforo.; Hipercalcemia, hiperfosfatemia, calcificação vascular y toxicidade por vitamina D.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade y riscos graves aplicáveis.",
    "administration": "Usar somente via y formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações y vias no são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação y jurisdição.",
    "safetyFlags": "Hipercalcemia, hiperfosfatemia, calcificação vascular y toxicidade por vitamina D.",
    "alerts": "Hipercalcemia, hiperfosfatemia, calcificação vascular y toxicidade por vitamina D.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=paricalcitol",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
...
/* GOLD33_SELECTIVE:paricalcitol:END */
/* GOLD33_SELECTIVE:patiromer:START */
;(function(){var db=window.NEFRO_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="patiromer";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:patiromer:"+matches.length);drug=matches[0];}else{drug=db&&db["patiromer"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:patiromer");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "060",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Patiromer",
    "class": "Quelante intestinal de potássio",
    "pharmacologicClass": "Quelante intestinal de potássio",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Pó para suspensão oral em sachês de diferentes gramas.",
    "presentations": "Pó para suspensão oral em sachês de diferentes gramas.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância e exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo e eliminação na fonte primária.",
    "indications": "Tratamento da hipercalemia; não indicado para emergência devido ao início tardio.",
    "dose": "Dose inicial adulta frequentemente 8,4 g VO uma vez/dia; titular semanalmente pelo potássio. Separar de outros medicamentos conforme rótulo.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Constipação, diarreia, náusea, dor abdominal e flatulência.",
    "dangerousAdverseEffects": "Hipomagnesemia, hipocalemia e interação por ligação gastrointestinal.",
    "adverseEffects": "Constipação, diarreia, náusea, dor abdominal e flatulência.; Hipomagnesemia, hipocalemia e interação por ligação gastrointestinal.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade e riscos graves aplicáveis.",
    "administration": "Usar somente via e formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações e vias não são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação e jurisdição.",
    "safetyFlags": "Hipomagnesemia, hipocalemia e interação por ligação gastrointestinal.",
    "alerts": "Hipomagnesemia, hipocalemia e interação por ligação gastrointestinal.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=patiromer",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=patiromer"
  },
  "es": {
    "name": "Patiromer",
    "class": "Quelante intestinal de potássio",
    ...
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Tratamento da hipercalemia; no indicado para emergência devido ao início tardio.",
    "dose": "Dose inicial adulta frequentemente 8,4 g VO uma vez/dia; titular semanalmente pelo potássio. Separar de outros medicamentos conforme rótulo.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Constipação, diarreia, náusea, dor abdominal y flatulência.",
    "dangerousAdverseEffects": "Hipomagnesemia, hipocalemia y interação por ligação gastrointestinal.",
    "adverseEffects": "Constipação, diarreia, náusea, dor abdominal y flatulência.; Hipomagnesemia, hipocalemia y interação por ligação gastrointestinal.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade y riscos graves aplicáveis.",
    "administration": "Usar somente via y formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações y vias no são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação y jurisdição.",
    "safetyFlags": "Hipomagnesemia, hipocalemia y interação por ligação gastrointestinal.",
    "alerts": "Hipomagnesemia, hipocalemia y interação por ligação gastrointestinal.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=patiromer",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
...
/* GOLD33_SELECTIVE:patiromer:END */
/* GOLD33_SELECTIVE:plasma_lyte:START */
;(function(){var db=window.NEFRO_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="plasma_lyte";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:plasma_lyte:"+matches.length);drug=matches[0];}else{drug=db&&db["plasma_lyte"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:plasma_lyte");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "063",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Solução cristaloide balanceada Plasma-Lyte",
    "class": "Solução intravenosa balanceada de eletrólitos",
    "pharmacologicClass": "Solução intravenosa balanceada de eletrólitos",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Bolsas intravenosas com composição e volumes específicos; conferir eletrólitos e compatibilidade.",
    "presentations": "Bolsas intravenosas com composição e volumes específicos; conferir eletrólitos e compatibilidade.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância e exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo e eliminação na fonte primária.",
    "indications": "Reposição de volume e fluidoterapia conforme composição do produto e avaliação clínica.",
    "dose": "Volume, velocidade e duração dependem de estado volêmico, eletrólitos, função renal/cardíaca e perdas. Não existe taxa universal; exige prescrição e monitorização individual.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Edema, sobrecarga de volume e alterações eletrolíticas.",
    "dangerousAdverseEffects": "Edema pulmonar, hiperpotassemia, distúrbio ácido-base e complicações do acesso/infusão.",
    "adverseEffects": "Edema, sobrecarga de volume e alterações eletrolíticas.; Edema pulmonar, hiperpotassemia, distúrbio ácido-base e complicações do acesso/infusão.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade e riscos graves aplicáveis.",
    "administration": "Usar somente via e formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações e vias não são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação e jurisdição.",
    "safetyFlags": "Edema pulmonar, hiperpotassemia, distúrbio ácido-base e complicações do acesso/infusão.",
    "alerts": "Edema pulmonar, hiperpotassemia, distúrbio ácido-base e complicações do acesso/infusão.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=plasma+lyte",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=plasma+lyte"
  },
  "es": {
    "name": "Solução cristaloide balanceada Plasma-Lyte",
    "class": "Solução intravenosa balanceada de eletrólitos",
    "pharmacologicClass": "Solução intravenosa balanceada de eletrólitos",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Bolsas intravenosas con composição y volumes específicos; conferir eletrólitos y compatibilidade.",
    "presentations": "Bolsas intravenosas con composição y volumes específicos; conferir eletrólitos y compatibilidade.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Reposição de volume y fluidoterapia conforme composição do produto y avaliação clínica.",
    "dose": "Volume, velocidade y duração dependem de estado volêmico, eletrólitos, función renal/cardíaca y perdas. No existe taxa universal; exige prescrição y monitorização individual.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Edema, sobrecarga de volume y alterações eletrolíticas.",
    "dangerousAdverseEffects": "Edema pulmonar, hiperpotassemia, distúrbio ácido-base y complicações do acesso/infusão.",
    "adverseEffects": "Edema, sobrecarga de volume y alterações eletrolíticas.; Edema pulmonar, hiperpotassemia, distúrbio ácido-base y complicações do acesso/infusão.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade y riscos graves aplicáveis.",
    "administration": "Usar somente via y formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações y vias no são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação y jurisdição.",
    "safetyFlags": "Edema pulmonar, hiperpotassemia, distúrbio ácido-base y complicações do acesso/infusão.",
    "alerts": "Edema pulmonar, hiperpotassemia, distúrbio ácido-base y complicações do acesso/infusão.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=plasma+lyte",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
...
/* GOLD33_SELECTIVE:plasma_lyte:END */
/* GOLD33_SELECTIVE:poliestirenossulfonato:START */
;(function(){var db=window.NEFRO_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="poliestirenossulfonato";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:poliestirenossulfonato:"+matches.length);drug=matches[0];}else{drug=db&&db["poliestirenossulfonato"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:poliestirenossulfonato");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "063",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Poliestirenossulfonato",
    "class": "Resina de troca catiônica",
    "pharmacologicClass": "Resina de troca catiônica",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Pó ou suspensão oral/retal; o cátion e a concentração devem ser identificados antes do uso.",
    "presentations": "Pó ou suspensão oral/retal; o cátion e a concentração devem ser identificados antes do uso.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância e exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo e eliminação na fonte primária.",
    "indications": "Tratamento da hiperpotassemia conforme cátion da resina, formulação e jurisdição.",
    "dose": "Não existe conversão universal entre sais de sódio e cálcio. Início de ação é variável; não usar como única terapia em emergência com risco de vida. Confirmar produto, via e dose no rótulo local.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Constipação, náusea, hipocalemia e alterações de cálcio/sódio.",
    "dangerousAdverseEffects": "Necrose intestinal, obstrução, aspiração e distúrbios eletrolíticos graves.",
    "adverseEffects": "Constipação, náusea, hipocalemia e alterações de cálcio/sódio.; Necrose intestinal, obstrução, aspiração e distúrbios eletrolíticos graves.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade e riscos graves aplicáveis.",
    "administration": "Usar somente via e formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações e vias não são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação e jurisdição.",
    "safetyFlags": "Necrose intestinal, obstrução, aspiração e distúrbios eletrolíticos graves.",
    "alerts": "Necrose intestinal, obstrução, aspiração e distúrbios eletrolíticos graves.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=poliestirenossulfonato",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=poliestirenossulfonato"
  },
  "es": {
    "name": "Poliestirenossulfonato",
    "class": "Resina de troca catiônica",
    "pharmacologicClass": "Resina de troca catiônica",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Pó ou suspensão oral/retal; o cátion y a concentração devem ser identificados antes do uso.",
    "presentations": "Pó ou suspensão oral/retal; o cátion y a concentração devem ser identificados antes do uso.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Tratamento da hiperpotassemia conforme cátion da resina, formulação y jurisdição.",
    "dose": "No existe conversão universal entre sais de sódio y cálcio. Início de ação é variável; no usar como única terapia em emergência con risco de vida. Confirmar produto, via y dosis no rótulo local.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Constipação, náusea, hipocalemia y alterações de cálcio/sódio.",
    "dangerousAdverseEffects": "Necrose intestinal, obstrução, aspiração y distúrbios eletrolíticos graves.",
    "adverseEffects": "Constipação, náusea, hipocalemia y alterações de cálcio/sódio.; Necrose intestinal, obstrução, aspiração y distúrbios eletrolíticos graves.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade y riscos graves aplicáveis.",
    "administration": "Usar somente via y formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações y vias no são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação y jurisdição.",
    "safetyFlags": "Necrose intestinal, obstrução, aspiração y distúrbios eletrolíticos graves.",
    "alerts": "Necrose intestinal, obstrução, aspiração y distúrbios eletrolíticos graves.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=poliestirenossulfonato",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
...
/* GOLD33_SELECTIVE:poliestirenossulfonato:END */
/* GOLD33_SELECTIVE:poliestirenossulfonato_de_calcio:START */
;(function(){var db=window.NEFRO_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="poliestirenossulfonato_de_calcio";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:poliestirenossulfonato_de_calcio:"+matches.length);drug=matches[0];}else{drug=db&&db["poliestirenossulfonato_de_calcio"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:poliestirenossulfonato_de_calcio");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "063",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Poliestirenossulfonato de cálcio",
    "class": "Resina de troca de potássio na forma cálcica",
    "pharmacologicClass": "Resina de troca de potássio na forma cálcica",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Pó ou suspensão oral/retal com conteúdo definido de resina cálcica.",
    "presentations": "Pó ou suspensão oral/retal com conteúdo definido de resina cálcica.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância e exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo e eliminação na fonte primária.",
    "indications": "Tratamento da hiperpotassemia conforme produto e protocolo local.",
    "dose": "Dose e via dependem da apresentação. Não converter automaticamente da resina sódica; monitorar potássio, cálcio e magnésio. Não substitui estabilização cardíaca e deslocamento intracelular na emergência.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Constipação, náusea, hipocalemia e hipercalcemia.",
    "dangerousAdverseEffects": "Necrose intestinal, obstrução, aspiração e distúrbios eletrolíticos graves.",
    "adverseEffects": "Constipação, náusea, hipocalemia e hipercalcemia.; Necrose intestinal, obstrução, aspiração e distúrbios eletrolíticos graves.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade e riscos graves aplicáveis.",
    "administration": "Usar somente via e formulação documentadas; respeitar técnica específica.",
    ...
    "alerts": "Necrose intestinal, obstrução, aspiração e distúrbios eletrolíticos graves.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=poliestirenossulfonato+de+calcio",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=poliestirenossulfonato+de+calcio"
  },
  "es": {
    "name": "Poliestirenossulfonato de cálcio",
    "class": "Resina de troca de potássio na forma cálcica",
    "pharmacologicClass": "Resina de troca de potássio na forma cálcica",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Pó ou suspensão oral/retal con conteúdo definido de resina cálcica.",
    "presentations": "Pó ou suspensão oral/retal con conteúdo definido de resina cálcica.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Tratamento da hiperpotassemia conforme produto y protocolo local.",
    "dose": "Dose y via dependem da apresentação. No converter automaticamente da resina sódica; monitorar potássio, cálcio y magnésio. No substitui estabilização cardíaca y deslocamento intracelular na emergência.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Constipação, náusea, hipocalemia y hipercalcemia.",
    "dangerousAdverseEffects": "Necrose intestinal, obstrução, aspiração y distúrbios eletrolíticos graves.",
    "adverseEffects": "Constipação, náusea, hipocalemia y hipercalcemia.; Necrose intestinal, obstrução, aspiração y distúrbios eletrolíticos graves.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade y riscos graves aplicáveis.",
    "administration": "Usar somente via y formulação documentadas; respeitar técnica específica.",
...
/* GOLD33_SELECTIVE:poliestirenossulfonato_de_calcio:END */
/* GOLD33_SELECTIVE:poliestirenossulfonato_de_sodio:START */
;(function(){var db=window.NEFRO_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="poliestirenossulfonato_de_sodio";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:poliestirenossulfonato_de_sodio:"+matches.length);drug=matches[0];}else{drug=db&&db["poliestirenossulfonato_de_sodio"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:poliestirenossulfonato_de_sodio");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "063",
    "requiredFieldCount": 33,
  ...
  "pt": {
    ...
    "class": "Resina de troca de potássio na forma sódica",
    "pharmacologicClass": "Resina de troca de potássio na forma sódica",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Pó ou suspensão oral/retal; concentração e excipientes variam por produto.",
    "presentations": "Pó ou suspensão oral/retal; concentração e excipientes variam por produto.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância e exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo e eliminação na fonte primária.",
    "indications": "Tratamento da hiperpotassemia conforme produto e protocolo; início imprevisível limita uso em emergência.",
    "dose": "Dose e via dependem da formulação e do protocolo. Monitorar potássio, sódio, cálcio e magnésio; considerar carga de sódio. Não usar como única medida em hiperpotassemia ameaçadora à vida.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Constipação, náusea, hipocalemia e retenção de sódio.",
    "dangerousAdverseEffects": "Necrose intestinal, obstrução, aspiração, sobrecarga de volume e distúrbios eletrolíticos graves.",
    "adverseEffects": "Constipação, náusea, hipocalemia e retenção de sódio.; Necrose intestinal, obstrução, aspiração, sobrecarga de volume e distúrbios eletrolíticos graves.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade e riscos graves aplicáveis.",
    "administration": "Usar somente via e formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações e vias não são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação e jurisdição.",
    "safetyFlags": "Necrose intestinal, obstrução, aspiração, sobrecarga de volume e distúrbios eletrolíticos graves.",
    "alerts": "Necrose intestinal, obstrução, aspiração, sobrecarga de volume e distúrbios eletrolíticos graves.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=poliestirenossulfonato+de+sodio",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=poliestirenossulfonato+de+sodio"
  },
  "es": {
    "name": "Poliestirenossulfonato de sódio",
    "class": "Resina de troca de potássio na forma sódica",
    "pharmacologicClass": "Resina de troca de potássio na forma sódica",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Pó ou suspensão oral/retal; concentração y excipientes variam por produto.",
    "presentations": "Pó ou suspensão oral/retal; concentração y excipientes variam por produto.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Tratamento da hiperpotassemia conforme produto y protocolo; início imprevisível limita uso em emergência.",
    "dose": "Dose y via dependem da formulação y do protocolo. Monitorar potássio, sódio, cálcio y magnésio; considerar carga de sódio. No usar como única medida em hiperpotassemia ameaçadora à vida.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Constipação, náusea, hipocalemia y retenção de sódio.",
    "dangerousAdverseEffects": "Necrose intestinal, obstrução, aspiração, sobrecarga de volume y distúrbios eletrolíticos graves.",
    "adverseEffects": "Constipação, náusea, hipocalemia y retenção de sódio.; Necrose intestinal, obstrução, aspiração, sobrecarga de volume y distúrbios eletrolíticos graves.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade y riscos graves aplicáveis.",
    "administration": "Usar somente via y formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações y vias no são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação y jurisdição.",
    "safetyFlags": "Necrose intestinal, obstrução, aspiração, sobrecarga de volume y distúrbios eletrolíticos graves.",
    "alerts": "Necrose intestinal, obstrução, aspiração, sobrecarga de volume y distúrbios eletrolíticos graves.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=poliestirenossulfonato+de+sodio",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
...
/* GOLD33_SELECTIVE:poliestirenossulfonato_de_sodio:END */
/* GOLD33_SELECTIVE:ringer_lactato:START */
;(function(){var db=window.NEFRO_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="ringer_lactato";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:ringer_lactato:"+matches.length);drug=matches[0];}else{drug=db&&db["ringer_lactato"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:ringer_lactato");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "068",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Solução de Ringer com lactato",
    "class": "Cristaloide isotônico balanceado",
    "pharmacologicClass": "Cristaloide isotônico balanceado",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Bolsas IV em volumes específicos.",
    "presentations": "Bolsas IV em volumes específicos.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância e exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo e eliminação na fonte primária.",
    "indications": "Reposição de volume e fluidoterapia conforme avaliação clínica.",
    "dose": "Volume e velocidade devem ser individualizados por volemia, eletrólitos, função renal/cardíaca e perdas. Não existe taxa universal; verificar compatibilidade e conteúdo de cálcio.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Edema, sobrecarga de volume e alterações eletrolíticas.",
    "dangerousAdverseEffects": "Edema pulmonar, hiperpotassemia e complicações de incompatibilidade/infusão.",
    "adverseEffects": "Edema, sobrecarga de volume e alterações eletrolíticas.; Edema pulmonar, hiperpotassemia e complicações de incompatibilidade/infusão.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade e riscos graves aplicáveis.",
    "administration": "Usar somente via e formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações e vias não são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação e jurisdição.",
    "safetyFlags": "Edema pulmonar, hiperpotassemia e complicações de incompatibilidade/infusão.",
    "alerts": "Edema pulmonar, hiperpotassemia e complicações de incompatibilidade/infusão.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=ringer+lactato",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=ringer+lactato"
  },
  "es": {
    "name": "Solução de Ringer con lactato",
    "class": "Cristaloide isotônico balanceado",
    "pharmacologicClass": "Cristaloide isotônico balanceado",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Bolsas IV em volumes específicos.",
    ...
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Reposição de volume y fluidoterapia conforme avaliação clínica.",
    "dose": "Volume y velocidade devem ser individualizados por volemia, eletrólitos, función renal/cardíaca y perdas. No existe taxa universal; verificar compatibilidade y conteúdo de cálcio.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Edema, sobrecarga de volume y alterações eletrolíticas.",
    "dangerousAdverseEffects": "Edema pulmonar, hiperpotassemia y complicações de incompatibilidade/infusão.",
    "adverseEffects": "Edema, sobrecarga de volume y alterações eletrolíticas.; Edema pulmonar, hiperpotassemia y complicações de incompatibilidade/infusão.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade y riscos graves aplicáveis.",
    "administration": "Usar somente via y formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações y vias no são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação y jurisdição.",
    "safetyFlags": "Edema pulmonar, hiperpotassemia y complicações de incompatibilidade/infusão.",
    "alerts": "Edema pulmonar, hiperpotassemia y complicações de incompatibilidade/infusão.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=ringer+lactato",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
...
/* GOLD33_SELECTIVE:sparsentana:START */
;(function(){var db=window.NEFRO_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="sparsentana";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:sparsentana:"+matches.length);drug=matches[0];}else{drug=db&&db["sparsentana"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:sparsentana");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "073",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Sparsentana",
    "class": "Antagonista dual dos receptores de endotelina e angiotensina II",
    "pharmacologicClass": "Antagonista dual dos receptores de endotelina e angiotensina II",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Comprimidos em forças específicas, sujeitos a programa de segurança onde aplicável.",
    "presentations": "Comprimidos em forças específicas, sujeitos a programa de segurança onde aplicável.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância e exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo e eliminação na fonte primária.",
    "indications": "Redução de proteinúria na nefropatia por IgA em adultos elegíveis conforme aprovação local.",
    "dose": "Dose oral titulada com monitorização hepática, pressão, potássio, função renal e teste de gravidez. Não combinar com bloqueadores do sistema renina-angiotensina.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Edema, hipotensão, tontura, hiperpotassemia e anemia.",
    "dangerousAdverseEffects": "Hepatotoxicidade, toxicidade embriofetal, lesão renal e retenção hídrica.",
    "adverseEffects": "Edema, hipotensão, tontura, hiperpotassemia e anemia.; Hepatotoxicidade, toxicidade embriofetal, lesão renal e retenção hídrica.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade e riscos graves aplicáveis.",
    "administration": "Usar somente via e formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações e vias não são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação e jurisdição.",
    "safetyFlags": "Hepatotoxicidade, toxicidade embriofetal, lesão renal e retenção hídrica.",
    "alerts": "Hepatotoxicidade, toxicidade embriofetal, lesão renal e retenção hídrica.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=sparsentana",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=sparsentana"
  },
  "es": {
    "name": "Sparsentana",
    "class": "Antagonista dual dos receptores de endotelina y angiotensina II",
    "pharmacologicClass": "Antagonista dual dos receptores de endotelina y angiotensina II",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Comprimidos em forças específicas, sujeitos a programa de seguridad onde aplicável.",
    "presentations": "Comprimidos em forças específicas, sujeitos a programa de seguridad onde aplicável.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Redução de proteinúria na nefropatia por IgA em adultos elegíveis conforme aprovação local.",
    "dose": "Dose oral titulada con monitorização hepática, pressão, potássio, función renal y teste de gravidez. No combinar con bloqueadores do sistema renina-angiotensina.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Edema, hipotensão, tontura, hiperpotassemia y anemia.",
    "dangerousAdverseEffects": "Hepatotoxicidade, toxicidade embriofetal, lesão renal y retenção hídrica.",
    "adverseEffects": "Edema, hipotensão, tontura, hiperpotassemia y anemia.; Hepatotoxicidade, toxicidade embriofetal, lesão renal y retenção hídrica.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade y riscos graves aplicáveis.",
    "administration": "Usar somente via y formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações y vias no são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação y jurisdição.",
    "safetyFlags": "Hepatotoxicidade, toxicidade embriofetal, lesão renal y retenção hídrica.",
    "alerts": "Hepatotoxicidade, toxicidade embriofetal, lesão renal y retenção hídrica.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=sparsentana",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
...
/* GOLD33_SELECTIVE:voclosporina:START */
;(function(){var db=window.NEFRO_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="voclosporina";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:voclosporina:"+matches.length);drug=matches[0];}else{drug=db&&db["voclosporina"];if(!drug&&db){var keys=Object.keys(db).filter(function(key){return key.toLowerCase()==="voclosporina";});if(keys.length>1)throw new Error("GOLD33_CANONICAL_CARDINALITY:voclosporina:"+keys.length);if(keys.length===1)drug=db[keys[0]];}if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:voclosporina");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "083",
    "requiredFieldCount": 33,
  ...
  "pt": {
    ...
    "commercialNames": "Marcas variam por país.",
    "presentation": "Cápsulas em força específica.",
    "presentations": "Cápsulas em força específica.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância e exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo e eliminação na fonte primária.",
    "indications": "Nefrite lúpica ativa em adultos, em combinação com terapia de base conforme rótulo.",
    "dose": "Dose oral em combinação, com avaliação de eGFR, pressão, potássio e interações CYP3A4. Não requer nível de vale rotineiro, mas exige critérios de redução/interrupção renal.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Redução de eGFR, hipertensão, diarreia, cefaleia e tosse.",
    "dangerousAdverseEffects": "Nefrotoxicidade, infecção grave, malignidade, neurotoxicidade e hiperpotassemia.",
    "adverseEffects": "Redução de eGFR, hipertensão, diarreia, cefaleia e tosse.; Nefrotoxicidade, infecção grave, malignidade, neurotoxicidade e hiperpotassemia.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade e riscos graves aplicáveis.",
    "administration": "Usar somente via e formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações e vias não são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação e jurisdição.",
    "safetyFlags": "Nefrotoxicidade, infecção grave, malignidade, neurotoxicidade e hiperpotassemia.",
    "alerts": "Nefrotoxicidade, infecção grave, malignidade, neurotoxicidade e hiperpotassemia.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=voclosporina",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=voclosporina"
  },
  "es": {
    "name": "Voclosporina",
    "class": "Inibidor da calcineurina imunossupressor",
    ...
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Nefrite lúpica ativa em adultos, em combinação con terapia de base conforme rótulo.",
    "dose": "Dose oral em combinação, con avaliação de eGFR, pressão, potássio y interações CYP3A4. No requer nível de vale rotineiro, mas exige critérios de redução/interrupção renal.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Redução de eGFR, hipertensão, diarreia, cefaleia y tosse.",
    "dangerousAdverseEffects": "Nefrotoxicidade, infecção grave, malignidade, neurotoxicidade y hiperpotassemia.",
    "adverseEffects": "Redução de eGFR, hipertensão, diarreia, cefaleia y tosse.; Nefrotoxicidade, infecção grave, malignidade, neurotoxicidade y hiperpotassemia.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade y riscos graves aplicáveis.",
    "administration": "Usar somente via y formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações y vias no são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação y jurisdição.",
    "safetyFlags": "Nefrotoxicidade, infecção grave, malignidade, neurotoxicidade y hiperpotassemia.",
    "alerts": "Nefrotoxicidade, infecção grave, malignidade, neurotoxicidade y hiperpotassemia.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=voclosporina",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
...
/* GOLD33_SELECTIVE:voclosporina:END */
