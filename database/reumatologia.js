...
;(function(){var db=window.REUMATOLOGIA_DRUGS_DB;if(!db||!db["abatacepte"])throw new Error("GOLD33_MISSING_CANONICAL:abatacepte");db["abatacepte"].mcGoldClinicalV1={
  ...
  "pt": {
    ...
    "commercialNames": "ORENCIA (abatacept; produto de referência documentado no DailyMed/FDA).",
    "presentation": "Formulações IV e SC; a fonte US descreve frasco IV 250 mg e formulações SC.",
    "presentations": "EUA: 250 mg de pó liofilizado em frasco de dose única para infusão IV; solução SC em seringa preenchida de 50 mg/0,4 mL, 87,5 mg/0,7 mL e 125 mg/mL; autoinjetor ClickJect 125 mg/mL. Não intercambiar via ou dispositivo no cálculo.",
    ...
    "pharmacokinetics": "Em adultos com AR após 10 mg/kg IV repetidos: Cmax média ~295 mcg/mL, meia-vida terminal média ~13,1 dias, depuração sistêmica ~0,22 mL/h/kg e Vss ~0,07 L/kg. Após SC, biodisponibilidade relativa ~79%, meia-vida terminal média ~14,3 dias; a depuração aumenta com o peso corporal. Não há estudos formais de PK em insuficiência renal ou hepática.",
    ...
    "adverseEffects": "Em artrite reumatoide, eventos comuns (≥10% no rótulo) incluem cefaleia, infecção de vias aéreas superiores, nasofaringite e náusea. Eventos graves incluem infecções sérias e reações de hipersensibilidade; o risco de infecção aumenta com imunossupressão concomitante. Em profilaxia de aGVHD, o perfil e frequências são diferentes e incluem anemia, hipertensão, reativação/infecção por CMV, febre, pneumonia, epistaxe, redução de CD4, hipermagnesemia e lesão renal aguda.",
    ...
    "preparation": "IV: reconstituir 250 mg com 10 mL de água para injeção usando a seringa sem silicone fornecida; girar suavemente, não agitar, e depois diluir em SF 0,9% até 100 mL antes da infusão. SC: seringas/autoinjetor são soluções prontas para uso subcutâneo e não devem ser reconstituídas nem administradas IV.",
    "infusionProtocol": "Formulação IV ORENCIA 250 mg: reconstituir cada frasco com 10 mL de água estéril para injeção usando seringa sem silicone, obtendo 25 mg/mL; diluir o volume calculado em SF 0,9% até volume final de 100 mL. Para RA/pJIA/PsA, a infusão IV é administrada em 30 min. Para profilaxia de aGVHD, o rótulo utiliza infusão de 60 min; manter esses protocolos separados.",
    "pregnancy": "Dados e decisão dependem de indicação e produto; não concluir nesta ficha.",
    "lactation": "Não concluir nesta ficha.",
    "specialPopulations": "Pediatria: o rótulo possui indicações e esquemas específicos para pJIA/PsA e profilaxia de aGVHD a partir de 2 anos em determinadas vias/regimes; não extrapolar entre indicações. Idosos: não há ajuste apenas por idade, mas infecções/comorbidades exigem vigilância. Insuficiência renal/hepática: não há estudos formais de PK suficientes para recomendar ajuste padronizado.",
    ...
    "clinicalPearls": "Antes de iniciar, rastrear infecções relevantes/TB e hepatites conforme o rótulo e atualizar vacinas. Evitar vacinas vivas durante o tratamento e por 3 meses após suspensão. O uso concomitante com outros bDMARDs/JAK inibidores não é recomendado pelo aumento de infecções. Não misturar os regimes IV de RA/pJIA/PsA com o regime de profilaxia de aGVHD.",
    "guidelineRecommendations": "EULAR 2025 atualizou a estratégia de DMARDs para artrite reumatoide. A atualização mantém os bDMARDs como opções fundamentais após resposta inadequada a csDMARD conforme estratificação clínica; abatacepte é um bDMARD estabelecido. A versão EULAR 2022 explicitava que, diante de fatores prognósticos desfavoráveis após resposta inadequada ao tratamento inicial, um bDMARD pode ser adicionado. A seleção de abatacepte deve ser individualizada pelo perfil de doença, segurança e tratamentos prévios.",
  ...
  "es": {
    ...
    "commercialNames": "ORENCIA (abatacept; producto de referencia documentado en DailyMed/FDA).",
    "presentation": "Formulaciones IV y SC; la fuente estadounidense describe vial IV 250 mg y formulaciones SC.",
    "presentations": "EE. UU.: 250 mg de polvo liofilizado en vial de dosis única para infusión IV; solución SC en jeringa precargada de 50 mg/0,4 mL, 87,5 mg/0,7 mL y 125 mg/mL; autoinyector ClickJect 125 mg/mL. No intercambiar vía ni dispositivo en el cálculo.",
    ...
    "pharmacokinetics": "En adultos con AR tras 10 mg/kg IV repetidos: Cmax media ~295 mcg/mL, semivida terminal media ~13,1 días, depuración sistémica ~0,22 mL/h/kg y Vss ~0,07 L/kg. Tras SC, biodisponibilidad relativa ~79%, semivida terminal media ~14,3 días; la depuración aumenta con el peso corporal. No existen estudios formales de PK en insuficiencia renal o hepática.",
    ...
    "adverseEffects": "En artritis reumatoide, eventos comunes (≥10% en el etiquetado) incluyen cefalea, infección de vías respiratorias superiores, nasofaringitis y náuseas. Eventos graves incluyen infecciones serias y reacciones de hipersensibilidad; el riesgo de infección aumenta con inmunosupresión concomitante. En profilaxis de aGVHD, el perfil y las frecuencias son diferentes e incluyen anemia, hipertensión, reactivación/infección por CMV, fiebre, neumonía, epistaxis, disminución de CD4, hipermagnesemia y lesión renal aguda.",
    ...
    "preparation": "IV: reconstituir 250 mg con 10 mL de agua para inyección usando la jeringa sin silicona provista; girar suavemente, no agitar, y luego diluir en SSN 0,9% hasta 100 mL antes de la infusión. SC: las jeringas/autoinyector son soluciones listas para uso subcutáneo y no deben reconstituirse ni administrarse IV.",
    "infusionProtocol": "Formulación IV ORENCIA 250 mg: reconstituir cada vial con 10 mL de agua estéril para inyección usando jeringa sin silicona, obteniendo 25 mg/mL; diluir el volumen calculado en SSN 0,9% hasta volumen final de 100 mL. Para AR/pJIA/PsA, la infusión IV se administra en 30 min. Para profilaxis de aGVHD, el etiquetado utiliza infusión de 60 min; mantener estos protocolos separados.",
    ...
    "specialPopulations": "Pediatría: el etiquetado posee indicaciones y esquemas específicos para pJIA/PsA y profilaxis de aGVHD desde los 2 años en determinadas vías/regímenes; no extrapolar entre indicaciones. Mayores: no hay ajuste sólo por edad, pero infecciones/comorbilidades requieren vigilancia. Insuficiencia renal/hepática: no hay estudios formales de PK suficientes para recomendar ajuste estandarizado.",
    ...
    "clinicalPearls": "Antes de iniciar, evaluar infecciones relevantes/TB y hepatitis según el etiquetado y actualizar vacunas. Evitar vacunas vivas durante el tratamiento y durante 3 meses tras la suspensión. El uso concomitante con otros bDMARD/JAK inhibidores no se recomienda por aumento de infecciones. No mezclar los regímenes IV de AR/pJIA/PsA con el régimen de profilaxis de aGVHD.",
    "guidelineRecommendations": "EULAR 2025 actualizó la estrategia de DMARD para artritis reumatoide. La actualización mantiene a los bDMARD como opciones fundamentales tras respuesta inadecuada a csDMARD según estratificación clínica; abatacept es un bDMARD establecido. La versión EULAR 2022 explicitaba que, ante factores pronósticos desfavorables tras respuesta inadecuada al tratamiento inicial, puede añadirse un bDMARD. La selección de abatacept debe individualizarse por perfil de enfermedad, seguridad y tratamientos previos.",
...
/* GOLD33_SELECTIVE:certolizumabe_pegol:START */
;(function(){var db=window.REUMATOLOGIA_DRUGS_DB;if(!db||!db["certolizumabe_pegol"])throw new Error("GOLD33_MISSING_CANONICAL:certolizumabe_pegol");db["certolizumabe_pegol"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "017",
    "requiredFieldCount": 33,
  ...
  "pt": {
    ...
    "class": "Biológico anti-TNF",
    "pharmacologicClass": "Fragmento Fab peguilado anti-TNF-alfa",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Seringa/caneta 200 mg/mL; frasco liofilizado 200 mg.",
    "presentations": "Seringa/caneta 200 mg/mL; frasco liofilizado 200 mg.",
    "mechanism": "Fragmento Fab peguilado anti-TNF-alfa. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Fragmento peguilado sem Fc; meia-vida ~14 dias; catabolismo proteico.",
    "indications": "AR, artrite psoriásica, espondiloartrite axial, Crohn e psoríase em adultos conforme rótulo.",
    "dose": "Ataque frequente: 400 mg SC nas semanas 0, 2 e 4; manutenção 200 mg a cada 2 semanas ou 400 mg a cada 4 semanas, conforme indicação.",
    ...
    "commonAdverseEffects": "Infecção respiratória, rash e reação no local.",
    "dangerousAdverseEffects": "TB/infecção oportunista, reativação HBV, malignidade, insuficiência cardíaca, citopenias e desmielinização.",
    "adverseEffects": "Infecção respiratória, rash e reação no local. Graves: TB/infecção oportunista, reativação HBV, malignidade, insuficiência cardíaca, citopenias e desmielinização.",
    "contraindications": "Hipersensibilidade. Não iniciar com infecção ativa clinicamente relevante.",
    "interactions": "Vacinas vivas; outros biológicos imunossupressores; cautela com imunossupressores.",
    "monitoring": "TB/HBV antes e durante, infecções, hemograma, fígado, insuficiência cardíaca, desmielinização e malignidade.",
    "administration": "SC; alternar locais, não injetar em pele inflamada.",
    "preparation": "Produto pronto ou frasco reconstituído por profissional conforme rótulo.",
    "infusionProtocol": "Não aplicável.",
    "pregnancy": "Transferência placentária mínima comparada a IgG completa; usar conforme indicação especializada.",
    "lactation": "Exposição no leite muito baixa; decisão especializada.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "TB/infecção oportunista, reativação HBV, malignidade, insuficiência cardíaca, citopenias e desmielinização. Início bloqueado sem indicação, triagem TB/HBV, infecção, vacinas, IC, neurologia e plano de monitorização.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=CIMZIA",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2024/125160s300lbl.pdf"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=CIMZIA"
  },
  "es": {
    "name": "Certolizumab pegol",
    "class": "Biológico anti-TNF",
    "pharmacologicClass": "Fragmento Fab pegilado anti-TNF-alfa",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Jeringa/pluma 200 mg/mL; vial liofilizado 200 mg.",
    "presentations": "Jeringa/pluma 200 mg/mL; vial liofilizado 200 mg.",
    "mechanism": "Fragmento Fab pegilado anti-TNF-alfa. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Fragmento pegilado sin Fc; semivida ~14 días; catabolismo proteico.",
    "indications": "AR, artritis psoriásica, espondiloartritis axial, Crohn y psoriasis en adultos según ficha.",
    "dose": "Carga frecuente: 400 mg SC semanas 0, 2 y 4; mantenimiento 200 mg cada 2 semanas o 400 mg cada 4 semanas según indicación.",
    ...
    "commonAdverseEffects": "Infección respiratoria, erupción y reacción local.",
    "dangerousAdverseEffects": "TB/infección oportunista, reactivación VHB, malignidad, insuficiencia cardíaca, citopenias y desmielinización.",
    "adverseEffects": "Infección respiratoria, erupción y reacción local. Graves: TB/infección oportunista, reactivación VHB, malignidad, insuficiencia cardíaca, citopenias y desmielinización.",
    "contraindications": "Hipersensibilidad. No iniciar con infección activa clínicamente relevante.",
    "interactions": "Vacunas vivas; otros biológicos inmunosupresores; precaución con inmunosupresores.",
    "monitoring": "TB/VHB antes y durante, infecciones, hemograma, hígado, insuficiencia cardíaca, desmielinización y malignidad.",
    "administration": "SC; alternar sitios, no inyectar en piel inflamada.",
    "preparation": "Producto listo o vial reconstituido por profesional según ficha.",
    "infusionProtocol": "No aplicable.",
    "pregnancy": "Transferencia placentaria mínima comparada con IgG completa; usar según indicación especializada.",
    "lactation": "Exposición en leche muy baja; decisión especializada.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "TB/infección oportunista, reactivación VHB, malignidad, insuficiencia cardíaca, citopenias y desmielinización. Início bloqueado sem indicação, triagem TB/HBV, infecção, vacinas, IC, neurologia e plano de monitorização.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=CIMZIA",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2024/125160s300lbl.pdf"
    ],
...
/* GOLD33_SELECTIVE:certolizumabe_pegol:END */
/* GOLD33_SELECTIVE:rituximabe:START */
;(function(){var db=window.REUMATOLOGIA_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="rituximabe";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:rituximabe:"+matches.length);drug=matches[0];}else{drug=db&&db["rituximabe"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:rituximabe");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "069",
    "requiredFieldCount": 33,
  ...
  "pt": {
    ...
    "presentation": "Concentrado IV e formulações específicas conforme mercado.",
    "presentations": "Concentrado IV e formulações específicas conforme mercado.",
    ...
    "indications": "Neoplasias hematológicas e doenças autoimunes selecionadas conforme produto e protocolo.",
    "dose": "Dose, ciclos, pré-medicação e velocidade dependem da indicação. Exige triagem de hepatite B, monitorização e protocolo de reação à infusão; vias/produtos não intercambiáveis.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Reação à infusão, febre, calafrios e infecção.",
    "dangerousAdverseEffects": "Anafilaxia, reativação de hepatite B, PML, lise tumoral e reação mucocutânea grave.",
    "adverseEffects": "Reação à infusão, febre, calafrios e infecção.; Anafilaxia, reativação de hepatite B, PML, lise tumoral e reação mucocutânea grave.",
    ...
    "safetyFlags": "Anafilaxia, reativação de hepatite B, PML, lise tumoral e reação mucocutânea grave.",
    "alerts": "Anafilaxia, reativação de hepatite B, PML, lise tumoral e reação mucocutânea grave.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=rituximabe",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=rituximabe"
  },
  "es": {
    "name": "Rituximabe",
    "class": "Anticorpo monoclonal anti-CD20",
    "pharmacologicClass": "Anticorpo monoclonal anti-CD20",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Concentrado IV y formulações específicas conforme mercado.",
    "presentations": "Concentrado IV y formulações específicas conforme mercado.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Neoplasias hematológicas y doenças autoimunes selecionadas conforme produto y protocolo.",
    "dose": "Dose, ciclos, pré-medicação y velocidade dependem da indicação. Exige triagem de hepatite B, monitorização y protocolo de reação à infusão; vias/produtos no intercambiáveis.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Reação à infusão, febre, calafrios y infecção.",
    "dangerousAdverseEffects": "Anafilaxia, reativação de hepatite B, PML, lise tumoral y reação mucocutânea grave.",
    "adverseEffects": "Reação à infusão, febre, calafrios y infecção.; Anafilaxia, reativação de hepatite B, PML, lise tumoral y reação mucocutânea grave.",
    ...
    "safetyFlags": "Anafilaxia, reativação de hepatite B, PML, lise tumoral y reação mucocutânea grave.",
    "alerts": "Anafilaxia, reativação de hepatite B, PML, lise tumoral y reação mucocutânea grave.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=rituximabe",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
