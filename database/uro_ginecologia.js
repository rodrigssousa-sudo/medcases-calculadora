...
/* GOLD33_SELECTIVE:mirabegrona:START */
;(function(){var db=window.URO_GINECOLOGIA_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="mirabegrona";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:mirabegrona:"+matches.length);drug=matches[0];}else{drug=db&&db["mirabegrona"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:mirabegrona");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "052",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Mirabegrona",
    "class": "Agonista beta-3 adrenérgico",
    "pharmacologicClass": "Agonista beta-3 adrenérgico",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Comprimidos ER 25 e 50 mg; suspensão/grânulos ER pediátricos conforme mercado.",
    "presentations": "Comprimidos ER 25 e 50 mg; suspensão/grânulos ER pediátricos conforme mercado.",
    "mechanism": "Mecanismo específico da classe conforme fonte primária e formulação.",
    "pharmacodynamics": "Mecanismo específico da classe conforme fonte primária e formulação.",
    "pharmacokinetics": "Revisar absorção, metabolismo, meia-vida e eliminação na fonte primária.",
    "indications": "Bexiga hiperativa em adultos e hiperatividade neurogênica do detrusor em pacientes pediátricos selecionados, conforme formulação.",
    "dose": "Adultos: iniciar 25 mg VO uma vez/dia; pode aumentar a 50 mg uma vez/dia após 4-8 semanas. Pediatria exige peso e tabela da formulação; não extrapolar dose adulta.",
    "pediatricDose": "Requer tabela completa por idade/peso; automação pediátrica bloqueada.",
    "renalDose": "Avaliar função renal e tabela específica; não inferir ajuste.",
    "hepaticDose": "Avaliar hepatopatia; não inferir ajuste.",
    "commonAdverseEffects": "Hipertensão, nasofaringite, infecção urinária, cefaleia e constipação.",
    "dangerousAdverseEffects": "Hipertensão grave, retenção urinária, angioedema e taquiarritmia; inibição de CYP2D6.",
    "adverseEffects": "Hipertensão, nasofaringite, infecção urinária, cefaleia e constipação.; Hipertensão grave, retenção urinária, angioedema e taquiarritmia; inibição de CYP2D6.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da bula.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas aplicáveis.",
    "monitoring": "Monitorar eficácia, tolerabilidade, função orgânica e eventos graves.",
    "administration": "Usar somente via/formulação rotulada; respeitar técnica e alimentos.",
    ...
    "clinicalPearls": "Formulações e combinações não são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Usar conforme diretriz oficial da indicação e jurisdição.",
    "safetyFlags": "Hipertensão grave, retenção urinária, angioedema e taquiarritmia; inibição de CYP2D6.",
    "alerts": "Hipertensão grave, retenção urinária, angioedema e taquiarritmia; inibição de CYP2D6.; monitorização obrigatória",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=mirabegron",
      "Fonte primária/oficial - https://www.accessdata.fda.gov/drugsatfda_docs/label/2021/202611s014lbl.pdf"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=mirabegron"
  },
  "es": {
    "name": "Mirabegrona",
    "class": "Agonista beta-3 adrenérgico",
    "pharmacologicClass": "Agonista beta-3 adrenérgico",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Comprimidos ER 25 y 50 mg; suspensão/grânulos ER pediátricos conforme mercado.",
    "presentations": "Comprimidos ER 25 y 50 mg; suspensão/grânulos ER pediátricos conforme mercado.",
    "mechanism": "Mecanismo específico da classe conforme fonte primária y formulação.",
    "pharmacodynamics": "Mecanismo específico da classe conforme fonte primária y formulação.",
    "pharmacokinetics": "Revisar absorção, metabolismo, meia-vida y eliminação na fonte primária.",
    "indications": "Bexiga hiperativa em adultos y hiperatividade neurogênica do detrusor em pacientes pediátricos selecionados, conforme formulação.",
    "dose": "Adultos: iniciar 25 mg VO uma vez/dia; pode aumentar a 50 mg uma vez/dia após 4-8 semanas. Pediatria exige peso y tabela da formulação; no extrapolar dosis adulta.",
    "pediatricDose": "Requer tabela completa por idade/peso; automação pediátrica bloqueada.",
    "renalDose": "Avaliar función renal y tabela específica; no inferir ajuste.",
    "hepaticDose": "Avaliar hepatopatia; no inferir ajuste.",
    "commonAdverseEffects": "Hipertensão, nasofaringite, infecção urinária, cefaleia y constipação.",
    "dangerousAdverseEffects": "Hipertensão grave, retenção urinária, angioedema y taquiarritmia; inibição de CYP2D6.",
    "adverseEffects": "Hipertensão, nasofaringite, infecção urinária, cefaleia y constipação.; Hipertensão grave, retenção urinária, angioedema y taquiarritmia; inibição de CYP2D6.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da bula.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas aplicáveis.",
    "monitoring": "Monitorar eficácia, tolerabilidade, función orgânica y eventos graves.",
    "administration": "Usar somente via/formulação rotulada; respeitar técnica y alimentos.",
    ...
    "clinicalPearls": "Formulações y combinações no são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Usar conforme diretriz oficial da indicação y jurisdição.",
    "safetyFlags": "Hipertensão grave, retenção urinária, angioedema y taquiarritmia; inibição de CYP2D6.",
    "alerts": "Hipertensão grave, retenção urinária, angioedema y taquiarritmia; inibição de CYP2D6.; monitorização obrigatória",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=mirabegron",
      "Fonte primária/oficial - https://www.accessdata.fda.gov/drugsatfda_docs/label/2021/202611s014lbl.pdf"
    ],
...
/* GOLD33_SELECTIVE:mirabegrona:END */
/* GOLD33_SELECTIVE:misoprostol:START */
;(function(){var db=window.URO_GINECOLOGIA_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="misoprostol";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:misoprostol:"+matches.length);drug=matches[0];}else{drug=db&&db["misoprostol"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:misoprostol");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "052",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Misoprostol",
    "class": "Análogo sintético da prostaglandina E1",
    "pharmacologicClass": "Análogo sintético da prostaglandina E1",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Comprimidos 100 e 200 microgramas.",
    "presentations": "Comprimidos 100 e 200 microgramas.",
    "mechanism": "Mecanismo específico da classe conforme fonte primária e formulação.",
    "pharmacodynamics": "Mecanismo específico da classe conforme fonte primária e formulação.",
    "pharmacokinetics": "Revisar absorção, metabolismo, meia-vida e eliminação na fonte primária.",
    "indications": "Redução do risco de úlcera gástrica induzida por AINE em pacientes de alto risco; usos obstétricos dependem de protocolo oficial separado.",
    "dose": "Prevenção de úlcera por AINE: 200 microgramas VO quatro vezes/dia com alimentos, última dose ao deitar; 100 microgramas pode ser usado se intolerância. Não reutilizar esta posologia para obstetrícia.",
    "pediatricDose": "Requer tabela completa por idade/peso; automação pediátrica bloqueada.",
    "renalDose": "Avaliar função renal e tabela específica; não inferir ajuste.",
    "hepaticDose": "Avaliar hepatopatia; não inferir ajuste.",
    "commonAdverseEffects": "Diarreia, dor abdominal, náusea, flatulência e cefaleia.",
    "dangerousAdverseEffects": "Aborto, hemorragia, ruptura uterina, choque e reações de hipersensibilidade.",
    "adverseEffects": "Diarreia, dor abdominal, náusea, flatulência e cefaleia.; Aborto, hemorragia, ruptura uterina, choque e reações de hipersensibilidade.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da bula.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas aplicáveis.",
    "monitoring": "Monitorar eficácia, tolerabilidade, função orgânica e eventos graves.",
    "administration": "Usar somente via/formulação rotulada; respeitar técnica e alimentos.",
    ...
    "clinicalPearls": "Formulações e combinações não são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Usar conforme diretriz oficial da indicação e jurisdição.",
    "safetyFlags": "Aborto, hemorragia, ruptura uterina, choque e reações de hipersensibilidade.",
    "alerts": "Aborto, hemorragia, ruptura uterina, choque e reações de hipersensibilidade.; monitorização obrigatória",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=misoprostol",
      "Fonte primária/oficial - https://www.accessdata.fda.gov/drugsatfda_docs/label/2012/019268s047lbl.pdf"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=misoprostol"
  },
  "es": {
    "name": "Misoprostol",
    "class": "Análogo sintético da prostaglandina E1",
    "pharmacologicClass": "Análogo sintético da prostaglandina E1",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Comprimidos 100 y 200 microgramas.",
    "presentations": "Comprimidos 100 y 200 microgramas.",
    "mechanism": "Mecanismo específico da classe conforme fonte primária y formulação.",
    "pharmacodynamics": "Mecanismo específico da classe conforme fonte primária y formulação.",
    "pharmacokinetics": "Revisar absorção, metabolismo, meia-vida y eliminação na fonte primária.",
    "indications": "Redução do riesgo de úlcera gástrica induzida por AINE em pacientes de alto riesgo; usos obstétricos dependem de protocolo oficial separado.",
    "dose": "Prevenção de úlcera por AINE: 200 microgramas VO quatro vezes/dia con alimentos, última dosis ao deitar; 100 microgramas pode ser usado se intolerância. No reutilizar esta posologia para obstetrícia.",
    "pediatricDose": "Requer tabela completa por idade/peso; automação pediátrica bloqueada.",
    "renalDose": "Avaliar función renal y tabela específica; no inferir ajuste.",
    "hepaticDose": "Avaliar hepatopatia; no inferir ajuste.",
    "commonAdverseEffects": "Diarreia, dor abdominal, náusea, flatulência y cefaleia.",
    "dangerousAdverseEffects": "Aborto, hemorragia, ruptura uterina, choque y reações de hipersensibilidade.",
    "adverseEffects": "Diarreia, dor abdominal, náusea, flatulência y cefaleia.; Aborto, hemorragia, ruptura uterina, choque y reações de hipersensibilidade.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da bula.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas aplicáveis.",
    "monitoring": "Monitorar eficácia, tolerabilidade, función orgânica y eventos graves.",
    "administration": "Usar somente via/formulação rotulada; respeitar técnica y alimentos.",
    ...
    "clinicalPearls": "Formulações y combinações no são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Usar conforme diretriz oficial da indicação y jurisdição.",
    "safetyFlags": "Aborto, hemorragia, ruptura uterina, choque y reações de hipersensibilidade.",
    "alerts": "Aborto, hemorragia, ruptura uterina, choque y reações de hipersensibilidade.; monitorização obrigatória",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=misoprostol",
      "Fonte primária/oficial - https://www.accessdata.fda.gov/drugsatfda_docs/label/2012/019268s047lbl.pdf"
    ],
...
/* GOLD33_SELECTIVE:oxibutinina:START */
;(function(){var db=window.URO_GINECOLOGIA_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="oxibutinina";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:oxibutinina:"+matches.length);drug=matches[0];}else{drug=db&&db["oxibutinina"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:oxibutinina");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "059",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Oxibutinina",
    "class": "Antimuscarínico urinário",
    "pharmacologicClass": "Antimuscarínico urinário",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Comprimidos IR/ER, solução, adesivo e gel transdérmico.",
    "presentations": "Comprimidos IR/ER, solução, adesivo e gel transdérmico.",
    ...
    "indications": "Bexiga hiperativa com urgência, frequência e incontinência; algumas formas têm indicações neurogênicas.",
    "dose": "IR adulta: 5 mg VO duas ou três vezes/dia, titulando conforme tolerância; ER, adesivo e gel possuem esquemas próprios.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Boca seca, constipação, tontura, sonolência e visão turva.",
    "dangerousAdverseEffects": "Retenção urinária/gástrica, hipertermia, confusão, glaucoma e angioedema.",
    "adverseEffects": "Boca seca, constipação, tontura, sonolência e visão turva.; Retenção urinária/gástrica, hipertermia, confusão, glaucoma e angioedema.",
    ...
    "safetyFlags": "Retenção urinária/gástrica, hipertermia, confusão, glaucoma e angioedema.",
    "alerts": "Retenção urinária/gástrica, hipertermia, confusão, glaucoma e angioedema.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=oxibutinina",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=oxibutinina"
  },
  "es": {
    "name": "Oxibutinina",
    "class": "Antimuscarínico urinário",
    "pharmacologicClass": "Antimuscarínico urinário",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Comprimidos IR/ER, solución, adesivo y gel transdérmico.",
    "presentations": "Comprimidos IR/ER, solución, adesivo y gel transdérmico.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Bexiga hiperativa con urgência, frequência y incontinência; algumas formas têm indicações neurogênicas.",
    "dose": "IR adulta: 5 mg VO duas ou três vezes/dia, titulando conforme tolerância; ER, adesivo y gel possuem esquemas próprios.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Boca seca, constipação, tontura, sonolência y visão turva.",
    "dangerousAdverseEffects": "Retenção urinária/gástrica, hipertermia, confusão, glaucoma y angioedema.",
    "adverseEffects": "Boca seca, constipação, tontura, sonolência y visão turva.; Retenção urinária/gástrica, hipertermia, confusão, glaucoma y angioedema.",
    ...
    "safetyFlags": "Retenção urinária/gástrica, hipertermia, confusão, glaucoma y angioedema.",
    "alerts": "Retenção urinária/gástrica, hipertermia, confusão, glaucoma y angioedema.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=oxibutinina",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
