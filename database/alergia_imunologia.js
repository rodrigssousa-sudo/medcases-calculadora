...
/* GOLD33_SELECTIVE:isotretinoina:START */
;(function(){var db=window.ALERGIA_IMUNOLOGIA_DRUGS_DB;if(!db||!db["isotretinoina"])throw new Error("GOLD33_MISSING_CANONICAL:isotretinoina");db["isotretinoina"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "043",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Isotretinoína",
    "class": "Retinoide sistêmico antiacne",
    "pharmacologicClass": "Retinoide oral; ácido 13-cis-retinoico",
    "commercialNames": "Absorica; Absorica LD; outras marcas variam por país.",
    "presentation": "Cápsulas orais; formulações não são substituíveis mg por mg.",
    "presentations": "Absorica 10, 20, 25, 30, 35, 40 mg; Absorica LD 8, 16, 20, 24, 28, 32 mg.",
    "mechanism": "Reduz tamanho/atividade das glândulas sebáceas, produção de sebo e comedogênese; mecanismo completo na acne não é totalmente definido.",
    "pharmacodynamics": "Promove remissão prolongada da acne nodular grave, com efeitos mucocutâneos e sistêmicos dependentes da exposição.",
    "pharmacokinetics": "Absorção varia por formulação/alimento; >99,9% ligada a proteínas. Metabolizada a 4-oxo-isotretinoína e outros; meia-vida ~18-24 h e metabólito ~38 h; excreção urinária/fecal.",
    "indications": "Acne nodular grave recalcitrante em pacientes >=12 anos não gestantes, não responsiva à terapia convencional inclusive antibióticos sistêmicos.",
    "dose": "Absorica 0,5-1 mg/kg/dia em 2 doses por 15-20 semanas; Absorica LD 0,4-0,8 mg/kg/dia em 2 doses por 15-20 semanas. Doença muito grave pode exigir dose maior rotulada; não intercambiar formulações.",
    "pediatricDose": ">=12 anos: mesmos regimes rotulados para acne nodular grave. <12 anos: segurança/eficácia não estabelecidas; CÁLCULO BLOQUEADO. Monitorar osso/músculo.",
    "renalDose": "Não há ajuste numérico rotulado; avaliar individualmente e monitorar toxicidade.",
    "hepaticDose": "Evitar em doença hepática clinicamente significativa; monitorar transaminases e interromper se hepatite/não normalização. Sem tabela Child-Pugh.",
    "commonAdverseEffects": "Queilite, pele seca, epistaxe, olho seco, dor musculoesquelética e alteração lipídica.",
    "dangerousAdverseEffects": "Teratogenicidade extrema, hipertensão intracraniana, reação cutânea grave, pancreatite, hepatotoxicidade e transtornos psiquiátricos.",
    "adverseEffects": "Alterações visuais/auditivas, elevação de CPK, doença inflamatória intestinal relatada e alterações hematológicas.",
    "contraindications": "Gravidez; hipersensibilidade ao produto. Programa de prevenção de gravidez obrigatório conforme jurisdição.",
    "interactions": "Evitar tetraciclinas (hipertensão intracraniana) e vitamina A/retinoides (toxicidade aditiva); álcool pode agravar hipertrigliceridemia.",
    "monitoring": "Teste de gravidez conforme programa; lipídios em jejum e função hepática antes/durante; humor, visão, sintomas neurológicos e musculoesqueléticos.",
    "administration": "VO em duas doses; engolir cápsula inteira com copo cheio. Absorica/LD com ou sem alimento conforme bula, sem substituição mg por mg.",
    "preparation": "Não manipular/abrir cápsulas; nenhuma preparação parenteral.",
    "infusionProtocol": "Não aplicável: uso oral, sem infusão.",
    "pregnancy": "CONTRAINDICADA. Risco alto de defeitos congênitos e perda gestacional; cumprir testes e contracepção/programa de risco.",
    "lactation": "Não amamentar durante o tratamento e pelo período definido na bula/programa por potencial de eventos graves.",
    "specialPopulations": "Pediatria >=12: monitorar dor, BMD e fechamento epifisário; geriatria pouco estudada; cautela em distúrbios ósseos/lipídicos/psiquiátricos.",
    "patientEducation": "Não engravidar nem doar sangue; não compartilhar; relatar cefaleia/alteração visual, humor, dor abdominal intensa, rash ou icterícia.",
    "clinicalPearls": "Absorica e Absorica LD têm biodisponibilidade/doses diferentes e não são substituíveis. Curso adicional somente após intervalo e reavaliação.",
    "guidelineRecommendations": "Reservada para acne nodular grave recalcitrante sob programa rigoroso de prevenção de gravidez e monitorização.",
    "safetyFlags": "EMBRIOFETOTOXICIDADE; programa de risco; lipídios/fígado; psiquiatria; não intercambiar formulações.",
    "alerts": "Gravidez contraindicada; testes obrigatórios; 15-20 semanas; tetraciclinas proibidas; <12 anos bloqueado.",
    "references": [
      "DailyMed/autoridade ou diretriz oficial - https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=3ef0cff8-19c1-4441-b780-fca6c7ee1615"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=3ef0cff8-19c1-4441-b780-fca6c7ee1615"
  },
  "es": {
    "name": "Isotretinoína",
    "class": "Retinoide sistêmico antiacne",
    "pharmacologicClass": "Retinoide oral; ácido 13-cis-retinoico",
    "commercialNames": "Absorica; Absorica LD; outras marcas variam por país.",
    "presentation": "Cápsulas orais; formulaciones no são substituíveis mg por mg.",
    "presentations": "Absorica 10, 20, 25, 30, 35, 40 mg; Absorica LD 8, 16, 20, 24, 28, 32 mg.",
    "mechanism": "Reduz tamanho/actividad das glândulas sebáceas, produção de sebo y comedogênese; mecanismo completo na acne no é totalmente definido.",
    "pharmacodynamics": "Promove remissão prolongada da acne nodular grave, con efeitos mucocutâneos y sistêmicos dependentes da exposição.",
    "pharmacokinetics": "Absorção varia por formulación/alimento; >99,9% ligada a proteínas. Metabolizada a 4-oxo-isotretinoína y outros; meia-vida ~18-24 h y metabólito ~38 h; excreção urinária/fecal.",
    "indications": "Acne nodular grave recalcitrante em pacientes >=12 anos no gestantes, no responsiva à terapia convencional inclusive antibióticos sistêmicos.",
    "dose": "Absorica 0,5-1 mg/kg/dia em 2 dosis por 15-20 semanas; Absorica LD 0,4-0,8 mg/kg/dia em 2 dosis por 15-20 semanas. Doença muito grave pode exigir dosis maior rotulada; no intercambiar formulaciones.",
    "pediatricDose": ">=12 anos: mesmos regimes rotulados para acne nodular grave. <12 anos: seguridad/eficacia no establecidas; CÁLCULO BLOQUEADO. Monitorar osso/músculo.",
    "renalDose": "No hay ajuste numérico rotulado; avaliar individualmente y monitorizar toxicidade.",
    "hepaticDose": "Evitar em enfermedad hepática clinicamente significativa; monitorizar transaminases y interromper se hepatite/no normalização. Sem tabela Child-Pugh.",
    "commonAdverseEffects": "Queilite, pele seca, epistaxe, olho seco, dor musculoesquelética y alteración lipídica.",
    "dangerousAdverseEffects": "Teratogenicidade extrema, hipertensão intracraniana, reacción cutânea grave, pancreatite, hepatotoxicidade y transtornos psiquiátricos.",
    "adverseEffects": "Alterações visuais/auditivas, elevação de CPK, enfermedad inflamatória intestinal relatada y alteraciones hematológicas.",
    "contraindications": "Gravidez; hipersensibilidad ao producto. Programa de prevenção de embarazo obrigatório según jurisdição.",
    "interactions": "Evitar tetraciclinas (hipertensão intracraniana) y vitamina A/retinoides (toxicidade aditiva); álcool pode agravar hipertrigliceridemia.",
    "monitoring": "Teste de embarazo según programa; lipídios em jejum y función hepática antes/durante; humor, visão, sintomas neurológicos y musculoesqueléticos.",
    "administration": "VO em duas dosis; tragar cápsula entera con vaso lleno. Absorica/LD con ou sin alimento según bula, sin substituição mg por mg.",
    "preparation": "No manipular/abrir cápsulas; nenhuma preparação parenteral.",
    "infusionProtocol": "No aplicable: uso oral, sin infusão.",
    "pregnancy": "CONTRAINDICADA. Risco alto de defeitos congênitos y perda gestacional; cumprir testes y contracepção/programa de riesgo.",
    "lactation": "No amamentar durante o tratamiento y pelo período definido na bula/programa por potencial de eventos graves.",
    "specialPopulations": "Pediatria >=12: monitorizar dor, BMD y fechamento epifisário; geriatria pouco estudada; precaución em distúrbios ósseos/lipídicos/psiquiátricos.",
    "patientEducation": "No engravidar nem donar sangre; no compartir; informar cefaleia/alteración visual, humor, dor abdominal intensa, rash ou icterícia.",
    "clinicalPearls": "Absorica y Absorica LD têm biodisponibilidade/dosis diferentes y no são substituíveis. Curso adicional solo após intervalo y reevaluación.",
    "guidelineRecommendations": "Reservada para acne nodular grave recalcitrante sob programa rigoroso de prevenção de embarazo y monitorización.",
    "safetyFlags": "EMBRIOFETOTOXICIDADE; programa de riesgo; lipídios/hígado; psiquiatria; no intercambiar formulaciones.",
    "alerts": "Gravidez contraindicada; testes obrigatórios; 15-20 semanas; tetraciclinas proibidas; <12 anos bloqueado.",
    "references": [
      "DailyMed/autoridade ou diretriz oficial - https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=3ef0cff8-19c1-4441-b780-fca6c7ee1615"
    ],
...
/* GOLD33_SELECTIVE:isotretinoina:END */
/* GOLD33_SELECTIVE:levocetirizina:START */
;(function(){var db=window.ALERGIA_IMUNOLOGIA_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="levocetirizina";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:levocetirizina:"+matches.length);drug=matches[0];}else{drug=db&&db["levocetirizina"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:levocetirizina");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "045",
    "requiredFieldCount": 33,
  ...
  "pt": {
    ...
    "presentation": "Comprimido 5 mg e solução 2,5 mg/5 mL.",
    "presentations": "Comprimido 5 mg e solução 2,5 mg/5 mL.",
    ...
    "indications": "Rinite alérgica e urticária crônica.",
    "dose": "Adultos e >=12 anos: 5 mg VO à noite; alguns respondem a 2,5 mg.",
    "pediatricDose": "6-11 anos: 2,5 mg à noite; 6 meses-5 anos: 1,25 mg à noite em indicações rotuladas. Automação bloqueada sem tabela renal completa.",
    ...
    "commonAdverseEffects": "Sonolência, fadiga, boca seca e nasofaringite.",
    "dangerousAdverseEffects": "Retenção urinária, hipersensibilidade e prurido intenso raro após suspensão de uso prolongado.",
    "adverseEffects": "Sonolência, fadiga, boca seca e nasofaringite.; Retenção urinária, hipersensibilidade e prurido intenso raro após suspensão de uso prolongado.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da formulação/indicação conforme bula.",
    "interactions": "Álcool e sedativos aumentam prejuízo; ritonavir pode elevar exposição.",
    "monitoring": "Função renal, sedação, retenção urinária e sintomas após interrupção.",
    ...
    "safetyFlags": "Retenção urinária, hipersensibilidade e prurido intenso raro após suspensão de uso prolongado.",
    "alerts": "Função renal, sedação, retenção urinária e sintomas após interrupção.; Retenção urinária, hipersensibilidade e prurido intenso raro após suspensão de uso prolongado.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=60ae7e0e-281c-40a3-a0d3-259b843ddaaa",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-safety-communications/fda-requires-warning-about-rare-severe-itching-after-stopping-long-term-use-oral-allergy-medicines"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=60ae7e0e-281c-40a3-a0d3-259b843ddaaa"
  },
  "es": {
    "name": "Levocetirizina",
    "class": "Anti-histamínico H1 de segunda geração",
    "pharmacologicClass": "Anti-histamínico H1 de segunda geração",
    "commercialNames": "Marcas variam por país; confirmar registro local.",
    "presentation": "Comprimido 5 mg y solución 2,5 mg/5 mL.",
    "presentations": "Comprimido 5 mg y solución 2,5 mg/5 mL.",
    ...
    "indications": "Rinite alérgica y urticária crônica.",
    "dose": "Adultos y >=12 anos: 5 mg VO à noite; alguns respondem a 2,5 mg.",
    "pediatricDose": "6-11 anos: 2,5 mg à noite; 6 meses-5 anos: 1,25 mg à noite em indicações rotuladas. Automação bloqueada sem tabela renal completa.",
    ...
    "commonAdverseEffects": "Sonolência, fadiga, boca seca y nasofaringite.",
    "dangerousAdverseEffects": "Retenção urinária, hipersensibilidade y prurido intenso raro após suspensão de uso prolongado.",
    "adverseEffects": "Sonolência, fadiga, boca seca y nasofaringite.; Retenção urinária, hipersensibilidade y prurido intenso raro após suspensão de uso prolongado.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da formulação/indicação conforme bula.",
    "interactions": "Álcool y sedativos aumentam prejuízo; ritonavir pode elevar exposição.",
    "monitoring": "Função renal, sedação, retenção urinária y sintomas após interrupção.",
    ...
    "safetyFlags": "Retenção urinária, hipersensibilidade y prurido intenso raro após suspensão de uso prolongado.",
    "alerts": "Função renal, sedação, retenção urinária y sintomas após interrupção.; Retenção urinária, hipersensibilidade y prurido intenso raro após suspensão de uso prolongado.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=60ae7e0e-281c-40a3-a0d3-259b843ddaaa",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-safety-communications/fda-requires-warning-about-rare-severe-itching-after-stopping-long-term-use-oral-allergy-medicines"
    ],
...
/* GOLD33_SELECTIVE:levocetirizina:END */
/* GOLD33_SELECTIVE:peroxido_de_benzoila:START */
;(function(){var db=window.ALERGIA_IMUNOLOGIA_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="peroxido_de_benzoila";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:peroxido_de_benzoila:"+matches.length);drug=matches[0];}else{drug=db&&db["peroxido_de_benzoila"];if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:peroxido_de_benzoila");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "062",
    "requiredFieldCount": 33,
  ...
  "pt": {
    ...
    "class": "Agente tópico oxidante antimicrobiano/queratolítico",
    "pharmacologicClass": "Agente tópico oxidante antimicrobiano/queratolítico",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Gel, creme ou lavagem 2,5-10%; combinações são distintas.",
    "presentations": "Gel, creme ou lavagem 2,5-10%; combinações são distintas.",
    ...
    "indications": "Acne vulgar; algumas combinações têm indicações próprias.",
    "dose": "Aplicar fina camada uma ou duas vezes/dia conforme concentração e tolerância, iniciando menos frequentemente em pele sensível. Uso tópico apenas.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Ressecamento, descamação, ardor e eritema.",
    "dangerousAdverseEffects": "Dermatite de contato grave, edema e hipersensibilidade rara; produto pode descolorir tecidos.",
    "adverseEffects": "Ressecamento, descamação, ardor e eritema.; Dermatite de contato grave, edema e hipersensibilidade rara; produto pode descolorir tecidos.",
    ...
    "safetyFlags": "Dermatite de contato grave, edema e hipersensibilidade rara; produto pode descolorir tecidos.",
    "alerts": "Dermatite de contato grave, edema e hipersensibilidade rara; produto pode descolorir tecidos.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=peroxido+de+benzoila",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=peroxido+de+benzoila"
  },
  "es": {
    "name": "Peróxido de benzoíla",
    "class": "Agente tópico oxidante antimicrobiano/queratolítico",
    ...
    "indications": "Acne vulgar; algumas combinações têm indicações próprias.",
    "dose": "Aplicar fina camada uma ou duas vezes/dia conforme concentração y tolerância, iniciando menos frequentemente em pele sensível. Uso tópico apenas.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Ressecamento, descamação, ardor y eritema.",
    "dangerousAdverseEffects": "Dermatite de contato grave, edema y hipersensibilidade rara; produto pode descolorir tecidos.",
    "adverseEffects": "Ressecamento, descamação, ardor y eritema.; Dermatite de contato grave, edema y hipersensibilidade rara; produto pode descolorir tecidos.",
    ...
    "safetyFlags": "Dermatite de contato grave, edema y hipersensibilidade rara; produto pode descolorir tecidos.",
    "alerts": "Dermatite de contato grave, edema y hipersensibilidade rara; produto pode descolorir tecidos.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=peroxido+de+benzoila",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
...
/* GOLD33_SELECTIVE:tretinoina:START */
;(function(){var db=window.ALERGIA_IMUNOLOGIA_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="tretinoina";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:tretinoina:"+matches.length);drug=matches[0];}else{drug=db&&db["tretinoina"];if(!drug&&db){var keys=Object.keys(db).filter(function(key){return key.toLowerCase()==="tretinoina";});if(keys.length>1)throw new Error("GOLD33_CANONICAL_CARDINALITY:tretinoina:"+keys.length);if(keys.length===1)drug=db[keys[0]];}if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:tretinoina");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "079",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Tretinoína tópica",
    "class": "Retinoide tópico",
    "pharmacologicClass": "Retinoide tópico",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Creme, gel e loção em diferentes concentrações.",
    "presentations": "Creme, gel e loção em diferentes concentrações.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância e exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo e eliminação na fonte primária.",
    "indications": "Acne e outras indicações dermatológicas conforme concentração e produto; tretinoína oral oncológica é distinta.",
    "dose": "Aplicar fina camada à noite conforme tolerância, iniciando em frequência reduzida se necessário. Evitar olhos/mucosas e orientar fotoproteção; não transpor para uso oral.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Eritema, descamação, ardor, ressecamento e fotossensibilidade.",
    "dangerousAdverseEffects": "Dermatite intensa, edema/vesiculação e risco fetal que exige avaliação na gestação.",
    "adverseEffects": "Eritema, descamação, ardor, ressecamento e fotossensibilidade.; Dermatite intensa, edema/vesiculação e risco fetal que exige avaliação na gestação.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade e riscos graves aplicáveis.",
    "administration": "Usar somente via e formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações e vias não são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação e jurisdição.",
    "safetyFlags": "Dermatite intensa, edema/vesiculação e risco fetal que exige avaliação na gestação.",
    "alerts": "Dermatite intensa, edema/vesiculação e risco fetal que exige avaliação na gestação.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=tretinoina",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=tretinoina"
  },
  "es": {
    "name": "Tretinoína tópica",
    "class": "Retinoide tópico",
    "pharmacologicClass": "Retinoide tópico",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Creme, gel y loção em diferentes concentrações.",
    "presentations": "Creme, gel y loção em diferentes concentrações.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Acne y outras indicações dermatológicas conforme concentração y produto; tretinoína oral oncológica é distinta.",
    "dose": "Aplicar fina camada à noite conforme tolerância, iniciando em frequência reduzida se necessário. Evitar olhos/mucosas y orientar fotoproteção; no transpor para uso oral.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Eritema, descamação, ardor, ressecamento y fotossensibilidade.",
    "dangerousAdverseEffects": "Dermatite intensa, edema/vesiculação y risco fetal que exige avaliação na gestação.",
    "adverseEffects": "Eritema, descamação, ardor, ressecamento y fotossensibilidade.; Dermatite intensa, edema/vesiculação y risco fetal que exige avaliação na gestação.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade y riscos graves aplicáveis.",
    "administration": "Usar somente via y formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações y vias no são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação y jurisdição.",
    "safetyFlags": "Dermatite intensa, edema/vesiculação y risco fetal que exige avaliação na gestação.",
    "alerts": "Dermatite intensa, edema/vesiculação y risco fetal que exige avaliação na gestação.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=tretinoina",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
...
/* GOLD33_SELECTIVE:tretinoina:END */
/* GOLD33_SELECTIVE:triancinolona_topica:START */
;(function(){var db=window.ALERGIA_IMUNOLOGIA_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="triancinolona_topica";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:triancinolona_topica:"+matches.length);drug=matches[0];}else{drug=db&&db["triancinolona_topica"];if(!drug&&db){var keys=Object.keys(db).filter(function(key){return key.toLowerCase()==="triancinolona_topica";});if(keys.length>1)throw new Error("GOLD33_CANONICAL_CARDINALITY:triancinolona_topica:"+keys.length);if(keys.length===1)drug=db[keys[0]];}if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:triancinolona_topica");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "079",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Triancinolona tópica",
    "class": "Corticosteroide tópico",
    "pharmacologicClass": "Corticosteroide tópico",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Creme, pomada, loção e outras formulações em várias concentrações.",
    "presentations": "Creme, pomada, loção e outras formulações em várias concentrações.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância e exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo e eliminação na fonte primária.",
    "indications": "Dermatoses inflamatórias responsivas a corticosteroides conforme potência, local e formulação.",
    "dose": "Aplicar camada fina pelo menor período necessário. Potência e absorção variam com concentração, veículo, área, oclusão e idade; evitar uso inadequado em face/dobras.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Ardor, irritação, ressecamento e foliculite.",
    "dangerousAdverseEffects": "Atrofia cutânea, supressão do eixo HPA, glaucoma, infecção e síndrome de Cushing.",
    "adverseEffects": "Ardor, irritação, ressecamento e foliculite.; Atrofia cutânea, supressão do eixo HPA, glaucoma, infecção e síndrome de Cushing.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade e riscos graves aplicáveis.",
    "administration": "Usar somente via e formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações e vias não são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação e jurisdição.",
    "safetyFlags": "Atrofia cutânea, supressão do eixo HPA, glaucoma, infecção e síndrome de Cushing.",
    "alerts": "Atrofia cutânea, supressão do eixo HPA, glaucoma, infecção e síndrome de Cushing.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=triancinolona+topica",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=triancinolona+topica"
  },
  "es": {
    "name": "Triancinolona tópica",
    "class": "Corticosteroide tópico",
    "pharmacologicClass": "Corticosteroide tópico",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Creme, pomada, loção y outras formulações em várias concentrações.",
    "presentations": "Creme, pomada, loção y outras formulações em várias concentrações.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Dermatoses inflamatórias responsivas a corticosteroides conforme potência, local y formulação.",
    "dose": "Aplicar camada fina pelo menor período necessário. Potência y absorção variam con concentração, veículo, área, oclusão y idade; evitar uso inadequado em face/dobras.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Ardor, irritação, ressecamento y foliculite.",
    "dangerousAdverseEffects": "Atrofia cutânea, supressão do eixo HPA, glaucoma, infecção y síndrome de Cushing.",
    "adverseEffects": "Ardor, irritação, ressecamento y foliculite.; Atrofia cutânea, supressão do eixo HPA, glaucoma, infecção y síndrome de Cushing.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade y riscos graves aplicáveis.",
    "administration": "Usar somente via y formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações y vias no são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação y jurisdição.",
    "safetyFlags": "Atrofia cutânea, supressão do eixo HPA, glaucoma, infecção y síndrome de Cushing.",
    "alerts": "Atrofia cutânea, supressão do eixo HPA, glaucoma, infecção y síndrome de Cushing.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=triancinolona+topica",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
