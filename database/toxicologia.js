...
;(function(){var db=window.TOXICOLOGIA_DRUGS_DB;if(!db||!db["acamprosato"])throw new Error("GOLD33_MISSING_CANONICAL:acamprosato");db["acamprosato"].mcGoldClinicalV1={
  ...
  "pt": {
    ...
    "commercialNames": "CAMPRAL (marca de referência histórica/documentada nos EUA) e múltiplos genéricos de acamprosato cálcico 333 mg de liberação retardada. Disponibilidade local deve ser verificada por país.",
    "presentation": "Comprimido gastrorresistente 333 mg no rótulo US consultado.",
    "presentations": "EUA: comprimido de liberação retardada de acamprosato cálcico 333 mg (equivalente a 300 mg de acamprosato no produto de referência). Existem múltiplos genéricos com a mesma força; confirmar fabricante e registro local.",
    ...
    "pharmacodynamics": "O mecanismo exato não é completamente definido. Evidência pré-clínica sugere modulação do equilíbrio entre neurotransmissão glutamatérgica excitatória e GABAérgica inibitória alterada pela exposição crônica ao álcool. Não causa reação tipo dissulfiram, nem demonstrou potencial de dependência/tolerância nas condições estudadas.",
    "pharmacokinetics": "VO: biodisponibilidade absoluta ~11%; estado estacionário em ~5 dias. Após 666 mg 3x/dia, Cmax média em estado estacionário ~350 ng/mL, atingida 3-8 h após a dose. Alimento reduz Cmax/AUC em ~42%/~23%, sem relevância clínica que exija ajuste. Vd estimado 72-109 L (~1 L/kg), ligação proteica desprezível; não sofre metabolismo. Meia-vida terminal ~20-33 h e eliminação principal renal como acamprosato inalterado.",
    ...
    "adverseEffects": "O efeito adverso mais característico é diarreia. Outros eventos relatados incluem flatulência, náusea, dor abdominal, prurido, tontura, ansiedade/depressão, insônia e parestesias. Há advertência para ideação/tentativa suicida no contexto da dependência alcoólica e relato pós-comercialização de insuficiência renal aguda; hipersensibilidade também pode ocorrer.",
    ...
    "preparation": "Comprimido de liberação retardada/entérico pronto para uso oral; não requer reconstituição nem diluição. A formulação deve ser engolida inteira, preservando o revestimento de liberação retardada.",
    "infusionProtocol": "NÃO APLICÁVEL COMPROVADO: acamprosato é apresentado como comprimido oral de liberação retardada; não existe protocolo de infusão.",
    "pregnancy": "Não concluir nesta ficha.",
    "lactation": "Não concluir nesta ficha.",
    "specialPopulations": "Pediatria: farmacocinética/segurança não estabelecidas para uso rotineiro; não automatizar. Idosos: dados são limitados e, como a eliminação é renal, maior exposição é possível com declínio da função renal. Insuficiência renal moderada aumenta exposição e exige redução de dose; insuficiência renal grave é contraindicação no rótulo. Não há metabolismo hepático relevante.",
    ...
    "clinicalPearls": "Acamprosato é manutenção da abstinência após retirada/desintoxicação, não tratamento de abstinência aguda e não produz reação aversiva tipo dissulfiram. Deve ser combinado com suporte psicossocial. A eliminação é renal e o fármaco não é metabolizado, tornando a função renal central para seleção/dose.",
    "guidelineRecommendations": "NICE CG115: após retirada bem-sucedida em dependência moderada-grave de álcool, considerar acamprosato ou naltrexona oral em combinação com intervenção psicológica específica. Se acamprosato for escolhido, iniciar o mais cedo possível após a retirada assistida; a diretriz usa 666 mg 3x/dia, com redução do total diário em pessoas <60 kg, e recomenda tratamento geralmente até 6 meses ou mais se houver benefício, interrompendo se o consumo persistir 4-6 semanas após início.",
  ...
  "es": {
    ...
    "commercialNames": "CAMPRAL (marca de referencia histórica/documentada en EE. UU.) y múltiples genéricos de acamprosato cálcico 333 mg de liberación retardada. La disponibilidad local debe verificarse por país.",
    "presentation": "Comprimido gastrorresistente 333 mg en el etiquetado estadounidense consultado.",
    "presentations": "EE. UU.: comprimido de liberación retardada de acamprosato cálcico 333 mg (equivalente a 300 mg de acamprosato en el producto de referencia). Existen múltiples genéricos con la misma dosis; confirmar fabricante y registro local.",
    ...
    "pharmacodynamics": "El mecanismo exacto no está completamente definido. La evidencia preclínica sugiere modulación del equilibrio entre neurotransmisión glutamatérgica excitatoria y GABAérgica inhibitoria alterada por la exposición crónica al alcohol. No causa reacción tipo disulfiram ni demostró potencial de dependencia/tolerancia en las condiciones estudiadas.",
    "pharmacokinetics": "VO: biodisponibilidad absoluta ~11%; estado estacionario en ~5 días. Tras 666 mg 3 veces/día, Cmax media en estado estacionario ~350 ng/mL, alcanzada 3-8 h después de la dosis. Los alimentos reducen Cmax/AUC ~42%/~23%, sin relevancia clínica que exija ajuste. Vd estimado 72-109 L (~1 L/kg), unión proteica despreciable; no se metaboliza. Semivida terminal ~20-33 h y eliminación principal renal como acamprosato sin cambios.",
    ...
    "adverseEffects": "El efecto adverso más característico es la diarrea. Otros eventos informados incluyen flatulencia, náuseas, dolor abdominal, prurito, mareo, ansiedad/depresión, insomnio y parestesias. Existe advertencia sobre ideación/intento suicida en el contexto de dependencia alcohólica y reporte poscomercialización de insuficiencia renal aguda; también puede ocurrir hipersensibilidad.",
    ...
    "preparation": "Comprimido de liberación retardada/entérico listo para uso oral; no requiere reconstitución ni dilución. La formulación debe tragarse entera, preservando el recubrimiento de liberación retardada.",
    "infusionProtocol": "NO APLICA, comprobado: acamprosato se presenta como comprimido oral de liberación retardada; no existe protocolo de infusión.",
    "pregnancy": "No concluir en esta ficha.",
    "lactation": "No concluir en esta ficha.",
    "specialPopulations": "Pediatría: farmacocinética/seguridad no establecidas para uso rutinario; no automatizar. Mayores: los datos son limitados y, como la eliminación es renal, puede haber mayor exposición con deterioro de función renal. Insuficiencia renal moderada aumenta exposición y exige reducción de dosis; insuficiencia renal grave es contraindicación en el etiquetado. No hay metabolismo hepático relevante.",
    ...
    "clinicalPearls": "Acamprosato es mantenimiento de la abstinencia tras retirada/desintoxicación, no tratamiento de abstinencia aguda y no produce reacción aversiva tipo disulfiram. Debe combinarse con apoyo psicosocial. La eliminación es renal y el fármaco no se metaboliza, por lo que la función renal es central para selección/dosis.",
    "guidelineRecommendations": "NICE CG115: tras retirada exitosa en dependencia moderada-grave de alcohol, considerar acamprosato o naltrexona oral combinado con intervención psicológica específica. Si se elige acamprosato, iniciar lo antes posible después de la retirada asistida; la guía usa 666 mg 3 veces/día, con reducción del total diario en personas <60 kg, y recomienda tratamiento generalmente hasta 6 meses o más si hay beneficio, suspendiendo si el consumo persiste 4-6 semanas tras el inicio.",
