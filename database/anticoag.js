...
;(function(){var db=window.ANTICOAG_DRUGS_DB;if(!db||!db["aas_antiagregante"])throw new Error("GOLD33_MISSING_CANONICAL:aas_antiagregante");db["aas_antiagregante"].mcGoldClinicalV1={
  ...
  "pt": {
    ...
    "commercialNames": "Aspirin 75 mg Gastro-Resistant Tablets (produto documentado no SmPC UK); existem outros produtos e marcas de ácido acetilsalicílico, cuja equivalência de apresentação não deve ser inferida automaticamente.",
    "presentation": "Comprimido gastro-resistente para administração oral, destinado a terapia antiagregante de baixa dose no produto consultado.",
    "presentations": "Produto consultado no Reino Unido: ácido acetilsalicílico 75 mg por comprimido gastro-resistente. Outras forças e formulações de aspirina existem, mas não são consideradas equivalentes neste preenchimento residual sem fonte específica.",
    ...
    "pharmacokinetics": "Após administração oral, o ácido acetilsalicílico é rapidamente absorvido no trato gastrointestinal, com hidrólise significativa para ácido salicílico já durante a absorção. Ácido acetilsalicílico e salicilato ligam-se extensamente a proteínas plasmáticas. O ASA é rapidamente metabolizado a salicilato (meia-vida ~15-30 min); em doses baixas, a meia-vida do salicilato é ~2-3 h. Salicilato e metabólitos são eliminados predominantemente pelos rins.",
    ...
    "pediatricDose": "Não existe esquema pediátrico antiagregante universal para este ID. O SmPC de 75 mg não recomenda uso rotineiro <16 anos devido, entre outros riscos, à síndrome de Reye, salvo indicação médica específica. Na doença de Kawasaki, diretrizes recomendam aspirina; para efeito antiagregante, baixa dose de 3-5 mg/kg/dia é usada e a duração depende do estado coronariano (por exemplo, 6 semanas quando não há envolvimento coronariano no acompanhamento). AUTOMATABLE=NO fora de um protocolo pediátrico específico por indicação.",
    ...
    "preparation": "Comprimido gastro-resistente oral pronto para uso; não requer reconstituição nem diluição. Para esta formulação, manter a integridade do revestimento e administrar por via oral conforme a bula do produto; não converter automaticamente para solução ou uso parenteral.",
    "infusionProtocol": "NÃO APLICÁVEL COMPROVADO ao escopo antiagregante oral de baixa dose avaliado: a fonte é comprimido gastro-resistente oral; não existe protocolo de infusão para esta apresentação.",
  ...
  "es": {
    ...
    "commercialNames": "Aspirin 75 mg Gastro-Resistant Tablets (producto documentado en el SmPC UK); existen otros productos y marcas de ácido acetilsalicílico, cuya equivalencia de presentación no debe inferirse automáticamente.",
    "presentation": "Comprimido gastro-resistente para administración oral, destinado a terapia antiagregante de baja dosis en el producto consultado.",
    "presentations": "Producto consultado en Reino Unido: ácido acetilsalicílico 75 mg por comprimido gastro-resistente. Existen otras concentraciones y formulaciones de aspirina, pero no se consideran equivalentes en este llenado residual sin fuente específica.",
    ...
    "pharmacokinetics": "Tras administración oral, el ácido acetilsalicílico se absorbe rápidamente en el tracto gastrointestinal, con hidrólisis significativa a ácido salicílico ya durante la absorción. Ácido acetilsalicílico y salicilato se unen extensamente a proteínas plasmáticas. El AAS se metaboliza rápidamente a salicilato (semivida ~15-30 min); a dosis bajas, la semivida del salicilato es ~2-3 h. Salicilato y metabolitos se eliminan predominantemente por riñón.",
    ...
    "pediatricDose": "No existe un esquema pediátrico antiagregante universal para este ID. El SmPC de 75 mg no recomienda uso rutinario <16 años debido, entre otros riesgos, al síndrome de Reye, salvo indicación médica específica. En enfermedad de Kawasaki, las guías recomiendan aspirina; para efecto antiagregante se usa dosis baja de 3-5 mg/kg/día y la duración depende del estado coronario (por ejemplo, 6 semanas cuando no hay afectación coronaria en el seguimiento). AUTOMATABLE=NO fuera de un protocolo pediátrico específico por indicación.",
    ...
    "preparation": "Comprimido gastro-resistente oral listo para usar; no requiere reconstitución ni dilución. Para esta formulación, mantener la integridad del recubrimiento y administrar por vía oral según el prospecto del producto; no convertir automáticamente a solución ni a uso parenteral.",
    "infusionProtocol": "NO APLICA, comprobado para el alcance antiagregante oral de baja dosis evaluado: la fuente es un comprimido gastro-resistente oral; no existe protocolo de infusión para esta presentación.",
...
/* GOLD33_SELECTIVE:enoxaparina:START */
;(function(){var db=window.ANTICOAG_DRUGS_DB;if(!db||!db["enoxaparina"])throw new Error("GOLD33_MISSING_CANONICAL:enoxaparina");db["enoxaparina"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "029",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Enoxaparina",
    "class": "Heparina de baixo peso molecular",
    "pharmacologicClass": "Potencializa antitrombina com atividade anti-Xa predominante",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Seringas SC pré-cheias e frascos multidose em várias concentrações.",
    "presentations": "Seringas SC pré-cheias e frascos multidose em várias concentrações.",
    "mechanism": "Potencializa antitrombina com atividade anti-Xa predominante. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Eliminação renal; atividade anti-Xa meia-vida ~4,5–7 h.",
    "indications": "Profilaxia/tratamento de TEV e síndromes coronarianas conforme cenário.",
    "dose": "Esquema depende da indicação: profilaxia comum 40 mg SC/dia; tratamento 1 mg/kg SC q12h ou 1,5 mg/kg/dia em selecionados. SCA e cirurgia têm protocolos próprios.",
    "pediatricDose": "Tratamento neonatal/pediátrico usa mg/kg por idade e monitorização anti-Xa especializada. AUTOMATABLE=NO.",
    "renalDose": "CrCl <30: profilaxia geralmente 30 mg SC/dia; tratamento 1 mg/kg SC/dia, conforme indicação/rótulo.",
    "hepaticDose": "Sem ajuste definido; cautela em coagulopatia.",
    "commonAdverseEffects": "Sangramento, anemia, hematoma no local e trombocitopenia.",
    "dangerousAdverseEffects": "Hemorragia fatal, HIT, hematoma espinal/epidural, necrose cutânea e hipercalemia.",
    "adverseEffects": "Sangramento, anemia, hematoma no local e trombocitopenia. Graves: Hemorragia fatal, HIT, hematoma espinal/epidural, necrose cutânea e hipercalemia.",
    "contraindications": "Sangramento maior ativo; trombocitopenia imune por heparina recente/anticorpos; hipersensibilidade.",
    "interactions": "Anticoagulantes, antiagregantes, AINEs e procedimentos neuroaxiais aumentam sangramento.",
    "monitoring": "Hemograma/plaquetas, creatinina, sangramento; anti-Xa em populações selecionadas; tempo neuroaxial.",
    "administration": "SC profunda no abdome; não expulsar bolha da seringa pré-cheia. IV apenas em protocolos específicos de IAM.",
    ...
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Hemorragia fatal, HIT, hematoma espinal/epidural, necrose cutânea e hipercalemia. Cálculo bloqueado sem indicação, peso, CrCl, idade, plaquetas/HIT, sangramento, gestação/prótese valvar e procedimento neuroaxial.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=enoxaparin",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2021/020164s129lbl.pdf"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=enoxaparin"
  },
  "es": {
    "name": "Enoxaparina",
    "class": "Heparina de bajo peso molecular",
    "pharmacologicClass": "Potencia antitrombina con actividad anti-Xa predominante",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Jeringas SC precargadas y viales multidosis en varias concentraciones.",
    "presentations": "Jeringas SC precargadas y viales multidosis en varias concentraciones.",
    "mechanism": "Potencia antitrombina con actividad anti-Xa predominante. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Eliminación renal; actividad anti-Xa semivida ~4,5–7 h.",
    "indications": "Profilaxis/tratamiento de TEV y síndromes coronarios según escenario.",
    "dose": "Pauta depende de indicación: profilaxis común 40 mg SC/día; tratamiento 1 mg/kg SC q12h o 1,5 mg/kg/día en seleccionados. SCA y cirugía tienen protocolos propios.",
    "pediatricDose": "Tratamiento neonatal/pediátrico usa mg/kg por edad y monitorización anti-Xa especializada. AUTOMATABLE=NO.",
    "renalDose": "CrCl <30: profilaxis generalmente 30 mg SC/día; tratamiento 1 mg/kg SC/día, según indicación/ficha.",
    "hepaticDose": "Sin ajuste definido; precaución en coagulopatía.",
    "commonAdverseEffects": "Sangrado, anemia, hematoma local y trombocitopenia.",
    "dangerousAdverseEffects": "Hemorragia fatal, HIT, hematoma espinal/epidural, necrosis cutánea e hiperpotasemia.",
    "adverseEffects": "Sangrado, anemia, hematoma local y trombocitopenia. Graves: Hemorragia fatal, HIT, hematoma espinal/epidural, necrosis cutánea e hiperpotasemia.",
    "contraindications": "Sangrado mayor activo; trombocitopenia inmune por heparina reciente/anticuerpos; hipersensibilidad.",
    "interactions": "Anticoagulantes, antiagregantes, AINE y procedimientos neuroaxiales aumentan sangrado.",
    "monitoring": "Hemograma/plaquetas, creatinina, sangrado; anti-Xa en poblaciones seleccionadas; tiempo neuroaxial.",
    "administration": "SC profunda en abdomen; no expulsar burbuja de jeringa precargada. IV solo en protocolos específicos de IAM.",
    ...
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Hemorragia fatal, HIT, hematoma espinal/epidural, necrosis cutánea e hiperpotasemia. Cálculo bloqueado sem indicação, peso, CrCl, idade, plaquetas/HIT, sangramento, gestação/prótese valvar e procedimento neuroaxial.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=enoxaparin",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2021/020164s129lbl.pdf"
    ],
...
/* GOLD33_SELECTIVE:heparina_hnf:START */
;(function(){var db=window.ANTICOAG_DRUGS_DB;if(!db||!db["heparina_hnf"])throw new Error("GOLD33_MISSING_CANONICAL:heparina_hnf");db["heparina_hnf"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "040",
    "requiredFieldCount": 33,
  ...
  "pt": {
    ...
    "pharmacologicClass": "Potencializa antitrombina e inibe IIa/Xa",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Injeção 1.000 a 20.000 UI/mL e bolsas prontas; confirmar produto.",
    "presentations": "Injeção 1.000 a 20.000 UI/mL e bolsas prontas; confirmar produto.",
    "mechanism": "Potencializa antitrombina e inibe IIa/Xa. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Não absorvida VO; efeito IV imediato; depuração saturável e renal.",
    "indications": "Profilaxia e tratamento de tromboembolismo; anticoagulação em cenários selecionados.",
    "dose": "Tratamento IV frequentemente bolus 80 UI/kg seguido 18 UI/kg/h, ajustado por aPTT ou anti-Xa; protocolos e indicações variam. Profilaxia 5.000 UI SC a cada 8-12 h.",
    "pediatricDose": "Protocolos por idade/peso e anti-Xa/aPTT; especialista. AUTOMATABLE=NO.",
    "renalDose": "Sem ajuste fixo, mas risco hemorrágico aumenta na DRC.",
    "hepaticDose": "Sem ajuste fixo; coagulopatia hepática eleva risco.",
    "commonAdverseEffects": "Sangramento, trombocitopenia e reação local.",
    "dangerousAdverseEffects": "Hemorragia fatal, HIT com trombose, hipercalemia e osteoporose prolongada.",
    "adverseEffects": "Sangramento, trombocitopenia e reação local. Graves: Hemorragia fatal, HIT com trombose, hipercalemia e osteoporose prolongada.",
    "contraindications": "Sangramento ativo importante; história de HIT; impossibilidade de monitorar em dose plena.",
    "interactions": "Antiagregantes, anticoagulantes, trombolíticos e AINE aumentam sangramento.",
    "monitoring": "Hemograma/plaquetas, aPTT ou anti-Xa, sangramento, K e HIT.",
    "administration": "IV contínua ou SC; nunca IM. Confirmar concentração por bolsa/seringa.",
    "preparation": "Diluir somente conforme produto/protocolo e usar bomba inteligente.",
    "infusionProtocol": "Titular por nomograma validado; protamina para reversão conforme dose recente.",
    "pregnancy": "Não atravessa placenta; anticoagulante preferido em cenários selecionados.",
    "lactation": "Compatível; não se espera passagem relevante ao leite.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    ...
    "alerts": "Hemorragia fatal, HIT com trombose, hipercalemia e osteoporose prolongada. Cálculo e bomba bloqueados sem indicação, peso, concentração, bolus, alvo aPTT/anti-Xa, plaquetas, sangramento e protocolo institucional.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=heparin+sodium+injection"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=heparin+sodium+injection"
  },
  "es": {
    "name": "Heparina no fraccionada",
    "class": "Anticoagulante",
    "pharmacologicClass": "Potencia antitrombina e inhibe IIa/Xa",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Inyección 1.000 a 20.000 UI/ml y bolsas listas; confirmar producto.",
    "presentations": "Inyección 1.000 a 20.000 UI/ml y bolsas listas; confirmar producto.",
    "mechanism": "Potencia antitrombina e inhibe IIa/Xa. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "No absorbida VO; efecto IV inmediato; depuración saturable y renal.",
    "indications": "Profilaxis y tratamiento de tromboembolismo; anticoagulación en escenarios seleccionados.",
    "dose": "Tratamiento IV frecuentemente bolo 80 UI/kg seguido 18 UI/kg/h, ajustado por aPTT o anti-Xa; protocolos e indicaciones varían. Profilaxis 5.000 UI SC cada 8-12 h.",
    "pediatricDose": "Protocolos por edad/peso y anti-Xa/aPTT; especialista. AUTOMATABLE=NO.",
    "renalDose": "Sin ajuste fijo, pero aumenta riesgo hemorrágico en ERC.",
    "hepaticDose": "Sin ajuste fijo; coagulopatía hepática aumenta riesgo.",
    "commonAdverseEffects": "Sangrado, trombocitopenia y reacción local.",
    "dangerousAdverseEffects": "Hemorragia fatal, HIT con trombosis, hiperpotasemia y osteoporosis prolongada.",
    "adverseEffects": "Sangrado, trombocitopenia y reacción local. Graves: Hemorragia fatal, HIT con trombosis, hiperpotasemia y osteoporosis prolongada.",
    "contraindications": "Sangrado activo importante; antecedente de HIT; imposibilidad de monitorizar dosis plena.",
    "interactions": "Antiagregantes, anticoagulantes, trombolíticos y AINE aumentan sangrado.",
    "monitoring": "Hemograma/plaquetas, aPTT o anti-Xa, sangrado, K y HIT.",
    "administration": "IV continua o SC; nunca IM. Confirmar concentración por bolsa/jeringa.",
    "preparation": "Diluir solo según producto/protocolo y usar bomba inteligente.",
    "infusionProtocol": "Titular por nomograma validado; protamina para reversión según dosis reciente.",
    "pregnancy": "No cruza placenta; anticoagulante preferido en escenarios seleccionados.",
    "lactation": "Compatible; no se espera paso relevante a leche.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    ...
    "alerts": "Hemorragia fatal, HIT con trombosis, hiperpotasemia y osteoporosis prolongada. Cálculo e bomba bloqueados sem indicação, peso, concentração, bolus, alvo aPTT/anti-Xa, plaquetas, sangramento e protocolo institucional.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=heparin+sodium+injection"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=heparin+sodium+injection"
...
/* GOLD33_SELECTIVE:varfarina:START */
;(function(){var db=window.ANTICOAG_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="varfarina";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:varfarina:"+matches.length);drug=matches[0];}else{drug=db&&db["varfarina"];if(!drug&&db){var keys=Object.keys(db).filter(function(key){return key.toLowerCase()==="varfarina";});if(keys.length>1)throw new Error("GOLD33_CANONICAL_CARDINALITY:varfarina:"+keys.length);if(keys.length===1)drug=db[keys[0]];}if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:varfarina");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "081",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Varfarina",
    "class": "Antagonista da vitamina K",
    "pharmacologicClass": "Antagonista da vitamina K",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Comprimidos em múltiplas forças com cores específicas.",
    "presentations": "Comprimidos em múltiplas forças com cores específicas.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância e exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo e eliminação na fonte primária.",
    "indications": "Prevenção e tratamento de tromboembolismo e indicações cardiovasculares selecionadas.",
    "dose": "Dose individualizada exclusivamente pelo INR, indicação e interações. Requer acompanhamento frequente, educação dietética e plano perioperatório; não usar dose fixa automatizada.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Sangramento, equimoses, náusea e alopecia.",
    "dangerousAdverseEffects": "Hemorragia fatal, necrose cutânea, síndrome do dedo roxo e toxicidade fetal.",
    "adverseEffects": "Sangramento, equimoses, náusea e alopecia.; Hemorragia fatal, necrose cutânea, síndrome do dedo roxo e toxicidade fetal.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade e riscos graves aplicáveis.",
    "administration": "Usar somente via e formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações e vias não são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação e jurisdição.",
    "safetyFlags": "Hemorragia fatal, necrose cutânea, síndrome do dedo roxo e toxicidade fetal.",
    "alerts": "Hemorragia fatal, necrose cutânea, síndrome do dedo roxo e toxicidade fetal.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=varfarina",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=varfarina"
  },
  "es": {
    "name": "Varfarina",
    "class": "Antagonista da vitamina K",
    "pharmacologicClass": "Antagonista da vitamina K",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Comprimidos em múltiplas forças con cores específicas.",
    "presentations": "Comprimidos em múltiplas forças con cores específicas.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Prevenção y tratamento de tromboembolismo y indicações cardiovasculares selecionadas.",
    "dose": "Dose individualizada exclusivamente pelo INR, indicação y interações. Requer acompanhamento frequente, educação dietética y plano perioperatório; no usar dosis fixa automatizada.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Sangramento, equimoses, náusea y alopecia.",
    "dangerousAdverseEffects": "Hemorragia fatal, necrose cutânea, síndrome do dedo roxo y toxicidade fetal.",
    "adverseEffects": "Sangramento, equimoses, náusea y alopecia.; Hemorragia fatal, necrose cutânea, síndrome do dedo roxo y toxicidade fetal.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade y riscos graves aplicáveis.",
    "administration": "Usar somente via y formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações y vias no são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação y jurisdição.",
    "safetyFlags": "Hemorragia fatal, necrose cutânea, síndrome do dedo roxo y toxicidade fetal.",
    "alerts": "Hemorragia fatal, necrose cutânea, síndrome do dedo roxo y toxicidade fetal.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=varfarina",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
...
/* GOLD33_SELECTIVE:varfarina:END */
