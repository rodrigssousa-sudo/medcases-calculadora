...
/* GOLD33_SELECTIVE:acido_folico:START */
;(function(){var db=window.HEMATOLOGIA_DRUGS_DB;if(!db||!db["acido_folico"])throw new Error("GOLD33_MISSING_CANONICAL:acido_folico");db["acido_folico"].mcGoldClinicalV1={
  "meta": {
  ...
  "pt": {
    "name": "Ácido fólico — escopo: prevenção periconcepcional de defeitos do tubo neural.",
    "class": "Vitamina hidrossolúvel B9.",
    "pharmacologicClass": "Precursor de coenzimas de folato envolvidas na síntese de nucleotídeos e metilação.",
    ...
    "presentation": "Suplemento oral; concentração e status regulatório variam por produto.",
    "presentations": "Suplemento oral; concentração e status regulatório variam por produto.",
    "mechanism": "Após conversão metabólica, participa de transferências de um carbono necessárias à síntese de DNA e ao desenvolvimento embrionário precoce.",
    "pharmacodynamics": "A suplementação periconcepcional reduz o risco de defeitos do tubo neural na população abrangida pela recomendação [3].",
    "pharmacokinetics": "Absorção oral e metabolismo dependem do produto e do estado de folato/B12; esta ficha não substitui investigação de anemia macrocítica.",
    "indications": "Pessoas que planejam ou podem engravidar, para prevenção de defeitos do tubo neural; outros usos terapêuticos exigem fonte/produto específico.",
    "dose": "USPSTF: 0,4–0,8 mg por via oral ao dia, iniciando pelo menos 1 mês antes da concepção e mantendo pelos primeiros 2–3 meses de gestação [3].",
    ...
    "renalDose": "Sem ajuste numérico documentado para esta recomendação preventiva; avaliar comorbidades e produto.",
    ...
    "commonAdverseEffects": "Geralmente bem tolerado nas doses preventivas; podem ocorrer desconforto gastrointestinal ou reação de hipersensibilidade rara.",
    "dangerousAdverseEffects": "Doses altas podem mascarar deficiência de vitamina B12 e retardar seu diagnóstico; não tratar anemia sem avaliação etiológica.",
    "adverseEffects": "Geralmente bem tolerado nas doses preventivas; podem ocorrer desconforto gastrointestinal ou reação de hipersensibilidade rara. Doses altas podem mascarar deficiência de vitamina B12 e retardar seu diagnóstico; não tratar anemia sem avaliação etiológica. Avaliar temporalidade, produto e dose; notificar suspeitas relevantes conforme a farmacovigilância local.",
    "contraindications": "Hipersensibilidade ao produto. Investigar deficiência de B12 antes de tratar anemia megaloblástica somente com folato.",
    "interactions": "Antifolatos e alguns anticonvulsivantes podem modificar o manejo; confirmar interação para o medicamento e a indicação reais.",
    "monitoring": "Adesão antes da concepção; em anemia, hemograma, folato e B12 conforme avaliação clínica.",
    "administration": "Via oral diária. Não usar esta recomendação para definir tratamento de alto risco sem protocolo especializado.",
    ...
    "pregnancy": "A recomendação é dirigida ao período periconcepcional; grupos de alto risco, história de DTN ou uso de certos antiepilépticos estão fora de seu escopo [3].",
    "lactation": "A recomendação consultada não define regime de lactação; usar orientação nutricional/obstétrica aplicável.",
    "specialPopulations": "Não extrapolar 0,4–0,8 mg/dia para pessoas com gravidez prévia afetada por DTN, malabsorção ou medicamentos que interferem no folato.",
    ...
    "safetyFlags": "Uso sujeito a revisão de indicação, comorbidades, interações e produto local.",
    "alerts": "ALERTA: não automatizar sem validação clínica e sem confirmação da formulação local.",
    "references": [
      "[3] USPSTF — Folic Acid Supplementation to Prevent Neural Tube Defects — Prevenção periconcepcional de defeitos do tubo neural."
    ],
    "ref": "https://www.uspreventiveservicestaskforce.org/uspstf/recommendation/folic-acid-for-the-prevention-of-neural-tube-defects-preventive-medication"
  },
  "es": {
    "name": "Ácido fólico — alcance: prevención periconcepcional de defectos del tubo neural.",
    "class": "Vitamina hidrosoluble B9.",
    "pharmacologicClass": "Precursor de coenzimas de folato implicadas en síntesis de nucleótidos y metilación.",
    ...
    "presentation": "Suplemento oral; concentración y estatus regulatorio varían por producto.",
    "presentations": "Suplemento oral; concentración y estatus regulatorio varían por producto.",
    "mechanism": "Tras conversión metabólica, participa en transferencias de un carbono necesarias para síntesis de ADN y desarrollo embrionario precoz.",
    "pharmacodynamics": "La suplementación periconcepcional reduce el riesgo de defectos del tubo neural en la población cubierta por la recomendación [3].",
    "pharmacokinetics": "La absorción oral y el metabolismo dependen del producto y del estado de folato/B12; esta ficha no sustituye la investigación de anemia macrocítica.",
    "indications": "Personas que planean o podrían quedar embarazadas, para prevención de defectos del tubo neural; otros usos terapéuticos requieren fuente/producto específico.",
    "dose": "USPSTF: 0,4–0,8 mg por vía oral al día, iniciando al menos 1 mes antes de la concepción y manteniendo durante los primeros 2–3 meses de gestación [3].",
    ...
    "renalDose": "Sin ajuste numérico documentado para esta recomendación preventiva; evaluar comorbilidades y producto.",
    ...
    "commonAdverseEffects": "Generalmente bien tolerado en dosis preventivas; puede ocurrir malestar gastrointestinal o reacción de hipersensibilidad rara.",
    "dangerousAdverseEffects": "Dosis altas pueden enmascarar déficit de vitamina B12 y retrasar su diagnóstico; no tratar anemia sin evaluación etiológica.",
    "adverseEffects": "Generalmente bien tolerado en dosis preventivas; puede ocurrir malestar gastrointestinal o reacción de hipersensibilidad rara. Dosis altas pueden enmascarar déficit de vitamina B12 y retrasar su diagnóstico; no tratar anemia sin evaluación etiológica. Evaluar temporalidad, producto y dosis; notificar sospechas relevantes según la farmacovigilancia local.",
    "contraindications": "Hipersensibilidad al producto. Investigar déficit de B12 antes de tratar anemia megaloblástica solo con folato.",
    "interactions": "Antifolatos y algunos anticonvulsivantes pueden modificar el manejo; confirmar la interacción para el medicamento y la indicación reales.",
    "monitoring": "Adherencia antes de la concepción; en anemia, hemograma, folato y B12 según evaluación clínica.",
    "administration": "Vía oral diaria. No usar esta recomendación para definir tratamiento de alto riesgo sin protocolo especializado.",
    ...
    "pregnancy": "La recomendación se dirige al período periconcepcional; grupos de alto riesgo, antecedente de DTN o uso de ciertos antiepilépticos quedan fuera de su alcance [3].",
    "lactation": "La recomendación consultada no define un esquema de lactancia; usar orientación nutricional/obstétrica aplicable.",
    "specialPopulations": "No extrapolar 0,4–0,8 mg/día a personas con embarazo previo afectado por DTN, malabsorción o medicamentos que interfieren con el folato.",
    ...
    "safetyFlags": "Uso sujeto a revisión de indicación, comorbilidades, interacciones y producto local.",
    "alerts": "ALERTA: no automatizar sin validación clínica y sin confirmación de la formulación local.",
    "references": [
      "[3] USPSTF — Folic Acid Supplementation to Prevent Neural Tube Defects — Prevenção periconcepcional de defeitos do tubo neural."
    ],
    "ref": "https://www.uspreventiveservicestaskforce.org/uspstf/recommendation/folic-acid-for-the-prevention-of-neural-tube-defects-preventive-medication"
...
/* GOLD33_SELECTIVE:acido_folico:END */
/* GOLD33_SELECTIVE:acido_tranexamico:START */
;(function(){var db=window.HEMATOLOGIA_DRUGS_DB;if(!db||!db["acido_tranexamico"])throw new Error("GOLD33_MISSING_CANONICAL:acido_tranexamico");db["acido_tranexamico"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "002",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Ácido tranexâmico — CYKLOKAPRON injetável IV.",
    "class": "Antifibrinolítico.",
    "pharmacologicClass": "Análogo sintético da lisina; inibidor de fibrinólise.",
    "commercialNames": "Nomes comerciais variam por jurisdição; a marca não substitui a confirmação de princípio ativo, sal e concentração.",
    "presentation": "Solução injetável IV 100 mg/mL [6].",
    "presentations": "Solução injetável IV 100 mg/mL [6].",
    "mechanism": "Liga-se a sítios de lisina do plasminogênio e reduz ativação/ligação à fibrina [6].",
    "pharmacodynamics": "Reduz fibrinólise; não substitui terapia da causa do sangramento [6].",
    "pharmacokinetics": "Eliminação predominantemente renal como fármaco inalterado; reduzir na IR moderada/grave [6].",
    "indications": "Curto prazo (2–8 dias) em hemofilia para extração dentária, segundo rótulo [6].",
    "dose": "10 mg/kg IV antes da extração; depois 10 mg/kg IV 3–4 vezes/dia por 2–8 dias. Regime exclusivo do rótulo [6].",
    "pediatricDose": "Evidência pediátrica apenas em hemofilia/extração dentária; não automatizar outros usos [6].",
    "renalDose": "10 mg/kg IV 2x/dia com creatinina 1,36–2,83 mg/dL; 1x/dia com 2,83–5,66; a cada 48 h ou 5 mg/kg/dia se >5,66 [6].",
    "hepaticDose": "A fonte selecionada não fornece ajuste hepático numérico universal; avaliar gravidade, produto e indicação antes de prescrever.",
    "commonAdverseEffects": "Náusea, vômito, diarreia, dermatite alérgica, tontura e hipotensão [6].",
    "dangerousAdverseEffects": "Trombose, convulsões, alteração visual e hipersensibilidade grave [6].",
    "adverseEffects": "Náusea, vômito, diarreia, dermatite alérgica, tontura e hipotensão [6]. Trombose, convulsões, alteração visual e hipersensibilidade grave [6]. Avaliar temporalidade, produto e dose; notificar suspeitas relevantes conforme a farmacovigilância local.",
    "contraindications": "Hemorragia subaracnoide, hipersensibilidade e coagulação intravascular ativa [6].",
    "interactions": "Evitar produtos pró-trombóticos concomitantes, salvo decisão especializada [6].",
    "monitoring": "Função renal, trombose, visão, sintomas neurológicos e hemostasia de base.",
    "administration": "Somente IV; nunca neuraxial, risco de convulsões/arritmias fatais [6].",
    "preparation": "Pode ser não diluído ou diluído; técnica asséptica e inspeção da solução [6].",
    "infusionProtocol": "Não há protocolo universal nesta ficha; infusão automática bloqueada.",
    "pregnancy": "Dados insuficientes para definir risco; decisão depende de gravidade/alternativas [6].",
    "lactation": "Passa ao leite em baixa concentração no rótulo; ponderar benefício/risco [6].",
    "specialPopulations": "Idosos: atenção à função renal. Não autoriza uso fora do produto/indicação.",
    "patientEducation": "Não iniciar, interromper ou ajustar por conta própria; levar lista de medicamentos e comunicar sinais de toxicidade ou alergia. Não automatizar cálculo, dose pediátrica, ajuste renal ou infusão nesta versão candidata; a ficha é educativa e requer validação clínica e vinculação ao produto local.",
    "clinicalPearls": "A indicação e a formulação definem a segurança do uso; esta ficha não autoriza intercâmbio automático entre produtos.",
    "guidelineRecommendations": "Seguir bula e diretriz aplicáveis ao cenário; quando houver lacuna, encaminhar para revisão clínica.",
    "safetyFlags": "VIA IV EXCLUSIVA; nunca neuraxial; risco trombótico/convulsões.",
    "alerts": "ALERTA: confirmar ID, concentração, via IV e função renal.",
    "references": [
      "[6] Pfizer — CYKLOKAPRON Injection, revised 08/2025 — Injeção IV 100 mg/mL; bula EUA."
    ],
    "ref": "https://labeling.pfizer.com/showlabeling.aspx?id=556"
  },
  "es": {
    "name": "Ácido tranexámico — CYKLOKAPRON inyectable IV.",
    "class": "Antifibrinolítico.",
    "pharmacologicClass": "Análogo sintético de la lisina; inhibidor de fibrinólisis.",
    "commercialNames": "Los nombres comerciales varían por jurisdicción; la marca no sustituye la confirmación de principio activo, sal y concentración.",
    "presentation": "Solución inyectable IV 100 mg/mL [6].",
    "presentations": "Solución inyectable IV 100 mg/mL [6].",
    "mechanism": "Se une a sitios de lisina del plasminógeno y reduce activación/unión a fibrina [6].",
    "pharmacodynamics": "Reduce la fibrinólisis; no sustituye la terapia de la causa del sangrado [6].",
    "pharmacokinetics": "Eliminación predominantemente renal como fármaco inalterado; reducir en IR moderada/grave [6].",
    "indications": "Corto plazo (2–8 días) en hemofilia para extracción dental, según prospecto [6].",
    "dose": "10 mg/kg IV antes de la extracción; luego 10 mg/kg IV 3–4 veces/día por 2–8 días. Régimen exclusivo del prospecto [6].",
    "pediatricDose": "Evidencia pediátrica solo en hemofilia/extracción dental; no automatizar otros usos [6].",
    "renalDose": "10 mg/kg IV 2 veces/día con creatinina 1,36–2,83 mg/dL; 1 vez/día con 2,83–5,66; cada 48 h o 5 mg/kg/día si >5,66 [6].",
    "hepaticDose": "La fuente seleccionada no proporciona un ajuste hepático numérico universal; evaluar gravedad, producto e indicación antes de prescribir.",
    "commonAdverseEffects": "Náuseas, vómitos, diarrea, dermatitis alérgica, mareo e hipotensión [6].",
    "dangerousAdverseEffects": "Trombosis, convulsiones, alteración visual e hipersensibilidad grave [6].",
    "adverseEffects": "Náuseas, vómitos, diarrea, dermatitis alérgica, mareo e hipotensión [6]. Trombosis, convulsiones, alteración visual e hipersensibilidad grave [6]. Evaluar temporalidad, producto y dosis; notificar sospechas relevantes según la farmacovigilancia local.",
    "contraindications": "Hemorragia subaracnoidea, hipersensibilidad y coagulación intravascular activa [6].",
    "interactions": "Evitar productos protrombóticos concomitantes, salvo decisión especializada [6].",
    "monitoring": "Función renal, trombosis, visión, síntomas neurológicos y hemostasia de base.",
    "administration": "Solo IV; nunca neuroaxial, riesgo de convulsiones/arritmias fatales [6].",
    "preparation": "Puede ser sin diluir o diluido; técnica aséptica e inspección de solución [6].",
    "infusionProtocol": "No hay protocolo universal en esta ficha; infusión automática bloqueada.",
    "pregnancy": "Datos insuficientes para definir riesgo; la decisión depende de gravedad/alternativas [6].",
    "lactation": "Pasa a la leche en baja concentración en el prospecto; ponderar beneficio/riesgo [6].",
    "specialPopulations": "Mayores: atención a función renal. No autoriza uso fuera de producto/indicación.",
    "patientEducation": "No iniciar, suspender ni ajustar por cuenta propia; llevar la lista de medicamentos y comunicar signos de toxicidad o alergia. No automatizar cálculo, dosis pediátrica, ajuste renal ni infusión en esta versión candidata; la ficha es educativa y requiere validación clínica y vinculación al producto local.",
    "clinicalPearls": "La indicación y la formulación definen la seguridad del uso; esta ficha no autoriza intercambio automático entre productos.",
    "guidelineRecommendations": "Seguir el prospecto y la guía aplicables al escenario; cuando haya una laguna, derivar a revisión clínica.",
    "safetyFlags": "VÍA IV EXCLUSIVA; nunca neuroaxial; riesgo trombótico/convulsiones.",
    "alerts": "ALERTA: confirmar ID, concentración, vía IV y función renal.",
    "references": [
      "[6] Pfizer — CYKLOKAPRON Injection, revised 08/2025 — Injeção IV 100 mg/mL; bula EUA."
    ],
    "ref": "https://labeling.pfizer.com/showlabeling.aspx?id=556"
...
/* GOLD33_SELECTIVE:acido_tranexamico:END */
/* GOLD33_SELECTIVE:eltrombopague:START */
;(function(){var db=window.HEMATOLOGIA_DRUGS_DB;if(!db||!db["eltrombopague"])throw new Error("GOLD33_MISSING_CANONICAL:eltrombopague");db["eltrombopague"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "029",
    "requiredFieldCount": 33,
  ...
  "pt": {
    ...
    "pharmacologicClass": "Ativa c-Mpl e estimula megacariócitos/plaquetas",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Comprimidos 12,5/25/50/75 mg; pó para suspensão 12,5/25 mg.",
    "presentations": "Comprimidos 12,5/25/50/75 mg; pó para suspensão 12,5/25 mg.",
    "mechanism": "Ativa c-Mpl e estimula megacariócitos/plaquetas. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Metabolismo hepático; meia-vida 21–32 h.",
    "indications": "Trombocitopenia imune persistente/crônica, anemia aplásica grave e indicações específicas conforme rótulo.",
    "dose": "PTI: usual 50 mg VO/dia; 25 mg em hepatopatia ou algumas ancestralidades asiáticas. Titular pela plaqueta; máximo 75 mg/dia. Anemia aplásica usa esquemas próprios.",
    "pediatricDose": "PTI ≥1 ano: dose por idade/ancestralidade, titulada; AUTOMATABLE=NO.",
    "renalDose": "Sem ajuste usual; monitorar.",
    "hepaticDose": "Reduzir dose inicial e monitorar estreitamente; risco de descompensação/trombose portal.",
    "commonAdverseEffects": "Náusea, diarreia, cefaleia, mialgia e aumento de transaminases.",
    "dangerousAdverseEffects": "Hepatotoxicidade, tromboembolismo, fibrose medular e progressão clonal/MDS em contexto inadequado.",
    "adverseEffects": "Náusea, diarreia, cefaleia, mialgia e aumento de transaminases. Graves: Hepatotoxicidade, tromboembolismo, fibrose medular e progressão clonal/MDS em contexto inadequado.",
    "contraindications": "Hipersensibilidade; contraindicações específicas variam, com alertas hepáticos importantes.",
    "interactions": "Cátions reduzem absorção; OATP/BCRP, estatinas e interferon/ribavirina.",
    "monitoring": "Hemograma/plaquetas, fígado, catarata, trombose e medula conforme indicação.",
    "administration": "Em jejum ou refeição pobre em cálcio; separar 2 h antes ou 4 h após cátions/laticínios.",
    ...
    "alerts": "Hepatotoxicidade, tromboembolismo, fibrose medular e progressão clonal/MDS em contexto inadequado. Dose/titulação bloqueadas sem indicação, idade/ancestralidade, plaquetas seriadas, fígado, trombose, cátions e terapia concomitante.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=eltrombopag",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2021/022291s030lbl.pdf"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=eltrombopag"
  },
  "es": {
    "name": "Eltrombopag",
    "class": "Agonista del receptor de trombopoyetina",
    "pharmacologicClass": "Activa c-Mpl y estimula megacariocitos/plaquetas",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Comprimidos 12,5/25/50/75 mg; polvo para suspensión 12,5/25 mg.",
    "presentations": "Comprimidos 12,5/25/50/75 mg; polvo para suspensión 12,5/25 mg.",
    "mechanism": "Activa c-Mpl y estimula megacariocitos/plaquetas. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Metabolismo hepático; semivida 21–32 h.",
    "indications": "Trombocitopenia inmune persistente/crónica, anemia aplásica grave e indicaciones específicas según ficha.",
    "dose": "PTI: habitual 50 mg VO/día; 25 mg en hepatopatía o algunas ascendencias asiáticas. Titular por plaquetas; máximo 75 mg/día. Anemia aplásica usa pautas propias.",
    "pediatricDose": "PTI ≥1 año: dosis por edad/ascendencia, titulada; AUTOMATABLE=NO.",
    "renalDose": "Sin ajuste habitual; vigilar.",
    "hepaticDose": "Reducir dosis inicial y vigilar estrechamente; riesgo de descompensación/trombosis portal.",
    "commonAdverseEffects": "Náusea, diarrea, cefalea, mialgia y aumento de transaminasas.",
    "dangerousAdverseEffects": "Hepatotoxicidad, tromboembolismo, fibrosis medular y progresión clonal/SMD en contexto inadecuado.",
    "adverseEffects": "Náusea, diarrea, cefalea, mialgia y aumento de transaminasas. Graves: Hepatotoxicidad, tromboembolismo, fibrosis medular y progresión clonal/SMD en contexto inadecuado.",
    "contraindications": "Hipersensibilidad; contraindicaciones específicas varían, con alertas hepáticas importantes.",
    "interactions": "Cationes reducen absorción; OATP/BCRP, estatinas e interferón/ribavirina.",
    "monitoring": "Hemograma/plaquetas, hígado, catarata, trombosis y médula según indicación.",
    "administration": "En ayunas o comida baja en calcio; separar 2 h antes o 4 h después de cationes/lácteos.",
    ...
    "alerts": "Hepatotoxicidad, tromboembolismo, fibrosis medular y progresión clonal/SMD en contexto inadecuado. Dose/titulação bloqueadas sem indicação, idade/ancestralidade, plaquetas seriadas, fígado, trombose, cátions e terapia concomitante.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=eltrombopag",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2021/022291s030lbl.pdf"
    ],
...
/* GOLD33_SELECTIVE:eltrombopague:END */
/* GOLD33_SELECTIVE:emicizumabe:START */
;(function(){var db=window.HEMATOLOGIA_DRUGS_DB;if(!db||!db["emicizumabe"])throw new Error("GOLD33_MISSING_CANONICAL:emicizumabe");db["emicizumabe"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "029",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Emicizumabe",
    "class": "Anticorpo biespecífico mimético do FVIII",
    "pharmacologicClass": "Aproxima FIXa e FX, restaurando função do FVIII",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Frascos SC 30/60/105/150 mg em concentrações diferentes.",
    "presentations": "Frascos SC 30/60/105/150 mg em concentrações diferentes.",
    "mechanism": "Aproxima FIXa e FX, restaurando função do FVIII. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Catabolismo proteico; meia-vida ~27 dias.",
    "indications": "Profilaxia de sangramento na hemofilia A congênita com ou sem inibidor de FVIII, todas as idades.",
    "dose": "Carga 3 mg/kg SC semanal por 4 semanas; manutenção 1,5 mg/kg semanal, 3 mg/kg a cada 2 semanas ou 6 mg/kg a cada 4 semanas.",
    "pediatricDose": "Mesmo esquema por peso, inclusive recém-nascidos; cálculo especializado. AUTOMATABLE=NO.",
    "renalDose": "Sem ajuste definido.",
    "hepaticDose": "Sem ajuste definido.",
    "commonAdverseEffects": "Reação local, cefaleia e artralgia.",
    "dangerousAdverseEffects": "Microangiopatia trombótica, trombose e hipersensibilidade.",
    "adverseEffects": "Reação local, cefaleia e artralgia. Graves: Microangiopatia trombótica, trombose e hipersensibilidade.",
    "contraindications": "Hipersensibilidade.",
    "interactions": "aPCC em altas doses/duração aumenta microangiopatia trombótica e trombose; interfere em testes intrínsecos como aPTT.",
    "monitoring": "Sangramentos, trombose/TMA, anticorpos e exames com métodos não interferidos.",
    "administration": "SC apenas; não combinar frascos de concentrações diferentes na mesma seringa.",
    "preparation": "Confirmar produto, força e apresentação; seguir rótulo oficial.",
    "infusionProtocol": "Não aplicável salvo apresentação parenteral; seguir protocolo do produto.",
    "pregnancy": "Usar somente após avaliação individual de benefício-risco e rotulagem específica.",
    "lactation": "Avaliar exposição do lactente, benefício materno e alternativas.",
    ...
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Microangiopatia trombótica, trombose e hipersensibilidade. Cálculo/profilaxia bloqueados sem peso, inibidor, plano de bypass, concentrações disponíveis e laboratório treinado para interferências.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=emicizumab",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2023/761083s020lbl.pdf"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=emicizumab"
  },
  "es": {
    "name": "Emicizumab",
    "class": "Anticuerpo biespecífico mimético de FVIII",
    "pharmacologicClass": "Aproxima FIXa y FX, restaurando función de FVIII",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Viales SC 30/60/105/150 mg en concentraciones diferentes.",
    "presentations": "Viales SC 30/60/105/150 mg en concentraciones diferentes.",
    "mechanism": "Aproxima FIXa y FX, restaurando función de FVIII. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Catabolismo proteico; semivida ~27 días.",
    "indications": "Profilaxis de sangrado en hemofilia A congénita con o sin inhibidor de FVIII, todas las edades.",
    "dose": "Carga 3 mg/kg SC semanal por 4 semanas; mantenimiento 1,5 mg/kg semanal, 3 mg/kg cada 2 semanas o 6 mg/kg cada 4 semanas.",
    "pediatricDose": "Misma pauta por peso, incluidos recién nacidos; cálculo especializado. AUTOMATABLE=NO.",
    "renalDose": "Sin ajuste definido.",
    "hepaticDose": "Sin ajuste definido.",
    "commonAdverseEffects": "Reacción local, cefalea y artralgia.",
    "dangerousAdverseEffects": "Microangiopatía trombótica, trombosis e hipersensibilidad.",
    "adverseEffects": "Reacción local, cefalea y artralgia. Graves: Microangiopatía trombótica, trombosis e hipersensibilidad.",
    "contraindications": "Hipersensibilidad.",
    "interactions": "CCPa en altas dosis/duración aumenta microangiopatía trombótica y trombosis; interfiere en pruebas intrínsecas como TTPa.",
    "monitoring": "Sangrados, trombosis/MAT, anticuerpos y pruebas con métodos no interferidos.",
    "administration": "Solo SC; no combinar viales de concentraciones diferentes en misma jeringa.",
    "preparation": "Confirmar producto, dosis y presentación; seguir ficha oficial.",
    "infusionProtocol": "No aplicable salvo presentación parenteral; seguir protocolo del producto.",
    "pregnancy": "Usar solo tras evaluación individual de beneficio-riesgo y ficha específica.",
    "lactation": "Evaluar exposición del lactante, beneficio materno y alternativas.",
    ...
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Microangiopatía trombótica, trombosis e hipersensibilidad. Cálculo/profilaxia bloqueados sem peso, inibidor, plano de bypass, concentrações disponíveis e laboratório treinado para interferências.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=emicizumab",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2023/761083s020lbl.pdf"
    ],
...
/* GOLD33_SELECTIVE:filgrastim:START */
;(function(){var db=window.HEMATOLOGIA_DRUGS_DB;if(!db||!db["filgrastim"])throw new Error("GOLD33_MISSING_CANONICAL:filgrastim");db["filgrastim"].mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "035",
    "requiredFieldCount": 33,
  ...
  "pt": {
    "name": "Filgrastim",
    "class": "Fator estimulador de colônias de granulócitos",
    "pharmacologicClass": "G-CSF recombinante",
    "commercialNames": "Não presumir marca regional; usar somente produto correspondente às fontes regulatórias citadas.",
    "presentation": "Frascos/seringas 300 microgramas/mL e 480 microgramas/1,6 mL, com variações entre produtos.",
    "presentations": "Frascos/seringas 300 microgramas/mL e 480 microgramas/1,6 mL, com variações entre produtos.",
    "mechanism": "G-CSF recombinante. O efeito deve ser interpretado por indicação, formulação e exposição.",
    "pharmacodynamics": "Resposta e toxicidade dependem da exposição e população; consultar dose e monitorização.",
    "pharmacokinetics": "Depuração renal e mediada por neutrófilos; cinética dependente da dose.",
    "indications": "Redução de neutropenia em quimioterapia, transplante, mobilização, neutropenia crônica grave e exposição mielossupressora conforme produto.",
    "dose": "Quimioterapia: 5 microgramas/kg/dia SC ou IV, iniciar ≥24 h após quimioterapia; outros cenários têm regimes próprios.",
    "pediatricDose": "Dose por kg conforme indicação, inclusive neonatos em contextos especializados. AUTOMATABLE=NO.",
    "renalDose": "Sem ajuste fixo.",
    "hepaticDose": "Sem ajuste fixo.",
    "commonAdverseEffects": "Dor óssea, dor musculoesquelética, cefaleia e reação local.",
    "dangerousAdverseEffects": "Ruptura esplênica, SDRA, anafilaxia, síndrome de extravasamento capilar, aortite e crise falciforme.",
    "adverseEffects": "Dor óssea, dor musculoesquelética, cefaleia e reação local. Graves: Ruptura esplênica, SDRA, anafilaxia, síndrome de extravasamento capilar, aortite e crise falciforme.",
    "contraindications": "Hipersensibilidade grave ao filgrastim/pegfilgrastim ou proteínas de E. coli.",
    "interactions": "Lítio pode potencializar neutrófilos; cautela com quimioterapia e radioterapia concomitantes.",
    "monitoring": "Hemograma/ANC, plaquetas, baço, sintomas pulmonares, aorta, urina e resposta.",
    "administration": "SC ou IV; não administrar nas 24 h antes/depois de quimioterapia citotóxica.",
    "preparation": "Diluição IV depende do produto/concentração; evitar adsorção e seguir bula.",
    "infusionProtocol": "Infusão IV curta ou contínua conforme indicação e produto.",
    "pregnancy": "Dados limitados; usar se benefício justificar.",
    "lactation": "Dados insuficientes; avaliar necessidade.",
    "specialPopulations": "Ver pediatria, função renal/hepática, gestação, lactação e idosos; individualizar fragilidade e polifarmácia.",
    "patientEducation": "Explicar indicação, administração, adesão e sinais de alarme; não alterar dose sem orientação.",
    "clinicalPearls": "Confirmar produto, concentração, via, indicação, peso e função orgânica antes de calcular ou administrar.",
    "guidelineRecommendations": "Conteúdo ancorado em bula regulatória primária; protocolo local e microbiologia podem restringir uso.",
    "safetyFlags": "CANDIDATO NÃO HOMOLOGADO. Revisão médica obrigatória antes de integração.",
    "alerts": "Ruptura esplênica, SDRA, anafilaxia, síndrome de extravasamento capilar, aortite e crise falciforme. Cálculo e duração bloqueados sem indicação, peso, ANC/hemograma, cronograma de quimioterapia, produto/concentração e risco esplênico/pulmonar.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=filgrastim",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2022/125553s031lbl.pdf"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=filgrastim"
  },
  "es": {
    "name": "Filgrastim",
    "class": "Factor estimulante de colonias de granulocitos",
    "pharmacologicClass": "G-CSF recombinante",
    "commercialNames": "No presumir marca regional; usar solo producto correspondiente a fuentes regulatorias citadas.",
    "presentation": "Viales/jeringas 300 microgramos/mL y 480 microgramos/1,6 mL, con variaciones entre productos.",
    "presentations": "Viales/jeringas 300 microgramos/mL y 480 microgramos/1,6 mL, con variaciones entre productos.",
    "mechanism": "G-CSF recombinante. El efecto debe interpretarse por indicación, formulación y exposición.",
    "pharmacodynamics": "Respuesta y toxicidad dependen de exposición y población; consultar dosis y monitorización.",
    "pharmacokinetics": "Depuración renal y mediada por neutrófilos; cinética dependiente de dosis.",
    "indications": "Reducción de neutropenia en quimioterapia, trasplante, movilización, neutropenia crónica grave y exposición mielosupresora según producto.",
    "dose": "Quimioterapia: 5 microgramos/kg/día SC o IV, iniciar ≥24 h después de quimioterapia; otros escenarios tienen pautas propias.",
    "pediatricDose": "Dosis por kg según indicación, incluidos neonatos en contextos especializados. AUTOMATABLE=NO.",
    "renalDose": "Sin ajuste fijo.",
    "hepaticDose": "Sin ajuste fijo.",
    "commonAdverseEffects": "Dolor óseo, dolor musculoesquelético, cefalea y reacción local.",
    "dangerousAdverseEffects": "Rotura esplénica, SDRA, anafilaxia, síndrome de fuga capilar, aortitis y crisis falciforme.",
    "adverseEffects": "Dolor óseo, dolor musculoesquelético, cefalea y reacción local. Graves: Rotura esplénica, SDRA, anafilaxia, síndrome de fuga capilar, aortitis y crisis falciforme.",
    "contraindications": "Hipersensibilidad grave a filgrastim/pegfilgrastim o proteínas de E. coli.",
    "interactions": "Litio puede potenciar neutrófilos; precaución con quimioterapia y radioterapia concomitantes.",
    "monitoring": "Hemograma/ANC, plaquetas, bazo, síntomas pulmonares, aorta, orina y respuesta.",
    "administration": "SC o IV; no administrar en las 24 h antes/después de quimioterapia citotóxica.",
    "preparation": "Dilución IV depende de producto/concentración; evitar adsorción y seguir ficha.",
    "infusionProtocol": "Infusión IV corta o continua según indicación y producto.",
    "pregnancy": "Datos limitados; usar si beneficio justifica.",
    "lactation": "Datos insuficientes; evaluar necesidad.",
    "specialPopulations": "Ver pediatría, función renal/hepática, embarazo, lactancia y ancianos; individualizar fragilidad y polifarmacia.",
    "patientEducation": "Explicar indicación, administración, adherencia y signos de alarma; no cambiar dosis sin indicación.",
    "clinicalPearls": "Confirmar producto, concentración, vía, indicación, peso y función orgánica antes de calcular o administrar.",
    "guidelineRecommendations": "Contenido basado en ficha regulatoria primaria; protocolo local y microbiología pueden restringir uso.",
    "safetyFlags": "CANDIDATO NO HOMOLOGADO. Revisión médica obligatoria antes de integración.",
    "alerts": "Rotura esplénica, SDRA, anafilaxia, síndrome de fuga capilar, aortitis y crisis falciforme. Cálculo e duração bloqueados sem indicação, peso, ANC/hemograma, cronograma de quimioterapia, produto/concentração e risco esplênico/pulmonar.",
    "references": [
      "1. Fonte regulatória primária consultada em 2026-09-18: https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=filgrastim",
      "2. Fonte regulatória primária consultada em 2026-09-18: https://www.accessdata.fda.gov/drugsatfda_docs/label/2022/125553s031lbl.pdf"
    ],
...
/* GOLD33_SELECTIVE:vitamina_k:START */
;(function(){var db=window.HEMATOLOGIA_DRUGS_DB,drug;if(Array.isArray(db)){var matches=db.filter(function(item){return item&&item.id==="vitamina_k";});if(matches.length!==1)throw new Error("GOLD33_CANONICAL_CARDINALITY:vitamina_k:"+matches.length);drug=matches[0];}else{drug=db&&db["vitamina_k"];if(!drug&&db){var keys=Object.keys(db).filter(function(key){return key.toLowerCase()==="vitamina_k";});if(keys.length>1)throw new Error("GOLD33_CANONICAL_CARDINALITY:vitamina_k:"+keys.length);if(keys.length===1)drug=db[keys[0]];}if(!drug)throw new Error("GOLD33_MISSING_CANONICAL:vitamina_k");}drug.mcGoldClinicalV1={
  "meta": {
    "schema": "mc-gold-clinical-v1",
    "lote": "083",
    "requiredFieldCount": 33,
  ...
  "pt": {
    ...
    "class": "Vitamina lipossolúvel necessária à síntese de fatores de coagulação",
    "pharmacologicClass": "Vitamina lipossolúvel necessária à síntese de fatores de coagulação",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Comprimidos, gotas e solução injetável em diferentes concentrações.",
    "presentations": "Comprimidos, gotas e solução injetável em diferentes concentrações.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância e exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo e eliminação na fonte primária.",
    "indications": "Prevenção ou tratamento da deficiência de vitamina K e reversão de antagonistas da vitamina K conforme urgência.",
    "dose": "Via e dose dependem da causa, INR, sangramento e urgência. Reversão grave exige protocolo com concentrado de fatores; administração IV lenta pelo risco de reação.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação e formulação.",
    "renalDose": "Não inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "Não inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Dor no local, rubor e alteração do paladar.",
    "dangerousAdverseEffects": "Anafilaxia/reação anafilactoide, hemólise em formulações específicas e falha de reversão por via inadequada.",
    "adverseEffects": "Dor no local, rubor e alteração do paladar.; Anafilaxia/reação anafilactoide, hemólise em formulações específicas e falha de reversão por via inadequada.",
    "contraindications": "Hipersensibilidade e contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas e metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade e riscos graves aplicáveis.",
    "administration": "Usar somente via e formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações e vias não são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação e jurisdição.",
    "safetyFlags": "Anafilaxia/reação anafilactoide, hemólise em formulações específicas e falha de reversão por via inadequada.",
    "alerts": "Anafilaxia/reação anafilactoide, hemólise em formulações específicas e falha de reversão por via inadequada.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=vitamina+k",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
    "ref": "https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=vitamina+k"
  },
  "es": {
    "name": "Vitamina K (fitomenadiona)",
    "class": "Vitamina lipossolúvel necessária à síntese de fatores de coagulação",
    "pharmacologicClass": "Vitamina lipossolúvel necessária à síntese de fatores de coagulação",
    "commercialNames": "Marcas variam por país.",
    "presentation": "Comprimidos, gotas y solución injetável em diferentes concentrações.",
    "presentations": "Comprimidos, gotas y solución injetável em diferentes concentrações.",
    "mechanism": "Mecanismo específico conforme fonte primária.",
    "pharmacodynamics": "Efeito farmacodinâmico dependente da substância y exposição.",
    "pharmacokinetics": "Revisar absorção, metabolismo y eliminação na fonte primária.",
    "indications": "Prevenção ou tratamento da deficiência de vitamina K y reversão de antagonistas da vitamina K conforme urgência.",
    "dose": "Via y dosis dependem da causa, INR, sangramento y urgência. Reversão grave exige protocolo con concentrado de fatores; administração IV lenta pelo risco de reação.",
    "pediatricDose": "Automação pediátrica bloqueada sem tabela completa por idade, peso, indicação y formulação.",
    "renalDose": "No inferir ajuste; aplicar somente tabela/conduta da fonte específica.",
    "hepaticDose": "No inferir ajuste; aplicar somente recomendação da fonte específica.",
    "commonAdverseEffects": "Dor no local, rubor y alteração do paladar.",
    "dangerousAdverseEffects": "Anafilaxia/reação anafilactoide, hemólise em formulações específicas y falha de reversão por via inadequada.",
    "adverseEffects": "Dor no local, rubor y alteração do paladar.; Anafilaxia/reação anafilactoide, hemólise em formulações específicas y falha de reversão por via inadequada.",
    "contraindications": "Hipersensibilidade y contraindicações específicas da apresentação.",
    "interactions": "Revisar interações farmacodinâmicas y metabólicas na fonte específica.",
    "monitoring": "Monitorar eficácia, tolerabilidade y riscos graves aplicáveis.",
    "administration": "Usar somente via y formulação documentadas; respeitar técnica específica.",
    ...
    "clinicalPearls": "Formulações y vias no são automaticamente intercambiáveis.",
    "guidelineRecommendations": "Aplicar diretriz oficial da indicação y jurisdição.",
    "safetyFlags": "Anafilaxia/reação anafilactoide, hemólise em formulações específicas y falha de reversão por via inadequada.",
    "alerts": "Anafilaxia/reação anafilactoide, hemólise em formulações específicas y falha de reversão por via inadequada.; revisão clínica obrigatória.",
    "references": [
      "Fonte primária/oficial - https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=vitamina+k",
      "Fonte primária/oficial - https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files"
    ],
...
/* GOLD33_SELECTIVE:vitamina_k:END */
