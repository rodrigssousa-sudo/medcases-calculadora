/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=346 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v346';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=346 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=346',
  './css/build233.css?v=346',
  './css/build234-design-system.css?v=346',
  './css/build235-layout.css?v=346',
  './css/build236-hub-redesign.css?v=346',
  './css/build237a-ux-refinement.css?v=346',
  './css/build237b-flush-cards.css?v=346',
  './css/build240b-fixes.css?v=346',
  './css/build241-ux-pro.css?v=346',
  './css/build243-fullscreen-overlay.css?v=346',
  './css/build244-category-pills.css?v=346',
  './css/build246-farmaco-modal-premium.css?v=346',
  './css/build254-critical-fixes.css?v=346',
  './css/build272-universal-design-system.css?v=346',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=346',
  './js/hub-accordion.js?v=346',
  './js/build240b-accordion-fix.js?v=346',
  './js/calculator-overlay.js?v=346',
  './js/category-pills.js?v=346',
  './js/elec-calc.js?v=346',
  './js/deeplink-router.js?v=346',
  './js/build272-reactive-engine.js?v=346',
  './js/build283-accessory-bar.js?v=346',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=346',
  './database/anticoag.js?v=346',
  './database/antimicrobianos.js?v=346',
  './database/cardio.js?v=346',
  './database/endocrino.js?v=346',
  './database/gastro.js?v=346',
  './database/gastro_imuno.js?v=346',
  './database/imuno_corticoide.js?v=346',
  './database/endocrino_glp1.js?v=346',
  './database/infusoes.js?v=346',
  './database/interacoes.js?v=346',
  './database/nefro.js?v=346',
  './database/neuro.js?v=346',
  './database/obesidade.js?v=346',
  './database/pneumo.js?v=346',
  './database/prescricoes.js?v=346',
  './database/psicofarmacos.js?v=346',
  './database/psiquiatria.js?v=346',
  './database/reumatologia.js?v=346',
  './database/emergencia.js?v=346',
  './database/infectologia.js?v=346',
];
