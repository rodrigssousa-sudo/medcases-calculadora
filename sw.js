/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=312 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v312';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=312 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=312',
  './css/build233.css?v=312',
  './css/build234-design-system.css?v=312',
  './css/build235-layout.css?v=312',
  './css/build236-hub-redesign.css?v=312',
  './css/build237a-ux-refinement.css?v=312',
  './css/build237b-flush-cards.css?v=312',
  './css/build240b-fixes.css?v=312',
  './css/build241-ux-pro.css?v=312',
  './css/build243-fullscreen-overlay.css?v=312',
  './css/build244-category-pills.css?v=312',
  './css/build246-farmaco-modal-premium.css?v=312',
  './css/build254-critical-fixes.css?v=312',
  './css/build272-universal-design-system.css?v=312',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=312',
  './js/hub-accordion.js?v=312',
  './js/build240b-accordion-fix.js?v=312',
  './js/calculator-overlay.js?v=312',
  './js/category-pills.js?v=312',
  './js/elec-calc.js?v=312',
  './js/deeplink-router.js?v=312',
  './js/build272-reactive-engine.js?v=312',
  './js/build283-accessory-bar.js?v=312',

  /* ── Database (16 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=312',
  './database/anticoag.js?v=312',
  './database/antimicrobianos.js?v=312',
  './database/cardio.js?v=312',
  './database/endocrino.js?v=312',
  './database/gastro.js?v=312',
  './database/gastro_imuno.js?v=312',
  './database/imuno_corticoide.js?v=312',
  './database/endocrino_glp1.js?v=312',
  './database/infusoes.js?v=312',
  './database/interacoes.js?v=312',
  './database/nefro.js?v=312',
  './database/neuro.js?v=312',
  './database/obesidade.js?v=312',
  './database/pneumo.js?v=312',
  './database/prescricoes.js?v=312',
  './database/psicofarmacos.js?v=312',
  './database/psiquiatria.js?v=312',
  './database/reumatologia.js?v=312',
];
