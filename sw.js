/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=306 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v306';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=306 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=306',
  './css/build233.css?v=306',
  './css/build234-design-system.css?v=306',
  './css/build235-layout.css?v=306',
  './css/build236-hub-redesign.css?v=306',
  './css/build237a-ux-refinement.css?v=306',
  './css/build237b-flush-cards.css?v=306',
  './css/build240b-fixes.css?v=306',
  './css/build241-ux-pro.css?v=306',
  './css/build243-fullscreen-overlay.css?v=306',
  './css/build244-category-pills.css?v=306',
  './css/build246-farmaco-modal-premium.css?v=306',
  './css/build254-critical-fixes.css?v=306',
  './css/build272-universal-design-system.css?v=306',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=306',
  './js/hub-accordion.js?v=306',
  './js/build240b-accordion-fix.js?v=306',
  './js/calculator-overlay.js?v=306',
  './js/category-pills.js?v=306',
  './js/elec-calc.js?v=306',
  './js/deeplink-router.js?v=306',
  './js/build272-reactive-engine.js?v=306',
  './js/build283-accessory-bar.js?v=306',

  /* ── Database (16 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=306',
  './database/anticoag.js?v=306',
  './database/antimicrobianos.js?v=306',
  './database/cardio.js?v=306',
  './database/endocrino.js?v=306',
  './database/gastro.js?v=306',
  './database/gastro_imuno.js?v=306',
  './database/imuno_corticoide.js?v=306',
  './database/endocrino_glp1.js?v=306',
  './database/infusoes.js?v=306',
  './database/interacoes.js?v=306',
  './database/nefro.js?v=306',
  './database/neuro.js?v=306',
  './database/obesidade.js?v=306',
  './database/pneumo.js?v=306',
  './database/prescricoes.js?v=306',
  './database/psicofarmacos.js?v=306',
  './database/psiquiatria.js?v=306',
  './database/reumatologia.js?v=306',
];
