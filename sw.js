/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=340 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v340';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=340 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=340',
  './css/build233.css?v=340',
  './css/build234-design-system.css?v=340',
  './css/build235-layout.css?v=340',
  './css/build236-hub-redesign.css?v=340',
  './css/build237a-ux-refinement.css?v=340',
  './css/build237b-flush-cards.css?v=340',
  './css/build240b-fixes.css?v=340',
  './css/build241-ux-pro.css?v=340',
  './css/build243-fullscreen-overlay.css?v=340',
  './css/build244-category-pills.css?v=340',
  './css/build246-farmaco-modal-premium.css?v=340',
  './css/build254-critical-fixes.css?v=340',
  './css/build272-universal-design-system.css?v=340',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=340',
  './js/hub-accordion.js?v=340',
  './js/build240b-accordion-fix.js?v=340',
  './js/calculator-overlay.js?v=340',
  './js/category-pills.js?v=340',
  './js/elec-calc.js?v=340',
  './js/deeplink-router.js?v=340',
  './js/build272-reactive-engine.js?v=340',
  './js/build283-accessory-bar.js?v=340',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=340',
  './database/anticoag.js?v=340',
  './database/antimicrobianos.js?v=340',
  './database/cardio.js?v=340',
  './database/endocrino.js?v=340',
  './database/gastro.js?v=340',
  './database/gastro_imuno.js?v=340',
  './database/imuno_corticoide.js?v=340',
  './database/endocrino_glp1.js?v=340',
  './database/infusoes.js?v=340',
  './database/interacoes.js?v=340',
  './database/nefro.js?v=340',
  './database/neuro.js?v=340',
  './database/obesidade.js?v=340',
  './database/pneumo.js?v=340',
  './database/prescricoes.js?v=340',
  './database/psicofarmacos.js?v=340',
  './database/psiquiatria.js?v=340',
  './database/reumatologia.js?v=340',
  './database/emergencia.js?v=340',
  './database/infectologia.js?v=340',
];
