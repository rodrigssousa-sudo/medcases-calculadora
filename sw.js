/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=396 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v396';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=396 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=396',
  './css/build233.css?v=396',
  './css/build234-design-system.css?v=396',
  './css/build235-layout.css?v=396',
  './css/build236-hub-redesign.css?v=396',
  './css/build237a-ux-refinement.css?v=396',
  './css/build237b-flush-cards.css?v=396',
  './css/build240b-fixes.css?v=396',
  './css/build241-ux-pro.css?v=396',
  './css/build243-fullscreen-overlay.css?v=396',
  './css/build244-category-pills.css?v=396',
  './css/build246-farmaco-modal-premium.css?v=396',
  './css/build254-critical-fixes.css?v=396',
  './css/build272-universal-design-system.css?v=396',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=396',
  './js/hub-accordion.js?v=396',
  './js/build240b-accordion-fix.js?v=396',
  './js/calculator-overlay.js?v=396',
  './js/category-pills.js?v=396',
  './js/elec-calc.js?v=396',
  './js/deeplink-router.js?v=396',
  './js/build272-reactive-engine.js?v=396',
  './js/build283-accessory-bar.js?v=396',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=396',
  './database/anticoag.js?v=396',
  './database/antimicrobianos.js?v=396',
  './database/cardio.js?v=396',
  './database/endocrino.js?v=396',
  './database/gastro.js?v=396',
  './database/gastro_imuno.js?v=396',
  './database/imuno_corticoide.js?v=396',
  './database/endocrino_glp1.js?v=396',
  './database/infusoes.js?v=396',
  './database/interacoes.js?v=396',
  './database/nefro.js?v=396',
  './database/neuro.js?v=396',
  './database/obesidade.js?v=396',
  './database/pneumo.js?v=396',
  './database/pneumologia.js?v=396',
  './database/alergia_imunologia.js?v=396',
  './database/pneumologia_otorrino.js?v=396',
  './database/neurologia.js?v=396',
  './database/prescricoes.js?v=396',
  './database/psicofarmacos.js?v=396',
  './database/psiquiatria.js?v=396',
  './database/reumatologia.js?v=396',
  './database/emergencia.js?v=396',
  './database/infectologia.js?v=396',
  './database/sedacao.js?v=396',
  './database/hematologia.js?v=396',
  './database/gastroenterologia.js?v=396',
  './database/cardiologia.js?v=396',
  './database/analgesia_opioides.js?v=396',
];
