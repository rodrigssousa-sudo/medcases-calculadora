/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=310 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v310';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=310 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=310',
  './css/build233.css?v=310',
  './css/build234-design-system.css?v=310',
  './css/build235-layout.css?v=310',
  './css/build236-hub-redesign.css?v=310',
  './css/build237a-ux-refinement.css?v=310',
  './css/build237b-flush-cards.css?v=310',
  './css/build240b-fixes.css?v=310',
  './css/build241-ux-pro.css?v=310',
  './css/build243-fullscreen-overlay.css?v=310',
  './css/build244-category-pills.css?v=310',
  './css/build246-farmaco-modal-premium.css?v=310',
  './css/build254-critical-fixes.css?v=310',
  './css/build272-universal-design-system.css?v=310',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=310',
  './js/hub-accordion.js?v=310',
  './js/build240b-accordion-fix.js?v=310',
  './js/calculator-overlay.js?v=310',
  './js/category-pills.js?v=310',
  './js/elec-calc.js?v=310',
  './js/deeplink-router.js?v=310',
  './js/build272-reactive-engine.js?v=310',
  './js/build283-accessory-bar.js?v=310',

  /* ── Database (16 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=310',
  './database/anticoag.js?v=310',
  './database/antimicrobianos.js?v=310',
  './database/cardio.js?v=310',
  './database/endocrino.js?v=310',
  './database/gastro.js?v=310',
  './database/gastro_imuno.js?v=310',
  './database/imuno_corticoide.js?v=310',
  './database/endocrino_glp1.js?v=310',
  './database/infusoes.js?v=310',
  './database/interacoes.js?v=310',
  './database/nefro.js?v=310',
  './database/neuro.js?v=310',
  './database/obesidade.js?v=310',
  './database/pneumo.js?v=310',
  './database/prescricoes.js?v=310',
  './database/psicofarmacos.js?v=310',
  './database/psiquiatria.js?v=310',
  './database/reumatologia.js?v=310',
];
