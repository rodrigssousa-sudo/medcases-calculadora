/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=447 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v447';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=447 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=447',
  './css/build233.css?v=447',
  './css/build234-design-system.css?v=447',
  './css/build235-layout.css?v=447',
  './css/build236-hub-redesign.css?v=447',
  './css/build237a-ux-refinement.css?v=447',
  './css/build237b-flush-cards.css?v=447',
  './css/build240b-fixes.css?v=447',
  './css/build241-ux-pro.css?v=447',
  './css/build243-fullscreen-overlay.css?v=447',
  './css/build244-category-pills.css?v=447',
  './css/build246-farmaco-modal-premium.css?v=447',
  './css/build254-critical-fixes.css?v=447',
  './css/build272-universal-design-system.css?v=447',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=447',
  './js/hub-accordion.js?v=447',
  './js/build240b-accordion-fix.js?v=447',
  './js/calculator-overlay.js?v=447',
  './js/category-pills.js?v=447',
  './js/elec-calc.js?v=447',
  './js/deeplink-router.js?v=447',
  './js/build272-reactive-engine.js?v=447',
  './js/build283-accessory-bar.js?v=447',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=447',
  './database/anticoag.js?v=447',
  './database/antimicrobianos.js?v=447',
  './database/cardio.js?v=447',
  './database/endocrino.js?v=447',
  './database/gastro.js?v=447',
  './database/gastro_imuno.js?v=447',
  './database/imuno_corticoide.js?v=447',
  './database/endocrino_glp1.js?v=447',
  './database/infusoes.js?v=447',
  './database/interacoes.js?v=447',
  './database/nefro.js?v=447',
  './database/neuro.js?v=447',
  './database/obesidade.js?v=447',
  './database/pneumo.js?v=447',
  './database/pneumologia.js?v=447',
  './database/alergia_imunologia.js?v=447',
  './database/pneumologia_otorrino.js?v=447',
  './database/neurologia.js?v=447',
  './database/prescricoes.js?v=447',
  './database/psicofarmacos.js?v=447',
  './database/psiquiatria.js?v=447',
  './database/reumatologia.js?v=447',
  './database/emergencia.js?v=447',
  './database/infectologia.js?v=447',
  './database/sedacao.js?v=447',
  './database/hematologia.js?v=447',
  './database/gastroenterologia.js?v=447',
  './database/cardiologia.js?v=447',
  './database/analgesia_opioides.js?v=447',
];
