/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=338 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v338';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=338 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=338',
  './css/build233.css?v=338',
  './css/build234-design-system.css?v=338',
  './css/build235-layout.css?v=338',
  './css/build236-hub-redesign.css?v=338',
  './css/build237a-ux-refinement.css?v=338',
  './css/build237b-flush-cards.css?v=338',
  './css/build240b-fixes.css?v=338',
  './css/build241-ux-pro.css?v=338',
  './css/build243-fullscreen-overlay.css?v=338',
  './css/build244-category-pills.css?v=338',
  './css/build246-farmaco-modal-premium.css?v=338',
  './css/build254-critical-fixes.css?v=338',
  './css/build272-universal-design-system.css?v=338',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=338',
  './js/hub-accordion.js?v=338',
  './js/build240b-accordion-fix.js?v=338',
  './js/calculator-overlay.js?v=338',
  './js/category-pills.js?v=338',
  './js/elec-calc.js?v=338',
  './js/deeplink-router.js?v=338',
  './js/build272-reactive-engine.js?v=338',
  './js/build283-accessory-bar.js?v=338',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=338',
  './database/anticoag.js?v=338',
  './database/antimicrobianos.js?v=338',
  './database/cardio.js?v=338',
  './database/endocrino.js?v=338',
  './database/gastro.js?v=338',
  './database/gastro_imuno.js?v=338',
  './database/imuno_corticoide.js?v=338',
  './database/endocrino_glp1.js?v=338',
  './database/infusoes.js?v=338',
  './database/interacoes.js?v=338',
  './database/nefro.js?v=338',
  './database/neuro.js?v=338',
  './database/obesidade.js?v=338',
  './database/pneumo.js?v=338',
  './database/prescricoes.js?v=338',
  './database/psicofarmacos.js?v=338',
  './database/psiquiatria.js?v=338',
  './database/reumatologia.js?v=338',
  './database/emergencia.js?v=338',
  './database/infectologia.js?v=338',
];
