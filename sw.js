/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=328 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v328';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=328 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=328',
  './css/build233.css?v=328',
  './css/build234-design-system.css?v=328',
  './css/build235-layout.css?v=328',
  './css/build236-hub-redesign.css?v=328',
  './css/build237a-ux-refinement.css?v=328',
  './css/build237b-flush-cards.css?v=328',
  './css/build240b-fixes.css?v=328',
  './css/build241-ux-pro.css?v=328',
  './css/build243-fullscreen-overlay.css?v=328',
  './css/build244-category-pills.css?v=328',
  './css/build246-farmaco-modal-premium.css?v=328',
  './css/build254-critical-fixes.css?v=328',
  './css/build272-universal-design-system.css?v=328',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=328',
  './js/hub-accordion.js?v=328',
  './js/build240b-accordion-fix.js?v=328',
  './js/calculator-overlay.js?v=328',
  './js/category-pills.js?v=328',
  './js/elec-calc.js?v=328',
  './js/deeplink-router.js?v=328',
  './js/build272-reactive-engine.js?v=328',
  './js/build283-accessory-bar.js?v=328',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=328',
  './database/anticoag.js?v=328',
  './database/antimicrobianos.js?v=328',
  './database/cardio.js?v=328',
  './database/endocrino.js?v=328',
  './database/gastro.js?v=328',
  './database/gastro_imuno.js?v=328',
  './database/imuno_corticoide.js?v=328',
  './database/endocrino_glp1.js?v=328',
  './database/infusoes.js?v=328',
  './database/interacoes.js?v=328',
  './database/nefro.js?v=328',
  './database/neuro.js?v=328',
  './database/obesidade.js?v=328',
  './database/pneumo.js?v=328',
  './database/prescricoes.js?v=328',
  './database/psicofarmacos.js?v=328',
  './database/psiquiatria.js?v=328',
  './database/reumatologia.js?v=328',
  './database/emergencia.js?v=328',
];
