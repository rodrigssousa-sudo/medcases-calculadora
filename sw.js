/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=326 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v326';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=326 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=326',
  './css/build233.css?v=326',
  './css/build234-design-system.css?v=326',
  './css/build235-layout.css?v=326',
  './css/build236-hub-redesign.css?v=326',
  './css/build237a-ux-refinement.css?v=326',
  './css/build237b-flush-cards.css?v=326',
  './css/build240b-fixes.css?v=326',
  './css/build241-ux-pro.css?v=326',
  './css/build243-fullscreen-overlay.css?v=326',
  './css/build244-category-pills.css?v=326',
  './css/build246-farmaco-modal-premium.css?v=326',
  './css/build254-critical-fixes.css?v=326',
  './css/build272-universal-design-system.css?v=326',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=326',
  './js/hub-accordion.js?v=326',
  './js/build240b-accordion-fix.js?v=326',
  './js/calculator-overlay.js?v=326',
  './js/category-pills.js?v=326',
  './js/elec-calc.js?v=326',
  './js/deeplink-router.js?v=326',
  './js/build272-reactive-engine.js?v=326',
  './js/build283-accessory-bar.js?v=326',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=326',
  './database/anticoag.js?v=326',
  './database/antimicrobianos.js?v=326',
  './database/cardio.js?v=326',
  './database/endocrino.js?v=326',
  './database/gastro.js?v=326',
  './database/gastro_imuno.js?v=326',
  './database/imuno_corticoide.js?v=326',
  './database/endocrino_glp1.js?v=326',
  './database/infusoes.js?v=326',
  './database/interacoes.js?v=326',
  './database/nefro.js?v=326',
  './database/neuro.js?v=326',
  './database/obesidade.js?v=326',
  './database/pneumo.js?v=326',
  './database/prescricoes.js?v=326',
  './database/psicofarmacos.js?v=326',
  './database/psiquiatria.js?v=326',
  './database/reumatologia.js?v=326',
  './database/emergencia.js?v=326',
];
