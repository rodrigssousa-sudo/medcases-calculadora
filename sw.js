/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=401 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v401';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=401 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=401',
  './css/build233.css?v=401',
  './css/build234-design-system.css?v=401',
  './css/build235-layout.css?v=401',
  './css/build236-hub-redesign.css?v=401',
  './css/build237a-ux-refinement.css?v=401',
  './css/build237b-flush-cards.css?v=401',
  './css/build240b-fixes.css?v=401',
  './css/build241-ux-pro.css?v=401',
  './css/build243-fullscreen-overlay.css?v=401',
  './css/build244-category-pills.css?v=401',
  './css/build246-farmaco-modal-premium.css?v=401',
  './css/build254-critical-fixes.css?v=401',
  './css/build272-universal-design-system.css?v=401',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=401',
  './js/hub-accordion.js?v=401',
  './js/build240b-accordion-fix.js?v=401',
  './js/calculator-overlay.js?v=401',
  './js/category-pills.js?v=401',
  './js/elec-calc.js?v=401',
  './js/deeplink-router.js?v=401',
  './js/build272-reactive-engine.js?v=401',
  './js/build283-accessory-bar.js?v=401',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=401',
  './database/anticoag.js?v=401',
  './database/antimicrobianos.js?v=401',
  './database/cardio.js?v=401',
  './database/endocrino.js?v=401',
  './database/gastro.js?v=401',
  './database/gastro_imuno.js?v=401',
  './database/imuno_corticoide.js?v=401',
  './database/endocrino_glp1.js?v=401',
  './database/infusoes.js?v=401',
  './database/interacoes.js?v=401',
  './database/nefro.js?v=401',
  './database/neuro.js?v=401',
  './database/obesidade.js?v=401',
  './database/pneumo.js?v=401',
  './database/pneumologia.js?v=401',
  './database/alergia_imunologia.js?v=401',
  './database/pneumologia_otorrino.js?v=401',
  './database/neurologia.js?v=401',
  './database/prescricoes.js?v=401',
  './database/psicofarmacos.js?v=401',
  './database/psiquiatria.js?v=401',
  './database/reumatologia.js?v=401',
  './database/emergencia.js?v=401',
  './database/infectologia.js?v=401',
  './database/sedacao.js?v=401',
  './database/hematologia.js?v=401',
  './database/gastroenterologia.js?v=401',
  './database/cardiologia.js?v=401',
  './database/analgesia_opioides.js?v=401',
];
