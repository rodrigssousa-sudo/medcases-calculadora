/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=298 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v298';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=298 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=298',
  './css/build233.css?v=298',
  './css/build234-design-system.css?v=298',
  './css/build235-layout.css?v=298',
  './css/build236-hub-redesign.css?v=298',
  './css/build237a-ux-refinement.css?v=298',
  './css/build237b-flush-cards.css?v=298',
  './css/build240b-fixes.css?v=298',
  './css/build241-ux-pro.css?v=298',
  './css/build243-fullscreen-overlay.css?v=298',
  './css/build244-category-pills.css?v=298',
  './css/build246-farmaco-modal-premium.css?v=298',
  './css/build254-critical-fixes.css?v=298',
  './css/build272-universal-design-system.css?v=298',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=298',
  './js/hub-accordion.js?v=298',
  './js/build240b-accordion-fix.js?v=298',
  './js/calculator-overlay.js?v=298',
  './js/category-pills.js?v=298',
  './js/elec-calc.js?v=298',
  './js/deeplink-router.js?v=298',
  './js/build272-reactive-engine.js?v=298',
  './js/build283-accessory-bar.js?v=298',

  /* ── Database (16 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=298',
  './database/anticoag.js?v=298',
  './database/antimicrobianos.js?v=298',
  './database/cardio.js?v=298',
  './database/endocrino.js?v=298',
  './database/gastro.js?v=298',
  './database/gastro_imuno.js?v=298',
  './database/imuno_corticoide.js?v=298',
  './database/endocrino_glp1.js?v=298',
  './database/infusoes.js?v=298',
  './database/interacoes.js?v=298',
  './database/nefro.js?v=298',
  './database/neuro.js?v=298',
  './database/obesidade.js?v=298',
  './database/pneumo.js?v=298',
  './database/prescricoes.js?v=298',
  './database/psicofarmacos.js?v=298',
  './database/psiquiatria.js?v=298',
  './database/reumatologia.js?v=298',
];
