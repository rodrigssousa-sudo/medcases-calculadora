/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=342 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v342';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=342 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=342',
  './css/build233.css?v=342',
  './css/build234-design-system.css?v=342',
  './css/build235-layout.css?v=342',
  './css/build236-hub-redesign.css?v=342',
  './css/build237a-ux-refinement.css?v=342',
  './css/build237b-flush-cards.css?v=342',
  './css/build240b-fixes.css?v=342',
  './css/build241-ux-pro.css?v=342',
  './css/build243-fullscreen-overlay.css?v=342',
  './css/build244-category-pills.css?v=342',
  './css/build246-farmaco-modal-premium.css?v=342',
  './css/build254-critical-fixes.css?v=342',
  './css/build272-universal-design-system.css?v=342',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=342',
  './js/hub-accordion.js?v=342',
  './js/build240b-accordion-fix.js?v=342',
  './js/calculator-overlay.js?v=342',
  './js/category-pills.js?v=342',
  './js/elec-calc.js?v=342',
  './js/deeplink-router.js?v=342',
  './js/build272-reactive-engine.js?v=342',
  './js/build283-accessory-bar.js?v=342',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=342',
  './database/anticoag.js?v=342',
  './database/antimicrobianos.js?v=342',
  './database/cardio.js?v=342',
  './database/endocrino.js?v=342',
  './database/gastro.js?v=342',
  './database/gastro_imuno.js?v=342',
  './database/imuno_corticoide.js?v=342',
  './database/endocrino_glp1.js?v=342',
  './database/infusoes.js?v=342',
  './database/interacoes.js?v=342',
  './database/nefro.js?v=342',
  './database/neuro.js?v=342',
  './database/obesidade.js?v=342',
  './database/pneumo.js?v=342',
  './database/prescricoes.js?v=342',
  './database/psicofarmacos.js?v=342',
  './database/psiquiatria.js?v=342',
  './database/reumatologia.js?v=342',
  './database/emergencia.js?v=342',
  './database/infectologia.js?v=342',
];
