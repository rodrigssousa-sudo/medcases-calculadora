/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=432 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v432';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=432 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=432',
  './css/build233.css?v=432',
  './css/build234-design-system.css?v=432',
  './css/build235-layout.css?v=432',
  './css/build236-hub-redesign.css?v=432',
  './css/build237a-ux-refinement.css?v=432',
  './css/build237b-flush-cards.css?v=432',
  './css/build240b-fixes.css?v=432',
  './css/build241-ux-pro.css?v=432',
  './css/build243-fullscreen-overlay.css?v=432',
  './css/build244-category-pills.css?v=432',
  './css/build246-farmaco-modal-premium.css?v=432',
  './css/build254-critical-fixes.css?v=432',
  './css/build272-universal-design-system.css?v=432',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=432',
  './js/hub-accordion.js?v=432',
  './js/build240b-accordion-fix.js?v=432',
  './js/calculator-overlay.js?v=432',
  './js/category-pills.js?v=432',
  './js/elec-calc.js?v=432',
  './js/deeplink-router.js?v=432',
  './js/build272-reactive-engine.js?v=432',
  './js/build283-accessory-bar.js?v=432',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=432',
  './database/anticoag.js?v=432',
  './database/antimicrobianos.js?v=432',
  './database/cardio.js?v=432',
  './database/endocrino.js?v=432',
  './database/gastro.js?v=432',
  './database/gastro_imuno.js?v=432',
  './database/imuno_corticoide.js?v=432',
  './database/endocrino_glp1.js?v=432',
  './database/infusoes.js?v=432',
  './database/interacoes.js?v=432',
  './database/nefro.js?v=432',
  './database/neuro.js?v=432',
  './database/obesidade.js?v=432',
  './database/pneumo.js?v=432',
  './database/pneumologia.js?v=432',
  './database/alergia_imunologia.js?v=432',
  './database/pneumologia_otorrino.js?v=432',
  './database/neurologia.js?v=432',
  './database/prescricoes.js?v=432',
  './database/psicofarmacos.js?v=432',
  './database/psiquiatria.js?v=432',
  './database/reumatologia.js?v=432',
  './database/emergencia.js?v=432',
  './database/infectologia.js?v=432',
  './database/sedacao.js?v=432',
  './database/hematologia.js?v=432',
  './database/gastroenterologia.js?v=432',
  './database/cardiologia.js?v=432',
  './database/analgesia_opioides.js?v=432',
];
