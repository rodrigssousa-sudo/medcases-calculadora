/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=302 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v302';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=302 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=302',
  './css/build233.css?v=302',
  './css/build234-design-system.css?v=302',
  './css/build235-layout.css?v=302',
  './css/build236-hub-redesign.css?v=302',
  './css/build237a-ux-refinement.css?v=302',
  './css/build237b-flush-cards.css?v=302',
  './css/build240b-fixes.css?v=302',
  './css/build241-ux-pro.css?v=302',
  './css/build243-fullscreen-overlay.css?v=302',
  './css/build244-category-pills.css?v=302',
  './css/build246-farmaco-modal-premium.css?v=302',
  './css/build254-critical-fixes.css?v=302',
  './css/build272-universal-design-system.css?v=302',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=302',
  './js/hub-accordion.js?v=302',
  './js/build240b-accordion-fix.js?v=302',
  './js/calculator-overlay.js?v=302',
  './js/category-pills.js?v=302',
  './js/elec-calc.js?v=302',
  './js/deeplink-router.js?v=302',
  './js/build272-reactive-engine.js?v=302',
  './js/build283-accessory-bar.js?v=302',

  /* ── Database (16 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=302',
  './database/anticoag.js?v=302',
  './database/antimicrobianos.js?v=302',
  './database/cardio.js?v=302',
  './database/endocrino.js?v=302',
  './database/gastro.js?v=302',
  './database/gastro_imuno.js?v=302',
  './database/imuno_corticoide.js?v=302',
  './database/endocrino_glp1.js?v=302',
  './database/infusoes.js?v=302',
  './database/interacoes.js?v=302',
  './database/nefro.js?v=302',
  './database/neuro.js?v=302',
  './database/obesidade.js?v=302',
  './database/pneumo.js?v=302',
  './database/prescricoes.js?v=302',
  './database/psicofarmacos.js?v=302',
  './database/psiquiatria.js?v=302',
  './database/reumatologia.js?v=302',
];
