/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=308 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v308';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=308 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=308',
  './css/build233.css?v=308',
  './css/build234-design-system.css?v=308',
  './css/build235-layout.css?v=308',
  './css/build236-hub-redesign.css?v=308',
  './css/build237a-ux-refinement.css?v=308',
  './css/build237b-flush-cards.css?v=308',
  './css/build240b-fixes.css?v=308',
  './css/build241-ux-pro.css?v=308',
  './css/build243-fullscreen-overlay.css?v=308',
  './css/build244-category-pills.css?v=308',
  './css/build246-farmaco-modal-premium.css?v=308',
  './css/build254-critical-fixes.css?v=308',
  './css/build272-universal-design-system.css?v=308',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=308',
  './js/hub-accordion.js?v=308',
  './js/build240b-accordion-fix.js?v=308',
  './js/calculator-overlay.js?v=308',
  './js/category-pills.js?v=308',
  './js/elec-calc.js?v=308',
  './js/deeplink-router.js?v=308',
  './js/build272-reactive-engine.js?v=308',
  './js/build283-accessory-bar.js?v=308',

  /* ── Database (16 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=308',
  './database/anticoag.js?v=308',
  './database/antimicrobianos.js?v=308',
  './database/cardio.js?v=308',
  './database/endocrino.js?v=308',
  './database/gastro.js?v=308',
  './database/gastro_imuno.js?v=308',
  './database/imuno_corticoide.js?v=308',
  './database/endocrino_glp1.js?v=308',
  './database/infusoes.js?v=308',
  './database/interacoes.js?v=308',
  './database/nefro.js?v=308',
  './database/neuro.js?v=308',
  './database/obesidade.js?v=308',
  './database/pneumo.js?v=308',
  './database/prescricoes.js?v=308',
  './database/psicofarmacos.js?v=308',
  './database/psiquiatria.js?v=308',
  './database/reumatologia.js?v=308',
];
