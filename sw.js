/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=454 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v454';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=454 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=454',
  './css/build233.css?v=454',
  './css/build234-design-system.css?v=454',
  './css/build235-layout.css?v=454',
  './css/build236-hub-redesign.css?v=454',
  './css/build237a-ux-refinement.css?v=454',
  './css/build237b-flush-cards.css?v=454',
  './css/build240b-fixes.css?v=454',
  './css/build241-ux-pro.css?v=454',
  './css/build243-fullscreen-overlay.css?v=454',
  './css/build244-category-pills.css?v=454',
  './css/build246-farmaco-modal-premium.css?v=454',
  './css/build254-critical-fixes.css?v=454',
  './css/build272-universal-design-system.css?v=454',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=454',
  './js/hub-accordion.js?v=454',
  './js/build240b-accordion-fix.js?v=454',
  './js/calculator-overlay.js?v=454',
  './js/category-pills.js?v=454',
  './js/elec-calc.js?v=454',
  './js/deeplink-router.js?v=454',
  './js/build272-reactive-engine.js?v=454',
  './js/build283-accessory-bar.js?v=454',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=454',
  './database/anticoag.js?v=454',
  './database/antimicrobianos.js?v=454',
  './database/cardio.js?v=454',
  './database/endocrino.js?v=454',
  './database/gastro.js?v=454',
  './database/gastro_imuno.js?v=454',
  './database/imuno_corticoide.js?v=454',
  './database/endocrino_glp1.js?v=454',
  './database/infusoes.js?v=454',
  './database/interacoes.js?v=454',
  './database/nefro.js?v=454',
  './database/neuro.js?v=454',
  './database/obesidade.js?v=454',
  './database/pneumo.js?v=454',
  './database/pneumologia.js?v=454',
  './database/alergia_imunologia.js?v=454',
  './database/pneumologia_otorrino.js?v=454',
  './database/neurologia.js?v=454',
  './database/prescricoes.js?v=454',
  './database/psicofarmacos.js?v=454',
  './database/psiquiatria.js?v=454',
  './database/reumatologia.js?v=454',
  './database/emergencia.js?v=454',
  './database/infectologia.js?v=454',
  './database/sedacao.js?v=454',
  './database/hematologia.js?v=454',
  './database/gastroenterologia.js?v=454',
  './database/cardiologia.js?v=454',
  './database/analgesia_opioides.js?v=454',
];
