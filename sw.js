/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=336 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v336';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=336 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=336',
  './css/build233.css?v=336',
  './css/build234-design-system.css?v=336',
  './css/build235-layout.css?v=336',
  './css/build236-hub-redesign.css?v=336',
  './css/build237a-ux-refinement.css?v=336',
  './css/build237b-flush-cards.css?v=336',
  './css/build240b-fixes.css?v=336',
  './css/build241-ux-pro.css?v=336',
  './css/build243-fullscreen-overlay.css?v=336',
  './css/build244-category-pills.css?v=336',
  './css/build246-farmaco-modal-premium.css?v=336',
  './css/build254-critical-fixes.css?v=336',
  './css/build272-universal-design-system.css?v=336',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=336',
  './js/hub-accordion.js?v=336',
  './js/build240b-accordion-fix.js?v=336',
  './js/calculator-overlay.js?v=336',
  './js/category-pills.js?v=336',
  './js/elec-calc.js?v=336',
  './js/deeplink-router.js?v=336',
  './js/build272-reactive-engine.js?v=336',
  './js/build283-accessory-bar.js?v=336',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=336',
  './database/anticoag.js?v=336',
  './database/antimicrobianos.js?v=336',
  './database/cardio.js?v=336',
  './database/endocrino.js?v=336',
  './database/gastro.js?v=336',
  './database/gastro_imuno.js?v=336',
  './database/imuno_corticoide.js?v=336',
  './database/endocrino_glp1.js?v=336',
  './database/infusoes.js?v=336',
  './database/interacoes.js?v=336',
  './database/nefro.js?v=336',
  './database/neuro.js?v=336',
  './database/obesidade.js?v=336',
  './database/pneumo.js?v=336',
  './database/prescricoes.js?v=336',
  './database/psicofarmacos.js?v=336',
  './database/psiquiatria.js?v=336',
  './database/reumatologia.js?v=336',
  './database/emergencia.js?v=336',
  './database/infectologia.js?v=336',
];
