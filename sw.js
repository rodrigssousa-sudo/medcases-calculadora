/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=330 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v330';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=330 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=330',
  './css/build233.css?v=330',
  './css/build234-design-system.css?v=330',
  './css/build235-layout.css?v=330',
  './css/build236-hub-redesign.css?v=330',
  './css/build237a-ux-refinement.css?v=330',
  './css/build237b-flush-cards.css?v=330',
  './css/build240b-fixes.css?v=330',
  './css/build241-ux-pro.css?v=330',
  './css/build243-fullscreen-overlay.css?v=330',
  './css/build244-category-pills.css?v=330',
  './css/build246-farmaco-modal-premium.css?v=330',
  './css/build254-critical-fixes.css?v=330',
  './css/build272-universal-design-system.css?v=330',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=330',
  './js/hub-accordion.js?v=330',
  './js/build240b-accordion-fix.js?v=330',
  './js/calculator-overlay.js?v=330',
  './js/category-pills.js?v=330',
  './js/elec-calc.js?v=330',
  './js/deeplink-router.js?v=330',
  './js/build272-reactive-engine.js?v=330',
  './js/build283-accessory-bar.js?v=330',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=330',
  './database/anticoag.js?v=330',
  './database/antimicrobianos.js?v=330',
  './database/cardio.js?v=330',
  './database/endocrino.js?v=330',
  './database/gastro.js?v=330',
  './database/gastro_imuno.js?v=330',
  './database/imuno_corticoide.js?v=330',
  './database/endocrino_glp1.js?v=330',
  './database/infusoes.js?v=330',
  './database/interacoes.js?v=330',
  './database/nefro.js?v=330',
  './database/neuro.js?v=330',
  './database/obesidade.js?v=330',
  './database/pneumo.js?v=330',
  './database/prescricoes.js?v=330',
  './database/psicofarmacos.js?v=330',
  './database/psiquiatria.js?v=330',
  './database/reumatologia.js?v=330',
  './database/emergencia.js?v=330',
];
