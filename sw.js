/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=358 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v358';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=358 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=358',
  './css/build233.css?v=358',
  './css/build234-design-system.css?v=358',
  './css/build235-layout.css?v=358',
  './css/build236-hub-redesign.css?v=358',
  './css/build237a-ux-refinement.css?v=358',
  './css/build237b-flush-cards.css?v=358',
  './css/build240b-fixes.css?v=358',
  './css/build241-ux-pro.css?v=358',
  './css/build243-fullscreen-overlay.css?v=358',
  './css/build244-category-pills.css?v=358',
  './css/build246-farmaco-modal-premium.css?v=358',
  './css/build254-critical-fixes.css?v=358',
  './css/build272-universal-design-system.css?v=358',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=358',
  './js/hub-accordion.js?v=358',
  './js/build240b-accordion-fix.js?v=358',
  './js/calculator-overlay.js?v=358',
  './js/category-pills.js?v=358',
  './js/elec-calc.js?v=358',
  './js/deeplink-router.js?v=358',
  './js/build272-reactive-engine.js?v=358',
  './js/build283-accessory-bar.js?v=358',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=358',
  './database/anticoag.js?v=358',
  './database/antimicrobianos.js?v=358',
  './database/cardio.js?v=358',
  './database/endocrino.js?v=358',
  './database/gastro.js?v=358',
  './database/gastro_imuno.js?v=358',
  './database/imuno_corticoide.js?v=358',
  './database/endocrino_glp1.js?v=358',
  './database/infusoes.js?v=358',
  './database/interacoes.js?v=358',
  './database/nefro.js?v=358',
  './database/neuro.js?v=358',
  './database/obesidade.js?v=358',
  './database/pneumo.js?v=358',
  './database/prescricoes.js?v=358',
  './database/psicofarmacos.js?v=358',
  './database/psiquiatria.js?v=358',
  './database/reumatologia.js?v=358',
  './database/emergencia.js?v=358',
  './database/infectologia.js?v=358',
  './database/sedacao.js?v=358',
  './database/hematologia.js?v=358',
  './database/gastroenterologia.js?v=358',
  './database/cardiologia.js?v=358',
  './database/analgesia_opioides.js?v=358',
];
