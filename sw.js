/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=344 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v344';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=344 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=344',
  './css/build233.css?v=344',
  './css/build234-design-system.css?v=344',
  './css/build235-layout.css?v=344',
  './css/build236-hub-redesign.css?v=344',
  './css/build237a-ux-refinement.css?v=344',
  './css/build237b-flush-cards.css?v=344',
  './css/build240b-fixes.css?v=344',
  './css/build241-ux-pro.css?v=344',
  './css/build243-fullscreen-overlay.css?v=344',
  './css/build244-category-pills.css?v=344',
  './css/build246-farmaco-modal-premium.css?v=344',
  './css/build254-critical-fixes.css?v=344',
  './css/build272-universal-design-system.css?v=344',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=344',
  './js/hub-accordion.js?v=344',
  './js/build240b-accordion-fix.js?v=344',
  './js/calculator-overlay.js?v=344',
  './js/category-pills.js?v=344',
  './js/elec-calc.js?v=344',
  './js/deeplink-router.js?v=344',
  './js/build272-reactive-engine.js?v=344',
  './js/build283-accessory-bar.js?v=344',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=344',
  './database/anticoag.js?v=344',
  './database/antimicrobianos.js?v=344',
  './database/cardio.js?v=344',
  './database/endocrino.js?v=344',
  './database/gastro.js?v=344',
  './database/gastro_imuno.js?v=344',
  './database/imuno_corticoide.js?v=344',
  './database/endocrino_glp1.js?v=344',
  './database/infusoes.js?v=344',
  './database/interacoes.js?v=344',
  './database/nefro.js?v=344',
  './database/neuro.js?v=344',
  './database/obesidade.js?v=344',
  './database/pneumo.js?v=344',
  './database/prescricoes.js?v=344',
  './database/psicofarmacos.js?v=344',
  './database/psiquiatria.js?v=344',
  './database/reumatologia.js?v=344',
  './database/emergencia.js?v=344',
  './database/infectologia.js?v=344',
];
