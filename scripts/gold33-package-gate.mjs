...
const approvedIds = v4 ? data.map((row) => row.ID) : (opinion.scope?.ids || []);
...
console.log(JSON.stringify({
  ...
  ids,
  finalSha256: v4 ? dataDocument.clinical_content_sha256 : opinion.final_consolidation.final_sha256,
  calculation: v4 ? 'GRANULAR_CONFORME_RESTRICOES' : restrictions.global.AUTORIZACAO_DE_CALCULO,
  publication: v4 ? dataDocument.gates.publication : restrictions.global.PUBLICACAO
}, null, 2));
