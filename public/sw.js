/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=414 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v414';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=414 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=414',
  './css/build233.css?v=414',
  './css/build234-design-system.css?v=414',
  './css/build235-layout.css?v=414',
  './css/build236-hub-redesign.css?v=414',
  './css/build237a-ux-refinement.css?v=414',
  './css/build237b-flush-cards.css?v=414',
  './css/build240b-fixes.css?v=414',
  './css/build241-ux-pro.css?v=414',
  './css/build243-fullscreen-overlay.css?v=414',
  './css/build244-category-pills.css?v=414',
  './css/build246-farmaco-modal-premium.css?v=414',
  './css/build254-critical-fixes.css?v=414',
  './css/build272-universal-design-system.css?v=414',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=414',
  './js/hub-accordion.js?v=414',
  './js/build240b-accordion-fix.js?v=414',
  './js/calculator-overlay.js?v=414',
  './js/category-pills.js?v=414',
  './js/elec-calc.js?v=414',
  './js/deeplink-router.js?v=414',
  './js/build272-reactive-engine.js?v=414',
  './js/build283-accessory-bar.js?v=414',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=414',
  './database/anticoag.js?v=414',
  './database/antimicrobianos.js?v=414',
  './database/cardio.js?v=414',
  './database/endocrino.js?v=414',
  './database/gastro.js?v=414',
  './database/gastro_imuno.js?v=414',
  './database/imuno_corticoide.js?v=414',
  './database/endocrino_glp1.js?v=414',
  './database/infusoes.js?v=414',
  './database/interacoes.js?v=414',
  './database/nefro.js?v=414',
  './database/neuro.js?v=414',
  './database/obesidade.js?v=414',
  './database/pneumo.js?v=414',
  './database/pneumologia.js?v=414',
  './database/alergia_imunologia.js?v=414',
  './database/pneumologia_otorrino.js?v=414',
  './database/neurologia.js?v=414',
  './database/prescricoes.js?v=414',
  './database/psicofarmacos.js?v=414',
  './database/psiquiatria.js?v=414',
  './database/reumatologia.js?v=414',
  './database/emergencia.js?v=414',
  './database/infectologia.js?v=414',
  './database/sedacao.js?v=414',
  './database/hematologia.js?v=414',
  './database/gastroenterologia.js?v=414',
  './database/cardiologia.js?v=414',
  './database/analgesia_opioides.js?v=414',
];
