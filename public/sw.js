/* ============================================================
   ...
   • ASSETS_TO_CACHE com query string ?v=435 sincronizada com index.html.
...
const CACHE_VERSION   = 'medcases-v435';
const CACHE_NAME      = `medcases-calc-${CACHE_VERSION}`;

/* ── Lista canônica de assets pré-cacheados no install ──────
   BUILD 276: query strings sincronizadas com ?v=435 do index.html.
...
const ASSETS_TO_CACHE = [
  ...
  './css/medcases-ux-v2.css?v=435',
  './css/build233.css?v=435',
  './css/build234-design-system.css?v=435',
  './css/build235-layout.css?v=435',
  './css/build236-hub-redesign.css?v=435',
  './css/build237a-ux-refinement.css?v=435',
  './css/build237b-flush-cards.css?v=435',
  './css/build240b-fixes.css?v=435',
  './css/build241-ux-pro.css?v=435',
  './css/build243-fullscreen-overlay.css?v=435',
  './css/build244-category-pills.css?v=435',
  './css/build246-farmaco-modal-premium.css?v=435',
  './css/build254-critical-fixes.css?v=435',
  './css/build272-universal-design-system.css?v=435',

  /* ── JS (8 arquivos — stack completa BUILD 275.1) ── */
  './js/medcases-ux-v2.js?v=435',
  './js/hub-accordion.js?v=435',
  './js/build240b-accordion-fix.js?v=435',
  './js/calculator-overlay.js?v=435',
  './js/category-pills.js?v=435',
  './js/elec-calc.js?v=435',
  './js/deeplink-router.js?v=435',
  './js/build272-reactive-engine.js?v=435',
  './js/build283-accessory-bar.js?v=435',

  /* ── Database (20 arquivos — base clínica COMPLETA) ── */
  './database/analgesicos.js?v=435',
  './database/anticoag.js?v=435',
  './database/antimicrobianos.js?v=435',
  './database/cardio.js?v=435',
  './database/endocrino.js?v=435',
  './database/gastro.js?v=435',
  './database/gastro_imuno.js?v=435',
  './database/imuno_corticoide.js?v=435',
  './database/endocrino_glp1.js?v=435',
  './database/infusoes.js?v=435',
  './database/interacoes.js?v=435',
  './database/nefro.js?v=435',
  './database/neuro.js?v=435',
  './database/obesidade.js?v=435',
  './database/pneumo.js?v=435',
  './database/pneumologia.js?v=435',
  './database/alergia_imunologia.js?v=435',
  './database/pneumologia_otorrino.js?v=435',
  './database/neurologia.js?v=435',
  './database/prescricoes.js?v=435',
  './database/psicofarmacos.js?v=435',
  './database/psiquiatria.js?v=435',
  './database/reumatologia.js?v=435',
  './database/emergencia.js?v=435',
  './database/infectologia.js?v=435',
  './database/sedacao.js?v=435',
  './database/hematologia.js?v=435',
  './database/gastroenterologia.js?v=435',
  './database/cardiologia.js?v=435',
  './database/analgesia_opioides.js?v=435',
];
